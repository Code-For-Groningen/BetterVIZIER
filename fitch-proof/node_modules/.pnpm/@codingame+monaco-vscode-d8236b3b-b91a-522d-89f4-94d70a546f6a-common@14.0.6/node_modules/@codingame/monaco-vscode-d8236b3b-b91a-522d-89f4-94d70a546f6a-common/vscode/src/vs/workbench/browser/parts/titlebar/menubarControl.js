...
import { ActivityBarPosition } from '@codingame/monaco-vscode-api/vscode/vs/workbench/services/layout/browser/layoutService';
...
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'File',
        original: 'File',
        mnemonicTitle: ( localize(3384, "&&File")),
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Edit',
        original: 'Edit',
        mnemonicTitle: ( localize(3385, "&&Edit"))
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Selection',
        original: 'Selection',
        mnemonicTitle: ( localize(3386, "&&Selection"))
    },
    order: 3
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'View',
        original: 'View',
        mnemonicTitle: ( localize(3387, "&&View"))
    },
    order: 4
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Go',
        original: 'Go',
        mnemonicTitle: ( localize(3388, "&&Go"))
    },
    order: 5
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Terminal',
        original: 'Terminal',
        mnemonicTitle: ( localize(3389, "&&Terminal"))
    },
    order: 7
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Help',
        original: 'Help',
        mnemonicTitle: ( localize(3390, "&&Help"))
    },
    order: 8
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        ...
        mnemonicTitle: ( localize(3391, "Preferences"))
    },
...
class MenubarControl extends Disposable {
    ...
    notifyUserOfCustomMenubarAccessibility() {
        ...
        this.notificationService.prompt(Severity.Info, message, [
            {
                label: ( localize(3393, "Open Settings")),
                run: () => {
        ...
        registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: ( localize2(3394, 'Focus Application Menu')),
                    keybinding: {
    ...
    getUpdateAction() {
        ...
        switch (state.type) {
            case StateType.Idle:
                return (new Action(
                    'update.check',
                    localize(3395, "Check for &&Updates..."),
                    undefined,
                    true,
            ...
            case StateType.CheckingForUpdates:
                return (new Action(
                    'update.checking',
                    localize(3396, "Checking for Updates..."),
                    undefined,
                    false
                ));
            case StateType.AvailableForDownload:
                return (new Action(
                    'update.downloadNow',
                    localize(3397, "D&&ownload Update"),
                    undefined,
                    true,
            ...
            case StateType.Downloading:
                return (new Action(
                    'update.downloading',
                    localize(3398, "Downloading Update..."),
                    undefined,
                    false
                ));
            case StateType.Downloaded:
                return isMacintosh ? null : ( new Action('update.install', ( localize(3399, "Install &&Update...")), undefined, true, () => this.updateService.applyUpdate()));
            case StateType.Updating:
                return (new Action(
                    'update.updating',
                    localize(3400, "Installing Update..."),
                    undefined,
                    false
                ));
            case StateType.Ready:
                return (new Action(
                    'update.restart',
                    localize(3401, "Restart to &&Update"),
                    undefined,
                    true,
