...
import { CompositeDragAndDropObserver, toggleDropEffect } from '@codingame/monaco-vscode-91789cdf-e3cb-5a04-aaeb-6f7df7d3d231-common/vscode/vs/workbench/browser/dnd';
...
let CompositeBarActionViewItem = class CompositeBarActionViewItem extends BaseActionViewItem {
    ...
    computeTitle() {
        ...
        let title = this.keybindingLabel ? ( localize(2781, "{0} ({1})", this.compositeBarActionItem.name, this.keybindingLabel)) : this.compositeBarActionItem.name;
...
class CompositeOverflowActivityAction extends CompositeBarAction {
    constructor(showMenu) {
        super({
            ...
            name: ( localize(2782, "Additional Views")),
...
let CompositeOverflowActivityActionViewItem = class CompositeOverflowActivityActionViewItem extends CompositeBarActionViewItem {
    ...
    getActions() {
        return (this.getOverflowingComposites().map(composite => {
            ...
            if (suffix) {
                action.label = ( localize(2783, "{0} ({1})", composite.name, suffix));
            }
            else {
...
let CompositeActionViewItem = class CompositeActionViewItem extends CompositeBarActionViewItem {
    ...
    showContextMenu(container) {
        ...
        if (isPinned) {
            this.toggleCompositePinnedAction.label = ( localize(2784, "Hide '{0}'", this.compositeBarActionItem.name));
            this.toggleCompositePinnedAction.checked = false;
            this.toggleCompositePinnedAction.enabled = this.compositeBar.getPinnedCompositeIds().length > 1;
        }
        else {
            this.toggleCompositePinnedAction.label = ( localize(2785, "Keep '{0}'", this.compositeBarActionItem.name));
        ...
        if (isBadgeEnabled) {
            this.toggleCompositeBadgeAction.label = ( localize(2786, "Hide Badge"));
        }
        else {
            this.toggleCompositeBadgeAction.label = ( localize(2787, "Show Badge"));
        }
...
class ToggleCompositePinnedAction extends Action {
    constructor(activity, compositeBar) {
        super('show.toggleCompositePinned', activity ? activity.name : ( localize(2788, "Toggle View Pinned")));
...
class ToggleCompositeBadgeAction extends Action {
    constructor(compositeBarActionItem, compositeBar) {
        super('show.toggleCompositeBadge', compositeBarActionItem ? compositeBarActionItem.name : ( localize(2789, "Toggle View Badge")));
