...
import { PaneView } from '@codingame/monaco-vscode-65619f8f-0eab-5d8b-855a-43b6353fe527-common/vscode/vs/base/browser/ui/splitview/paneview';
...
import '@codingame/monaco-vscode-65619f8f-0eab-5d8b-855a-43b6353fe527-common/vscode/vs/workbench/browser/parts/views/media/paneviewlet.css';
...
import { CompositeMenuActions } from '@codingame/monaco-vscode-65619f8f-0eab-5d8b-855a-43b6353fe527-common/vscode/vs/workbench/browser/actions';
...
registerAction2(class MoveViewUp extends MoveViewPosition {
    constructor() {
        super({
            id: 'views.moveViewUp',
            title: ( localize(3438, "Move View Up")),
            keybinding: {
...
registerAction2(class MoveViewLeft extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(3439, "Move View Left")),
            keybinding: {
...
registerAction2(class MoveViewDown extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(3440, "Move View Down")),
            keybinding: {
...
registerAction2(class MoveViewRight extends MoveViewPosition {
    constructor() {
        super({
            ...
            title: ( localize(3441, "Move View Right")),
            keybinding: {
...
registerAction2(class MoveViews extends Action2 {
    constructor() {
        super({
            id: 'vscode.moveViews',
            title: ( localize(3442, "Move Views")),
        });
    }
