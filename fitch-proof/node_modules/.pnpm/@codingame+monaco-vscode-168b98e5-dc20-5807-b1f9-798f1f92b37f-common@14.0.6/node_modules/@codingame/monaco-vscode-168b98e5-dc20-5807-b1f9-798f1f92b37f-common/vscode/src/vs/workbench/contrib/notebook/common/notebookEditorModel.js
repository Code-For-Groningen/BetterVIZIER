...
import { StoredFileWorkingCopyState } from '@codingame/monaco-vscode-99f24462-c56d-5407-83fb-2ea9dd33cc8c-common/vscode/vs/workbench/services/workingCopy/common/storedFileWorkingCopy';
...
let SimpleNotebookEditorModel = SimpleNotebookEditorModel_1 = class SimpleNotebookEditorModel extends EditorModel {
    constructor(resource, _hasAssociatedFilePath, viewType, _workingCopyManager, scratchpad, _filesConfigurationService, _notebookSynchronizerService) {
        super();
        ...
        this._notebookSynchronizerService = _notebookSynchronizerService;
...
SimpleNotebookEditorModel = SimpleNotebookEditorModel_1 = ( __decorate([
    ...
    ( __param(6, INotebookSynchronizerService))
