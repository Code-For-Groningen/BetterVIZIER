...
import { ThrottledDelayer, createCancelablePromise } from '@codingame/monaco-vscode-api/vscode/vs/base/common/async';
...
import { toFileOperationResult, FileOperationResult, FileOperationError } from '@codingame/monaco-vscode-api/vscode/vs/platform/files/common/files';
...
import { SyncStatus, getPathSegments, PREVIEW_DIR_NAME, getLastSyncResourceUri, Change, UserDataSyncError, UserDataSyncErrorCode, MergeState, USER_DATA_SYNC_SCHEME, USER_DATA_SYNC_CONFIGURATION_SCOPE } from '@codingame/monaco-vscode-api/vscode/vs/platform/userDataSync/common/userDataSync';
import { IUserDataSyncStoreService, IUserDataSyncLocalStoreService, IUserDataSyncEnablementService, IUserDataSyncLogService, IUserDataSyncUtilService } from '@codingame/monaco-vscode-api/vscode/vs/platform/userDataSync/common/userDataSync.service';
