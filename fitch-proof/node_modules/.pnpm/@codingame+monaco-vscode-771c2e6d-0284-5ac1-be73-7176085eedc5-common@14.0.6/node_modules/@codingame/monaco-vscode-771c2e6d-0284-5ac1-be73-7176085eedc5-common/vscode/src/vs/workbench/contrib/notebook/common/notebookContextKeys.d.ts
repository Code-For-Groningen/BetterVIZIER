...
export declare const NOTEBOOK_IS_ACTIVE_EDITOR: import("@codingame/monaco-vscode-api/vscode/vs/platform/contextkey/common/contextkey").ContextKeyExpression;
export declare const INTERACTIVE_WINDOW_IS_ACTIVE_EDITOR: import("@codingame/monaco-vscode-api/vscode/vs/platform/contextkey/common/contextkey").ContextKeyExpression;
export declare const REPL_NOTEBOOK_IS_ACTIVE_EDITOR: import("@codingame/monaco-vscode-api/vscode/vs/platform/contextkey/common/contextkey").ContextKeyExpression;
