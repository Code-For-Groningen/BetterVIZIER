...
import { NOTEBOOK_EDITOR_ID, INTERACTIVE_WINDOW_EDITOR_ID, REPL_EDITOR_ID } from '@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/notebook/common/notebookCommon';
...
const MOST_RECENT_REPL_EDITOR = ( new RawContextKey('mostRecentReplEditor', undefined));
