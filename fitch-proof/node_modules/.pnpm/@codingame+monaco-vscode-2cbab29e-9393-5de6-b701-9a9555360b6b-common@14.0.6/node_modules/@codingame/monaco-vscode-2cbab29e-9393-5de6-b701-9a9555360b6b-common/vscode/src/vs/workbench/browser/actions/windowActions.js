...
class BaseOpenRecentAction extends Action2 {
    constructor(desc) {
        ...
        this.removeFromRecentlyOpened = {
            ...
            tooltip: ( localize(2688, "Remove from Recently Opened"))
        };
        this.dirtyRecentlyOpenedFolder = {
            iconClass: 'dirty-workspace ' + ThemeIcon.asClassName(Codicon.closeDirty),
            tooltip: ( localize(2689, "Folder With Unsaved Files")),
            alwaysVisible: true
        };
        this.dirtyRecentlyOpenedWorkspace = {
            ...this.dirtyRecentlyOpenedFolder,
            tooltip: ( localize(2690, "Workspace With Unsaved Files")),
        };
    }
    async run(accessor) {
        ...
        let keyMods;
        const workspaceSeparator = { type: 'separator', label: hasWorkspaces ? ( localize(2691, "folders & workspaces")) : ( localize(2692, "folders")) };
        const fileSeparator = { type: 'separator', label: ( localize(2693, "files")) };
            ...
            onDidTriggerItemButton: async (context) => {
                if (context.button === this.removeFromRecentlyOpened) {
                    ...
                    const { confirmed } = await dialogService.confirm({
                        title: isDirtyWorkspace ? ( localize(2696, "Workspace with Unsaved Files")) : ( localize(2697, "Folder with Unsaved Files")),
                        message: isDirtyWorkspace ? ( localize(2698, "Do you want to open the workspace to review the unsaved files?")) : ( localize(2699, "Do you want to open the folder to review the unsaved files?")),
    ...
    toQuickPick(modelService, languageService, labelService, recent, isDirty) {
        ...
        return {
            iconClasses,
            label: name,
            ariaLabel: isDirty ? isWorkspace ? ( localize(2702, "{0}, workspace with unsaved changes", name)) : ( localize(2703, "{0}, folder with unsaved changes", name)) : name,
...
class OpenRecentAction extends BaseOpenRecentAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2704, "Open Recent...")),
                mnemonicTitle: ( localize(2705, "&&More...")),
            },
...
class QuickPickRecentAction extends BaseOpenRecentAction {
    constructor() {
        super({
            ...
            title: ( localize2(2706, 'Quick Open Recent...')),
            category: Categories.File,
            f1: false
        });
    }
...
class ToggleFullScreenAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2707, "Toggle Full Screen")),
                mnemonicTitle: ( localize(2708, "&&Full Screen")),
            },
...
class ReloadWindowAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2709, 'Reload Window')),
...
class ShowAboutDialogAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2710, "About")),
                mnemonicTitle: ( localize(2711, "&&About")),
            },
...
class NewWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2712, "New Window")),
                mnemonicTitle: ( localize(2713, "New &&Window")),
            },
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class BlurAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2714, 'Remove keyboard focus from focused element'))
        });
    }
    run() {
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        ...
        title: ( localize(2715, "Confirm Before Close")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    title: ( localize(2716, "Open &&Recent")),
