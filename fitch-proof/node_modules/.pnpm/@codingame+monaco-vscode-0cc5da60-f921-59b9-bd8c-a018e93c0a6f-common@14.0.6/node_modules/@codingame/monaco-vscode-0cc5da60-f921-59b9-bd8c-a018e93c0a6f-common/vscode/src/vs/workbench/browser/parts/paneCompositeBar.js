...
import { Dimension, isMouseEvent } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dom';
...
import { ToggleCompositeBadgeAction, ToggleCompositePinnedAction, CompositeBarAction } from '@codingame/monaco-vscode-d8236b3b-b91a-522d-89f4-94d70a546f6a-common/vscode/vs/workbench/browser/parts/compositeBarActions';
...
import { Separator, SubmenuAction, toAction } from '@codingame/monaco-vscode-api/vscode/vs/base/common/actions';
...
let PaneCompositeBar = class PaneCompositeBar extends Disposable {
    ...
    getContextMenuActionsForComposite(compositeId) {
        ...
        actions.push(( new SubmenuAction('moveToMenu', ( localize(3321, "Move To")), moveActions)));
        if (defaultLocation !== currentLocation) {
            actions.push(toAction({
                id: 'resetLocationAction', label: ( localize(3322, "Reset Location")), run: () => {
    ...
    createMoveAction(viewContainer, newLocation, defaultLocation) {
        return toAction({
            ...
            label: newLocation === ViewContainerLocation.Panel ? ( localize(3323, "Panel")) : newLocation === ViewContainerLocation.Sidebar ? ( localize(3324, "Primary Side Bar")) : ( localize(3325, "Secondary Side Bar")),
            run: () => {
                let index;
