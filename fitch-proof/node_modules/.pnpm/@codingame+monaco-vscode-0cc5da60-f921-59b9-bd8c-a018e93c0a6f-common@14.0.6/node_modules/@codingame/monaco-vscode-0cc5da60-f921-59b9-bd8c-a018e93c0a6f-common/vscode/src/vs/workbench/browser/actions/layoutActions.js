...
import { positionToString, Position, Parts, LayoutSettings, EditorTabsMode, ZenModeSettings, EditorActionsLocation } from '@codingame/monaco-vscode-api/vscode/vs/workbench/services/layout/browser/layoutService';
...
import { IsMainEditorCenteredLayoutContext, IsAuxiliaryWindowFocusedContext, MainEditorAreaVisibleContext, PanelAlignmentContext, PanelPositionContext, SideBarVisibleContext, InEditorZenModeContext, TitleBarStyleContext, IsMainWindowFullscreenContext, FocusedViewContext, AuxiliaryBarVisibleContext, PanelVisibleContext } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/contextkeys';
...
const menubarIcon = registerIcon('menuBar', Codicon.layoutMenubar, ( localize(2540, "Represents the menu bar")));
const activityBarLeftIcon = registerIcon('activity-bar-left', Codicon.layoutActivitybarLeft, ( localize(2541, "Represents the activity bar in the left position")));
const activityBarRightIcon = registerIcon('activity-bar-right', Codicon.layoutActivitybarRight, ( localize(2542, "Represents the activity bar in the right position")));
const panelLeftIcon = registerIcon('panel-left', Codicon.layoutSidebarLeft, ( localize(2543, "Represents a side bar in the left position")));
const panelLeftOffIcon = registerIcon('panel-left-off', Codicon.layoutSidebarLeftOff, ( localize(2544, "Represents a side bar in the left position toggled off")));
const panelRightIcon = registerIcon('panel-right', Codicon.layoutSidebarRight, ( localize(2545, "Represents side bar in the right position")));
const panelRightOffIcon = registerIcon('panel-right-off', Codicon.layoutSidebarRightOff, ( localize(2546, "Represents side bar in the right position toggled off")));
const panelIcon = registerIcon('panel-bottom', Codicon.layoutPanel, ( localize(2547, "Represents the bottom panel")));
const statusBarIcon = registerIcon('statusBar', Codicon.layoutStatusbar, ( localize(2548, "Represents the status bar")));
const panelAlignmentLeftIcon = registerIcon('panel-align-left', Codicon.layoutPanelLeft, ( localize(2549, "Represents the bottom panel alignment set to the left")));
const panelAlignmentRightIcon = registerIcon('panel-align-right', Codicon.layoutPanelRight, ( localize(2550, "Represents the bottom panel alignment set to the right")));
const panelAlignmentCenterIcon = registerIcon('panel-align-center', Codicon.layoutPanelCenter, ( localize(2551, "Represents the bottom panel alignment set to the center")));
const panelAlignmentJustifyIcon = registerIcon('panel-align-justify', Codicon.layoutPanelJustify, ( localize(2552, "Represents the bottom panel alignment set to justified")));
const quickInputAlignmentTopIcon = registerIcon('quickInputAlignmentTop', Codicon.arrowUp, ( localize(2553, "Represents quick input alignment set to the top")));
const quickInputAlignmentCenterIcon = registerIcon('quickInputAlignmentCenter', Codicon.circle, ( localize(2554, "Represents quick input alignment set to the center")));
const fullscreenIcon = registerIcon('fullscreen', Codicon.screenFull, ( localize(2555, "Represents full screen")));
const centerLayoutIcon = registerIcon('centerLayoutIcon', Codicon.layoutCentered, ( localize(2556, "Represents centered layout mode")));
const zenModeIcon = registerIcon('zenMode', Codicon.target, ( localize(2557, "Represents zen mode")));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2558, "Toggle Centered Layout")),
                mnemonicTitle: ( localize(2559, "&&Centered Layout")),
            },
...
class MoveSidebarRightAction extends MoveSidebarPositionAction {
    ...
    constructor() {
        super(MoveSidebarRightAction.ID, ( localize2(2560, "Move Primary Side Bar Right")), Position.RIGHT);
    }
}
class MoveSidebarLeftAction extends MoveSidebarPositionAction {
    static { this.ID = 'workbench.action.moveSideBarLeft'; }
    constructor() {
        super(MoveSidebarLeftAction.ID, ( localize2(2561, "Move Primary Side Bar Left")), Position.LEFT);
    }
}
...
class ToggleSidebarPositionAction extends Action2 {
    ...
    static { this.LABEL = ( localize(2562, "Toggle Primary Side Bar Position")); }
    static getLabel(layoutService) {
        return layoutService.getSideBarPosition() === Position.LEFT ? ( localize(2560, "Move Primary Side Bar Right")) : ( localize(2561, "Move Primary Side Bar Left"));
    }
    constructor() {
        super({
            id: ToggleSidebarPositionAction.ID,
            title: ( localize2(2562, "Toggle Primary Side Bar Position")),
            category: Categories.View,
            f1: true
        });
    }
...
const configureLayoutIcon = registerIcon('configure-layout-icon', Codicon.layout, ( localize(2563, 'Icon represents workbench layout configuration.')));
MenuRegistry.appendMenuItem(MenuId.LayoutControlMenu, {
    submenu: MenuId.LayoutControlMenuSubmenu,
    title: ( localize(2564, "Configure Layout")),
...
MenuRegistry.appendMenuItems([{
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarPositionAction.ID,
                title: ( localize(2565, "Move Primary Side Bar Right"))
            },
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarPositionAction.ID,
                title: ( localize(2566, "Move Primary Side Bar Left"))
            },
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarPositionAction.ID,
                title: ( localize(2567, "Move Secondary Side Bar Left"))
            },
            when: ( ContextKeyExpr.and(( ContextKeyExpr.notEquals('config.workbench.sideBar.location', 'right')), ( ContextKeyExpr.equals(
                'viewContainerLocation',
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarPositionAction.ID,
                title: ( localize(2568, "Move Secondary Side Bar Right"))
            },
            when: ( ContextKeyExpr.and(( ContextKeyExpr.equals('config.workbench.sideBar.location', 'right')), ( ContextKeyExpr.equals(
                'viewContainerLocation',
                ViewContainerLocationToString(ViewContainerLocation.AuxiliaryBar)
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    command: {
        id: ToggleSidebarPositionAction.ID,
        title: ( localize(2569, "&&Move Primary Side Bar Right"))
    },
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    command: {
        id: ToggleSidebarPositionAction.ID,
        title: ( localize(2570, "&&Move Primary Side Bar Left"))
    },
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2571, "Toggle Editor Area Visibility")),
                mnemonicTitle: ( localize(2572, "Show &&Editor Area")),
            },
            category: Categories.View,
            f1: true,
...
MenuRegistry.appendMenuItem(MenuId.MenubarViewMenu, {
    group: '2_appearance',
    title: ( localize(2573, "&&Appearance")),
    submenu: MenuId.MenubarAppearanceMenu,
    order: 1
});
class ToggleSidebarVisibilityAction extends Action2 {
    static { this.ID = 'workbench.action.toggleSidebarVisibility'; }
    static { this.LABEL = ( localize(2574, "Hide Primary Side Bar")); }
    constructor() {
        super({
            id: ToggleSidebarVisibilityAction.ID,
            title: ( localize2(2575, 'Toggle Primary Side Bar Visibility')),
            toggled: {
                condition: SideBarVisibleContext,
                title: ( localize(2576, "Primary Side Bar")),
                mnemonicTitle: ( localize(2577, "&&Primary Side Bar")),
            },
            metadata: {
                description: ( localize(2578, 'Open/Show and Close/Hide Sidebar')),
            },
            category: Categories.View,
            f1: true,
            keybinding: {
...
MenuRegistry.appendMenuItems([
    {
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarVisibilityAction.ID,
                title: ( localize(2574, "Hide Primary Side Bar")),
            },
        ...
        item: {
            ...
            command: {
                id: ToggleSidebarVisibilityAction.ID,
                title: ( localize(2579, "Toggle Primary Side Bar")),
...
class ToggleStatusbarVisibilityAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2580, "Toggle Status Bar Visibility")),
                mnemonicTitle: ( localize(2581, "S&&tatus Bar")),
            },
            category: Categories.View,
            f1: true,
...
class HideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2582, 'Hide Editor Tabs'));
        super(LayoutSettings.EDITOR_TABS_MODE, EditorTabsMode.NONE, title, HideEditorTabsAction.ID, precondition, ( localize2(2583, "Hide Tab Bar")));
    }
}
class ZenHideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2584, 'Hide Editor Tabs in Zen Mode'));
        super(ZenModeSettings.SHOW_TABS, EditorTabsMode.NONE, title, ZenHideEditorTabsAction.ID, precondition, ( localize2(2585, "Hide Tab Bar in Zen Mode")));
    }
}
class ShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2586, 'Show Multiple Editor Tabs'));
        super(LayoutSettings.EDITOR_TABS_MODE, EditorTabsMode.MULTIPLE, title, ShowMultipleEditorTabsAction.ID, precondition, ( localize2(2587, "Show Tab Bar with multiple tabs")));
    }
}
class ZenShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2588, 'Show Multiple Editor Tabs in Zen Mode'));
        super(ZenModeSettings.SHOW_TABS, EditorTabsMode.MULTIPLE, title, ZenShowMultipleEditorTabsAction.ID, precondition, ( localize2(2589, "Show Tab Bar in Zen Mode")));
    }
}
class ShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2590, 'Show Single Editor Tab'));
        super(LayoutSettings.EDITOR_TABS_MODE, EditorTabsMode.SINGLE, title, ShowSingleEditorTabAction.ID, precondition, ( localize2(2591, "Show Tab Bar with one Tab")));
    }
}
class ZenShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = ( localize2(2592, 'Show Single Editor Tab in Zen Mode'));
        super(ZenModeSettings.SHOW_TABS, EditorTabsMode.SINGLE, title, ZenShowSingleEditorTabAction.ID, precondition, ( localize2(2593, "Show Tab Bar in Zen Mode with one Tab")));
    }
}
...
class EditorActionsTitleBarAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2595, "Move Editor Actions to Title Bar")),
            category: Categories.View,
            precondition: ( ( ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
                EditorActionsLocation.TITLEBAR
            )).negate()),
            metadata: { description: ( localize2(2596, "Move Editor Actions from the tab bar to the title bar")) },
            f1: true
        });
    }
    run(accessor) {
...
class EditorActionsDefaultAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2597, "Move Editor Actions to Tab Bar")),
            category: Categories.View,
            ...
            metadata: { description: ( localize2(2598, "Move Editor Actions from the title bar to the tab bar")) },
            f1: true
        });
    }
    run(accessor) {
...
class HideEditorActionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2599, "Hide Editor Actions")),
            category: Categories.View,
            precondition: ( ( ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
                EditorActionsLocation.HIDDEN
            )).negate()),
            metadata: { description: ( localize2(2600, "Hide Editor Actions in the tab and title bar")) },
            f1: true
        });
    }
    run(accessor) {
...
class ShowEditorActionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2601, "Show Editor Actions")),
            category: Categories.View,
            precondition: ( ContextKeyExpr.equals(
                `config.${LayoutSettings.EDITOR_ACTIONS_LOCATION}`,
                EditorActionsLocation.HIDDEN
            )),
            metadata: { description: ( localize2(2602, "Make Editor Actions visible.")) },
            f1: true
        });
    }
    run(accessor) {
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    title: ( localize(2603, "Editor Actions Position")),
    group: '3_workbench_layout_move',
    order: 11
});
class ConfigureEditorTabsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2604, "Configure Tabs")),
            category: Categories.View,
        });
    }
    run(accessor) {
...
class ConfigureEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2605, "Configure Editors")),
            category: Categories.View,
        });
    }
    run(accessor) {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2606, "Separate Pinned Editor Tabs")),
            category: Categories.View,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2608, "Toggle Zen Mode")),
                mnemonicTitle: ( localize(2609, "Zen Mode")),
            },
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated()),
            category: Categories.View,
            f1: true,
    ...
    registerAction2(class ToggleMenubarAction extends Action2 {
        constructor() {
            super({
                ...
                title: {
                    ...( localize2(2610, "Toggle Menu Bar")),
                    mnemonicTitle: ( localize(2611, "Menu &&Bar")),
                },
                category: Categories.View,
                f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2613, "Reset View Locations")),
            category: Categories.View,
            f1: true
        });
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2614, "Move View")),
            category: Categories.View,
            f1: true
        });
    }
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: ( localize(2615, "Side Bar / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: ( localize(2616, "Panel / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: ( localize(2617, "Secondary Side Bar / {0}", containerModel.title))
                        });
                        hasAddedView = true;
                    }
                    results.push({
    ...
    async getView(quickInputService, viewDescriptorService, paneCompositePartService, viewId) {
        ...
        quickPick.placeholder = ( localize(2618, "Select a View to Move"));
...
class MoveFocusedViewAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2619, "Move Focused View")),
            category: Categories.View,
    ...
    run(accessor, viewId) {
        ...
        if (focusedViewId === undefined || focusedViewId.trim() === '') {
            dialogService.error(( localize(2620, "There is no view currently focused.")));
            return;
        }
        const viewDescriptor = viewDescriptorService.getViewDescriptorById(focusedViewId);
        if (!viewDescriptor || !viewDescriptor.canMoveView) {
            dialogService.error(( localize(2621, "The currently focused view is not movable.")));
            return;
        }
        const disposables = ( new DisposableStore());
        const quickPick = disposables.add(quickInputService.createQuickPick({ useSeparators: true }));
        quickPick.placeholder = ( localize(2622, "Select a Destination for the View"));
        quickPick.title = ( localize(2623, "View: Move {0}", viewDescriptor.name.value));
        const items = [];
        ...
        items.push({
            type: 'separator',
            label: ( localize(2629, "Secondary Side Bar"))
        });
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2630, "Reset Focused View Location")),
            category: Categories.View,
            f1: true,
            precondition: ( FocusedViewContext.notEqualsTo(''))
        });
    ...
    run(accessor) {
        ...
        if (!viewDescriptor) {
            dialogService.error(( localize(2631, "There is no view currently focused.")));
            return;
        }
...
class IncreaseViewSizeAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2632, 'Increase Current View Size')),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class IncreaseViewWidthAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2633, 'Increase Editor Width')),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class IncreaseViewHeightAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2634, 'Increase Editor Height')),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class DecreaseViewSizeAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2635, 'Decrease Current View Size')),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class DecreaseViewWidthAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2636, 'Decrease Editor Width')),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
class DecreaseViewHeightAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2637, 'Decrease Editor Height')),
            f1: true,
            precondition: ( IsAuxiliaryWindowFocusedContext.toNegated())
        });
    }
...
registerAction2(class AlignQuickInputTopAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2638, 'Align Quick Input Top')),
            f1: false
        });
    }
    run(accessor) {
...
registerAction2(class AlignQuickInputCenterAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2639, 'Align Quick Input Center')),
            f1: false
        });
    }
    run(accessor) {
...
const CreateToggleLayoutItem = (id, active, label, visualIcon) => {
    return {
        ...
        activeAriaLabel: ( localize(2640, "Select to Hide")),
        inactiveAriaLabel: ( localize(2641, "Select to Show")),
        useButtons: true,
    };
};
const CreateOptionLayoutItem = (id, active, label, visualIcon) => {
    return {
        ...
        activeAriaLabel: ( localize(2642, "Active")),
        useButtons: false
    };
};
...
if (!isMacintosh || !isNative) {
    ToggleVisibilityActions.push(CreateToggleLayoutItem('workbench.action.toggleMenuBar', MenuBarToggledContext, ( localize(2643, "Menu Bar")), menubarIcon));
}
ToggleVisibilityActions.push(...[
    CreateToggleLayoutItem(ToggleActivityBarVisibilityActionId, ( ContextKeyExpr.notEquals('config.workbench.activityBar.location', 'hidden')), ( localize(2644, "Activity Bar")), { whenA: ( ContextKeyExpr.equals('config.workbench.sideBar.location', 'left')), iconA: activityBarLeftIcon, iconB: activityBarRightIcon }),
    CreateToggleLayoutItem(ToggleSidebarVisibilityAction.ID, SideBarVisibleContext, ( localize(2645, "Primary Side Bar")), { whenA: ( ContextKeyExpr.equals('config.workbench.sideBar.location', 'left')), iconA: panelLeftIcon, iconB: panelRightIcon }),
    CreateToggleLayoutItem(ToggleAuxiliaryBarAction.ID, AuxiliaryBarVisibleContext, ( localize(2629, "Secondary Side Bar")), { whenA: ( ContextKeyExpr.equals('config.workbench.sideBar.location', 'left')), iconA: panelRightIcon, iconB: panelLeftIcon }),
    CreateToggleLayoutItem(TogglePanelAction.ID, PanelVisibleContext, ( localize(2628, "Panel")), panelIcon),
    CreateToggleLayoutItem(ToggleStatusbarVisibilityAction.ID, ( ContextKeyExpr.equals('config.workbench.statusBar.visible', true)), ( localize(2646, "Status Bar")), statusBarIcon),
]);
const MoveSideBarActions = [
    CreateOptionLayoutItem(MoveSidebarLeftAction.ID, ( ContextKeyExpr.equals('config.workbench.sideBar.location', 'left')), ( localize(2647, "Left")), panelLeftIcon),
    CreateOptionLayoutItem(MoveSidebarRightAction.ID, ( ContextKeyExpr.equals('config.workbench.sideBar.location', 'right')), ( localize(2648, "Right")), panelRightIcon),
];
const AlignPanelActions = [
    CreateOptionLayoutItem('workbench.action.alignPanelLeft', ( PanelAlignmentContext.isEqualTo('left')), ( localize(2649, "Left")), panelAlignmentLeftIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelRight', ( PanelAlignmentContext.isEqualTo('right')), ( localize(2650, "Right")), panelAlignmentRightIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelCenter', ( PanelAlignmentContext.isEqualTo('center')), ( localize(2651, "Center")), panelAlignmentCenterIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelJustify', ( PanelAlignmentContext.isEqualTo('justify')), ( localize(2652, "Justify")), panelAlignmentJustifyIcon),
];
const QuickInputActions = [
    CreateOptionLayoutItem('workbench.action.alignQuickInputTop', ( QuickInputAlignmentContextKey.isEqualTo('top')), ( localize(2653, "Top")), quickInputAlignmentTopIcon),
    CreateOptionLayoutItem('workbench.action.alignQuickInputCenter', ( QuickInputAlignmentContextKey.isEqualTo('center')), ( localize(2654, "Center")), quickInputAlignmentCenterIcon),
];
const MiscLayoutOptions = [
    CreateOptionLayoutItem('workbench.action.toggleFullScreen', IsMainWindowFullscreenContext, ( localize(2655, "Full Screen")), fullscreenIcon),
    CreateOptionLayoutItem('workbench.action.toggleZenMode', InEditorZenModeContext, ( localize(2656, "Zen Mode")), zenModeIcon),
    CreateOptionLayoutItem('workbench.action.toggleCenteredLayout', IsMainEditorCenteredLayoutContext, ( localize(2657, "Centered Layout")), centerLayoutIcon),
];
...
registerAction2(class CustomizeLayoutAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2658, "Customize Layout...")),
            f1: true,
            icon: configureLayoutIcon,
            menu: [
                {
    ...
    getItems(contextKeyService, keybindingService) {
        ...
        return [
            {
                type: 'separator',
                label: ( localize(2659, "Visibility"))
            },
            ...( ToggleVisibilityActions.map(toQuickPickItem)),
            {
                type: 'separator',
                label: ( localize(2660, "Primary Side Bar Position"))
            },
            ...( MoveSideBarActions.map(toQuickPickItem)),
            {
                type: 'separator',
                label: ( localize(2661, "Panel Alignment"))
            },
            ...( AlignPanelActions.map(toQuickPickItem)),
            {
                type: 'separator',
                label: ( localize(2662, "Quick Input Position"))
            },
            ...( QuickInputActions.map(toQuickPickItem)),
            {
                type: 'separator',
                label: ( localize(2663, "Modes")),
            },
    ...
    run(accessor) {
        ...
        quickPick.title = ( localize(2664, "Customize Layout"));
        const closeButton = {
            alwaysVisible: true,
            iconClass: ThemeIcon.asClassName(Codicon.close),
            tooltip: ( localize(2665, "Close"))
        };
        const resetButton = {
            alwaysVisible: true,
            iconClass: ThemeIcon.asClassName(Codicon.discard),
            tooltip: ( localize(2666, "Restore Defaults"))
        };
        quickPick.buttons = [
            resetButton,
            closeButton
