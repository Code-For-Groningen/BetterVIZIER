...
import { LayoutSettings, ActivityBarPosition, Parts } from '@codingame/monaco-vscode-api/vscode/vs/workbench/services/layout/browser/layoutService';
...
const auxiliaryBarRightIcon = registerIcon('auxiliarybar-right-layout-icon', Codicon.layoutSidebarRight, ( localize(2762, 'Icon to toggle the auxiliary bar off in its right position.')));
const auxiliaryBarRightOffIcon = registerIcon('auxiliarybar-right-off-layout-icon', Codicon.layoutSidebarRightOff, ( localize(2763, 'Icon to toggle the auxiliary bar on in its right position.')));
const auxiliaryBarLeftIcon = registerIcon('auxiliarybar-left-layout-icon', Codicon.layoutSidebarLeft, ( localize(2764, 'Icon to toggle the auxiliary bar in its left position.')));
const auxiliaryBarLeftOffIcon = registerIcon('auxiliarybar-left-off-layout-icon', Codicon.layoutSidebarLeftOff, ( localize(2765, 'Icon to toggle the auxiliary bar on in its left position.')));
class ToggleAuxiliaryBarAction extends Action2 {
    static { this.ID = 'workbench.action.toggleAuxiliaryBar'; }
    static { this.LABEL = ( localize2(2766, "Toggle Secondary Side Bar Visibility")); }
    constructor() {
        super({
            ...
            toggled: {
                ...
                title: ( localize(2767, 'Hide Secondary Side Bar')),
                icon: closeIcon,
                mnemonicTitle: ( localize(2768, "Secondary Si&&de Bar")),
            },
            icon: closeIcon,
            category: Categories.View,
            metadata: {
                description: ( localize(2769, 'Open/Show and Close/Hide Secondary Side Bar')),
            },
            f1: true,
            keybinding: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2767, 'Hide Secondary Side Bar')),
            category: Categories.View,
...
registerAction2(class FocusAuxiliaryBarAction extends Action2 {
    ...
    static { this.LABEL = ( localize2(2770, "Focus into Secondary Side Bar")); }
    constructor() {
        super({
...
MenuRegistry.appendMenuItems([
    {
        ...
        item: {
            ...
            command: {
                id: ToggleAuxiliaryBarAction.ID,
                title: ( localize(2771, "Toggle Secondary Side Bar")),
        ...
        item: {
            ...
            command: {
                id: ToggleAuxiliaryBarAction.ID,
                title: ( localize2(2772, 'Hide Secondary Side Bar')),
            },
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2773, 'Previous Secondary Side Bar View')),
            category: Categories.View,
            f1: true
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2774, 'Next Secondary Side Bar View')),
            category: Categories.View,
            f1: true
        }, ViewContainerLocation.AuxiliaryBar, 1);
    }
