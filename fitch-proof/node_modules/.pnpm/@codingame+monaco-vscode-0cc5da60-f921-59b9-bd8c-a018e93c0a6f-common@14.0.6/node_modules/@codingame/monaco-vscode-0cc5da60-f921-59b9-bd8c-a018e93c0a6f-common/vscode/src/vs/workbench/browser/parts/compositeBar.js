...
import { CompositeOverflowActivityAction, CompositeActionViewItem, CompositeOverflowActivityActionViewItem } from '@codingame/monaco-vscode-d8236b3b-b91a-522d-89f4-94d70a546f6a-common/vscode/vs/workbench/browser/parts/compositeBarActions';
import { isAncestor, $, addDisposableListener, EventType, getWindow, EventHelper } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dom';
...
import { toggleDropEffect, CompositeDragAndDropObserver } from '@codingame/monaco-vscode-91789cdf-e3cb-5a04-aaeb-6f7df7d3d231-common/vscode/vs/workbench/browser/dnd';
...
let CompositeBar = class CompositeBar extends Widget {
    ...
    create(parent) {
        ...
        this.compositeSwitcherBar = this._register(( new ActionBar(actionBarDiv, {
            ...
            ariaLabel: ( localize(2780, "Active View Switcher")),
            ariaRole: 'tablist',
