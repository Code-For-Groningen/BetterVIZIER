...
import { Parts, Position, LayoutSettings, ActivityBarPosition } from '@codingame/monaco-vscode-api/vscode/vs/workbench/services/layout/browser/layoutService';
...
let ActivityBarCompositeBar = class ActivityBarCompositeBar extends PaneCompositeBar {
    ...
    fillContextMenuActions(actions, e) {
        ...
        if (menuBarVisibility === 'compact' || menuBarVisibility === 'hidden' || menuBarVisibility === 'toggle') {
            actions.unshift(...[toAction({ id: 'toggleMenuVisibility', label: ( localize(2743, "Menu")), checked: menuBarVisibility === 'compact', run: () => this.configurationService.updateValue('window.menuBarVisibility', menuBarVisibility === 'compact' ? 'toggle' : 'compact') }), ( new Separator())]);
        }
        if (menuBarVisibility === 'compact' && this.menuBarContainer && e?.target) {
            if (isAncestor(e.target, this.menuBarContainer)) {
                actions.unshift(...[toAction({ id: 'hideCompactMenu', label: ( localize(2744, "Hide Menu")), run: () => this.configurationService.updateValue('window.menuBarVisibility', 'toggle') }), ( new Separator())]);
            }
        }
    ...
    getActivityBarContextMenuActions() {
        ...
        const actions = [
            ( new SubmenuAction('workbench.action.panel.position', ( localize(2745, "Activity Bar Position")), positionActions)),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2746, 'Move Activity Bar to Side')),
                mnemonicTitle: ( localize(2747, "&&Default")),
            },
            shortTitle: ( localize(2748, "Default")),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2749, 'Move Activity Bar to Top')),
                mnemonicTitle: ( localize(2750, "&&Top")),
            },
            shortTitle: ( localize(2751, "Top")),
            category: Categories.View,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2752, 'Move Activity Bar to Bottom')),
                mnemonicTitle: ( localize(2753, "&&Bottom")),
            },
            shortTitle: ( localize(2754, "Bottom")),
            category: Categories.View,
            toggled: ( ContextKeyExpr.equals(
                `config.${LayoutSettings.ACTIVITY_BAR_LOCATION}`,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2755, 'Hide Activity Bar')),
                mnemonicTitle: ( localize(2756, "&&Hidden")),
            },
            shortTitle: ( localize(2757, "Hidden")),
            category: Categories.View,
            toggled: ( ContextKeyExpr.equals(
                `config.${LayoutSettings.ACTIVITY_BAR_LOCATION}`,
...
MenuRegistry.appendMenuItem(MenuId.MenubarAppearanceMenu, {
    ...
    title: ( localize(2758, "Activity Bar Position")),
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2759, 'Previous Primary Side Bar View')),
            category: Categories.View,
            f1: true
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: ( localize2(2760, 'Next Primary Side Bar View')),
            category: Categories.View,
            f1: true
        }, ViewContainerLocation.Sidebar, 1);
    }
...
registerAction2(class FocusActivityBarAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2761, 'Focus Activity Bar')),
            category: Categories.View,
            f1: true
        });
    }
