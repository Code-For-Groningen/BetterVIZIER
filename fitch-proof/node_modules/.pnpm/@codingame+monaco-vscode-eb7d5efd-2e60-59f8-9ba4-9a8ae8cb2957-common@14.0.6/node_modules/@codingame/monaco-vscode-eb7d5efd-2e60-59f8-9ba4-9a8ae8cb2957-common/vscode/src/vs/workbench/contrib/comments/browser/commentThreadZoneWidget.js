...
import { MouseTargetType, isCodeEditor } from '@codingame/monaco-vscode-api/vscode/vs/editor/browser/editorBrowser';
...
import { CommentThreadWidget } from '@codingame/monaco-vscode-9ee79c1a-3f03-568b-8eac-b02513a98b68-common/vscode/vs/workbench/contrib/comments/browser/commentThreadWidget';
import { getCommentThreadStateBorderColor, commentThreadStateColorVar, commentThreadStateBackgroundColorVar } from '@codingame/monaco-vscode-9ee79c1a-3f03-568b-8eac-b02513a98b68-common/vscode/vs/workbench/contrib/comments/browser/commentColors';
import { peekViewBorder } from '@codingame/monaco-vscode-api/vscode/vs/editor/contrib/peekView/browser/peekView';
    ...
    async confirmCollapse() {
        ...
        if (confirmSetting === 'whenHasUnsubmittedComments' && this._commentThreadWidget.hasUnsubmittedComments) {
            const result = await this.dialogService.confirm({
                ...
                primaryButton: ( localize(4972, "Collapse")),
                type: Severity.Warning,
                checkbox: { label: ( localize(4973, "Never ask me again")), checked: false }
            });
