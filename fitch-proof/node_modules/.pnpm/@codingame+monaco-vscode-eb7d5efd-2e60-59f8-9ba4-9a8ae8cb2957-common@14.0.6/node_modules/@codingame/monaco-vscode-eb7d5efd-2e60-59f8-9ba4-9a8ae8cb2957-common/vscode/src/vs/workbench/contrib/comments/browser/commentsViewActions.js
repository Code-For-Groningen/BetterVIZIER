...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(5049, "Focus Comments view")),
            keybinding: {
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(5050, "Clear filter text")),
            keybinding: {
                when: CommentsViewFilterFocusContextKey,
                weight: KeybindingWeight.WorkbenchContrib,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(5051, "Focus comments filter")),
            keybinding: {
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(5052, "Show Unresolved")),
            category: ( localize(5053, "Comments")),
            toggled: {
                condition: CONTEXT_KEY_SHOW_UNRESOLVED,
                title: ( localize(5054, "Show Unresolved")),
            },
            menu: {
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: ( localize(5055, "Show Resolved")),
            category: ( localize(5053, "Comments")),
            toggled: {
                condition: CONTEXT_KEY_SHOW_RESOLVED,
                title: ( localize(5056, "Show Resolved")),
            },
            menu: {
                id: viewFilterSubmenu,
                group: '1_filter',
