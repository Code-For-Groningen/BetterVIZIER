...
import { IEditorControl, IEditorPane, IEditorOpenContext, SideBySideEditor as Side, IEditorPaneSelection, IEditorPaneWithSelection, IEditorPaneSelectionChangeEvent } from "@codingame/monaco-vscode-api/vscode/vs/workbench/common/editor";
