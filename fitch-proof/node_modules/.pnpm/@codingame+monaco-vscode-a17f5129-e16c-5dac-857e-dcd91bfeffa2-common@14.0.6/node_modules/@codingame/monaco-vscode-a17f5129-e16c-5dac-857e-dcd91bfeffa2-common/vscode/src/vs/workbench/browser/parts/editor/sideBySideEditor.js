...
import { Dimension, $, multibyteAwareBtoa, clearNode } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dom';
import { Registry } from '@codingame/monaco-vscode-api/vscode/vs/platform/registry/common/platform';
import { SIDE_BY_SIDE_EDITOR_ID, SideBySideEditor as SideBySideEditor$1, EditorExtensions, isEditorPaneWithSelection, EditorPaneSelectionCompareResult } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/editor';
...
import { Emitter, Relay, Event } from '@codingame/monaco-vscode-api/vscode/vs/base/common/event';
...
import { DEFAULT_EDITOR_MIN_DIMENSIONS } from '@codingame/monaco-vscode-api/vscode/vs/workbench/browser/parts/editor/editor';
import { DisposableStore } from '@codingame/monaco-vscode-api/vscode/vs/base/common/lifecycle';
import { SIDE_BY_SIDE_EDITOR_VERTICAL_BORDER, SIDE_BY_SIDE_EDITOR_HORIZONTAL_BORDER } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/theme';
import { AbstractEditorWithViewState } from '@codingame/monaco-vscode-4a28f637-7c3c-5e48-a77c-1b7538b38850-common/vscode/vs/workbench/browser/parts/editor/editorWithViewState';
...
let SideBySideEditor = class SideBySideEditor extends AbstractEditorWithViewState {
    ...
    getTitle() {
        ...
        return localize(3240, "Side by Side Editor");
    }
