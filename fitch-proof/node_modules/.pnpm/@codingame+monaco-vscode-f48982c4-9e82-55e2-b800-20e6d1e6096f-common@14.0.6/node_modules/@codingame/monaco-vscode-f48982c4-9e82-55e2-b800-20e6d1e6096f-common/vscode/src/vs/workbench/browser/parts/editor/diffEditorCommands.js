...
import { TextCompareEditorVisibleContext, TextCompareEditorActiveContext, ActiveCompareEditorCanSwapContext } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/contextkeys';
...
function registerDiffEditorCommands() {
    ...
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: GOTO_NEXT_CHANGE,
            title: ( localize2(2853, 'Go to Next Change')),
        }
    });
    KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: GOTO_PREVIOUS_CHANGE,
            title: ( localize2(2854, 'Go to Previous Change')),
        }
    });
    ...
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: TOGGLE_DIFF_SIDE_BY_SIDE,
            title: ( localize2(2855, "Toggle Inline View")),
            category: ( localize(2856, "Compare"))
        },
    ...
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
        command: {
            id: DIFF_SWAP_SIDES,
            title: ( localize2(2857, "Swap Left and Right Editor Side")),
            category: ( localize(2856, "Compare"))
        },
