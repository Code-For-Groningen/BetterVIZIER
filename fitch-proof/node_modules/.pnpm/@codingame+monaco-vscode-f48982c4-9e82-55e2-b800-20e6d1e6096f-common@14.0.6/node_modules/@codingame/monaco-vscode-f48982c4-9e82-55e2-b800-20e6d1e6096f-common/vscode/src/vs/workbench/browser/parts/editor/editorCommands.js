...
import { SideBySideEditor } from '@codingame/monaco-vscode-a17f5129-e16c-5dac-857e-dcd91bfeffa2-common/vscode/vs/workbench/browser/parts/editor/sideBySideEditor';
...
function registerActiveEditorMoveCopyCommand() {
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        metadata: {
            description: ( localize(3115, "Move the active editor by tabs or groups")),
            args: [
                {
                    name: ( localize(3116, "Active editor move argument")),
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        metadata: {
            description: ( localize(3118, "Copy the active editor by groups")),
            args: [
                {
                    name: ( localize(3119, "Active editor copy argument")),
                    description: ( localize(
                        3120,
                    ...
                    schema: {
                        ...
                        'properties': {
                            'orientation': {
                                ...
                                'enum': [0, 1],
                                'enumDescriptions': [
                                    ( localize(3121, "Horizontal")),
                                    ( localize(3122, "Vertical"))
                                ],
                            },
                            'groups': {
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3123, 'Split Editor in Group')),
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3124, 'Join Editor in Group')),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3125, 'Toggle Split Editor in Group')),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3126, 'Toggle Layout of Split Editor in Group')),
                category: Categories.View,
                precondition: SideBySideEditorActiveContext,
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3127, 'Focus First Side in Active Editor')),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3128, 'Focus Second Side in Active Editor')),
                category: Categories.View,
                precondition: ( ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext)),
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3129, 'Focus Other Side in Active Editor')),
                category: Categories.View,
                precondition: ( ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext)),
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3130, 'Toggle Editor Group Lock')),
                category: Categories.View,
                f1: true
            });
        }
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3131, 'Lock Editor Group')),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: ( localize2(3132, 'Unlock Editor Group')),
