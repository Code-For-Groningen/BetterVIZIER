...
import { prepareQuery } from '@codingame/monaco-vscode-d0fb86d3-2a47-594e-955b-9a24631a7124-common/vscode/vs/base/common/fuzzyScorer';
...
import { OutlineTarget } from '@codingame/monaco-vscode-d4a98668-f793-5361-a9cf-1e6ae6d62ce3-common/vscode/vs/workbench/services/outline/browser/outline';
import { IOutlineService } from '@codingame/monaco-vscode-api/vscode/vs/workbench/services/outline/browser/outline.service';
import { isCompositeEditor } from '@codingame/monaco-vscode-api/vscode/vs/editor/browser/editorBrowser';
...
import { accessibleViewIsShown, accessibilityHelpIsShown } from '@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/accessibility/browser/accessibilityConfiguration';
import { parseLabelWithIcons, matchesFuzzyIconAware } from '@codingame/monaco-vscode-api/vscode/vs/base/common/iconLabels';
        ...
        this.outlineService.createOutline(pane, OutlineTarget.QuickPick, cts.token).then(outline => {
            ...
            const updatePickerItems = () => {
                ...
                if (filteredItems.length === 0) {
                    const label = ( localize(4849, 'No matching entries'));
...
class GotoSymbolAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(4850, "Go to Symbol in Editor...")),
                mnemonicTitle: ( localize(4851, "Go to &&Symbol in Editor...")),
            },
            f1: true,
            keybinding: {
...
( Registry.as(Extensions.Quickaccess)).registerQuickAccessProvider({
    ...
    placeholder: ( localize(4852, "Type the name of a symbol to go to.")),
    helpEntries: [
        {
            description: ( localize(4853, "Go to Symbol in Editor")),
            prefix: AbstractGotoSymbolQuickAccessProvider.PREFIX,
            commandId: GotoSymbolAction.ID,
            commandCenterOrder: 40
        },
        {
            description: ( localize(4854, "Go to Symbol in Editor by Category")),
