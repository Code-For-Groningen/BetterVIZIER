...
import { DraggedEditorGroupIdentifier, isWindowDraggedOver, fillEditorsDragData } from '@codingame/monaco-vscode-91789cdf-e3cb-5a04-aaeb-6f7df7d3d231-common/vscode/vs/workbench/browser/dnd';
...
import { EDITOR_CORE_NAVIGATION_COMMANDS } from '@codingame/monaco-vscode-f48982c4-9e82-55e2-b800-20e6d1e6096f-common/vscode/vs/workbench/browser/parts/editor/editorCommands';
...
let EditorTabsControl = class EditorTabsControl extends Themable {
    ...
    doCreateEditorActionsToolBar(container) {
        ...
        this.editorActionsToolbar = this.editorActionsToolbarDisposables.add(this.instantiationService.createInstance(WorkbenchToolBar, container, {
            ...
            ariaLabel: ( localize(3237, "Editor actions")),
    ...
    onGroupDragStart(e, element) {
        ...
        if (this.groupView.activeEditor) {
            ...
            if (this.groupsView.partOptions.showTabs === 'multiple' && this.groupView.count > 1) {
                label = ( localize(3238, "{0} (+{1})", label, this.groupView.count - 1));
            }
