...
import { NewExplorerItem, ExplorerItem } from '@codingame/monaco-vscode-eea37658-2307-56a5-8ed0-b2752c7b7a50-common/vscode/vs/workbench/contrib/files/common/explorerModel';
...
let ExplorerView = class ExplorerView extends ViewPane {
    ...
    renderHeader(container) {
        ...
        const setHeader = () => {
            ...
            this.ariaHeaderLabel = ( localize(6822, "Explorer Section: {0}", this.name));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(6824, "New Folder...")),
            f1: false,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6825, "Refresh Explorer")),
            f1: true,
            ...
            metadata: {
                description: ( localize2(6826, "Forces a refresh of the Explorer."))
            },
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6827, "Collapse Folders in Explorer")),
            f1: true,
            ...
            metadata: {
                description: ( localize2(6828, "Folds all folders in the Explorer."))
            }
        });
    }
    run(accessor) {
