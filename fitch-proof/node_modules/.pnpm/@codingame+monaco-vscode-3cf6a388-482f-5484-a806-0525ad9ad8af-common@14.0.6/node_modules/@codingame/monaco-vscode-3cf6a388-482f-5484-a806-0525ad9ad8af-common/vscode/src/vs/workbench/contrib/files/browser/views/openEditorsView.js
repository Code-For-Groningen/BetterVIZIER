...
import { OpenEditor, OpenEditorsFocusedContext, ExplorerFocusedContext } from '@codingame/monaco-vscode-eea37658-2307-56a5-8ed0-b2752c7b7a50-common/vscode/vs/workbench/contrib/files/common/files';
import { CloseEditorAction, UnpinEditorAction, CloseAllEditorsAction } from '@codingame/monaco-vscode-c3c61c00-c254-5856-9dc9-d7929c1f9062-common/vscode/vs/workbench/browser/parts/editor/editorActions';
...
import { ResourcesDropHandler, fillEditorsDragData } from '@codingame/monaco-vscode-91789cdf-e3cb-5a04-aaeb-6f7df7d3d231-common/vscode/vs/workbench/browser/dnd';
...
import { WorkingCopyCapabilities } from '@codingame/monaco-vscode-ce8c4b18-4e75-55dd-9656-517347af9de7-common/vscode/vs/workbench/services/workingCopy/common/workingCopy';
...
let OpenEditorsView = class OpenEditorsView extends ViewPane {
    ...
    static { this.NAME = ( localize2(6845, "Open Editors")); }
    ...
    updateDirtyIndicator(workingCopy) {
        ...
        if (dirty === 0) {
            ...
            this.dirtyCountElement.textContent = ( localize(6846, "{0} unsaved", dirty));
...
class OpenEditorsAccessibilityProvider {
    getWidgetAriaLabel() {
        return localize(6845, "Open Editors");
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6847, "Toggle Vertical/Horizontal Editor Layout")),
            f1: true,
            keybinding: {
...
MenuRegistry.appendMenuItem(MenuId.MenubarLayoutMenu, {
    ...
    command: {
        ...
        title: {
            ...( localize2(6848, "Flip Layout")),
            mnemonicTitle: ( localize(6849, "Flip &&Layout"))
        }
    },
    order: 1
});
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(6850, "New Untitled Text File")),
            f1: false,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(6851, 'Configure \'{0}\'', OpenEditorsView.NAME.value)),
            f1: false,
            icon: Codicon.gear,
            menu: {
                id: MenuId.ViewTitle,
