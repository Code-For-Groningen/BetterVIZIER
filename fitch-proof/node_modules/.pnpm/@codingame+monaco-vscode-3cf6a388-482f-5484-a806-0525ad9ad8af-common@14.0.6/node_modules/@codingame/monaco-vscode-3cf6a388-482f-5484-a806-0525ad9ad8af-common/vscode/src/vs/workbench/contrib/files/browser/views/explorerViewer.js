...
import { addDisposableListener, addStandardDisposableListener, EventType, isActiveElement, isHTMLElement, hasParentWithClass, getWindow } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dom';
import { match, parse } from '@codingame/monaco-vscode-api/vscode/vs/base/common/glob';
...
import { FileKind, FileChangeType, FileOperationResult } from '@codingame/monaco-vscode-api/vscode/vs/platform/files/common/files';
...
import { DisposableStore, toDisposable, dispose, Disposable } from '@codingame/monaco-vscode-api/vscode/vs/base/common/lifecycle';
import { KeyCode } from '@codingame/monaco-vscode-api/vscode/vs/base/common/keyCodes';
import { TreeVisibility, TreeDragOverBubble } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/ui/tree/tree';
...
import { ExplorerFindProviderActive, UndoConfirmLevel } from '@codingame/monaco-vscode-eea37658-2307-56a5-8ed0-b2752c7b7a50-common/vscode/vs/workbench/contrib/files/common/files';
import { relativePath, dirname, joinPath, distinctParents } from '@codingame/monaco-vscode-api/vscode/vs/base/common/resources';
...
import { equals, deepClone } from '@codingame/monaco-vscode-api/vscode/vs/base/common/objects';
import { relative } from '@codingame/monaco-vscode-api/vscode/vs/base/common/path';
import { ExplorerItem, NewExplorerItem } from '@codingame/monaco-vscode-eea37658-2307-56a5-8ed0-b2752c7b7a50-common/vscode/vs/workbench/contrib/files/common/explorerModel';
import { compareFileNamesDefault, compareFileExtensionsDefault, compareFileNamesUnicode, compareFileExtensionsUnicode, compareFileNamesLower, compareFileExtensionsLower, compareFileNamesUpper, compareFileExtensionsUpper } from '@codingame/monaco-vscode-api/vscode/vs/base/common/comparers';
import { containsDragType, CodeDataTransfers } from '@codingame/monaco-vscode-api/vscode/vs/platform/dnd/browser/dnd';
import { fillEditorsDragData } from '@codingame/monaco-vscode-91789cdf-e3cb-5a04-aaeb-6f7df7d3d231-common/vscode/vs/workbench/browser/dnd';
import { IInstantiationService } from '@codingame/monaco-vscode-api/vscode/vs/platform/instantiation/common/instantiation';
import { DataTransfers } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dnd';
import { Schemas } from '@codingame/monaco-vscode-api/vscode/vs/base/common/network';
import { NativeDragAndDropData, ExternalElementsDragAndDropData, ListViewTargetSector } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/ui/list/listView';
...
import { Emitter, EventMultiplexer, Event } from '@codingame/monaco-vscode-api/vscode/vs/base/common/event';
...
import { defaultCountBadgeStyles, defaultInputBoxStyles } from '@codingame/monaco-vscode-api/vscode/vs/platform/theme/browser/defaultStyles';
...
import { explorerFileContribRegistry } from '@codingame/monaco-vscode-eea37658-2307-56a5-8ed0-b2752c7b7a50-common/vscode/vs/workbench/contrib/files/browser/explorerFileContrib';
import { getExcludes, QueryType } from '@codingame/monaco-vscode-api/vscode/vs/workbench/services/search/common/search';
import { ISearchService } from '@codingame/monaco-vscode-api/vscode/vs/workbench/services/search/common/search.service';
import { TreeFindMode, TreeFindMatchType } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/ui/tree/abstractTree';
...
import { listFilterMatchHighlightBorder, listFilterMatchHighlight } from '@codingame/monaco-vscode-api/vscode/vs/platform/theme/common/colors/listColors';
...
let FilesRenderer = class FilesRenderer {
    ...
    getWidgetAriaLabel() {
        return localize(6830, "Files Explorer");
    }
    get templateId() {
    ...
    renderStat(stat, label, domId, filterData, templateData) {
        ...
        if (highlightResults > 0) {
            const badge = ( new CountBadge(
                ...
                {},
                { ...defaultCountBadgeStyles, badgeBackground: asCssVariable(listFilterMatchHighlight), badgeBorder: asCssVariable(listFilterMatchHighlightBorder) }
            ));
            badge.setCount(highlightResults);
            badge.setTitleFormat(( localize(6831, "Directory contains {0} matches", highlightResults)));
    ...
    renderInputBox(container, stat, editableData) {
        ...
        const inputBox = ( new InputBox(label.element, this.contextViewService, {
            ...
            ariaLabel: ( localize(6832, "Type file name. Press Enter to confirm or Escape to cancel.")),
...
let FileDragAndDrop = class FileDragAndDrop {
    ...
    async handleExplorerDrop(data, target, targetIndex, targetSector, originalEvent) {
        ...
        if (confirmDragAndDrop) {
            ...
            const confirmation = await this.dialogService.confirm({
                ...
                detail,
                checkbox: {
                    label: ( localize(6837, "Do not ask me again"))
                },
                primaryButton: ( localize(6838, "&&Move"))
            });
    ...
    async doHandleExplorerDropOnCopy(sources, target) {
        ...
        await this.explorerService.applyBulkEdit(resourceFileEdits, {
            ...
            undoLabel: ( localize(6839, "Copy {0}", labelSuffix)),
            progressLabel: ( localize(6840, "Copying {0}", labelSuffix)),
        });
    ...
    async doHandleExplorerDropOnMove(sources, target) {
        ...
        const options = {
            ...
            undoLabel: ( localize(6841, "Move {0}", labelSuffix)),
            progressLabel: ( localize(6842, "Moving {0}", labelSuffix))
        };
        try {
...
function getFileOrFolderLabelSuffix(items) {
    ...
    if (items.every(i => i.isDirectory)) {
        return localize(6843, "{0} folders", items.length);
    }
    if (items.every(i => !i.isDirectory)) {
        return localize(6844, "{0} files", items.length);
    }
