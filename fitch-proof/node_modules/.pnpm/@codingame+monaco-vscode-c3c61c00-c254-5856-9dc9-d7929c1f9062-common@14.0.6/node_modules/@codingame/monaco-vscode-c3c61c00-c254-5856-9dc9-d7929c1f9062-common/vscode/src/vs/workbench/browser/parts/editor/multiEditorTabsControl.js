...
import { isWindows, isLinux, isMacintosh } from '@codingame/monaco-vscode-api/vscode/vs/base/common/platform';
import { shorten } from '@codingame/monaco-vscode-api/vscode/vs/base/common/labels';
import { DEFAULT_EDITOR_ASSOCIATION, EditorsOrder, preventEditorClose, EditorCloseMethod, Verbosity, EditorInputCapabilities, EditorResourceAccessor, SideBySideEditor } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/editor';
import { computeEditorAriaLabel } from '@codingame/monaco-vscode-d0fb86d3-2a47-594e-955b-9a24631a7124-common/vscode/vs/workbench/browser/editor';
...
import { ResourceLabels, DEFAULT_LABELS_CONTAINER } from '@codingame/monaco-vscode-91789cdf-e3cb-5a04-aaeb-6f7df7d3d231-common/vscode/vs/workbench/browser/labels';
...
import { EditorTabsControl, EditorCommandsContextActionRunner } from '@codingame/monaco-vscode-d4a98668-f793-5361-a9cf-1e6ae6d62ce3-common/vscode/vs/workbench/browser/parts/editor/editorTabsControl';
import { IQuickInputService } from '@codingame/monaco-vscode-api/vscode/vs/platform/quickinput/common/quickInput.service';
import { MutableDisposable, DisposableStore, dispose, combinedDisposable, toDisposable } from '@codingame/monaco-vscode-api/vscode/vs/base/common/lifecycle';
...
import { getOrSet } from '@codingame/monaco-vscode-api/vscode/vs/base/common/map';
...
import { EDITOR_GROUP_HEADER_TABS_BORDER, TAB_BORDER, TAB_ACTIVE_BORDER, TAB_UNFOCUSED_ACTIVE_BORDER, TAB_ACTIVE_BORDER_TOP, TAB_UNFOCUSED_ACTIVE_BORDER_TOP, TAB_SELECTED_BORDER_TOP, TAB_ACTIVE_MODIFIED_BORDER, TAB_INACTIVE_MODIFIED_BORDER, TAB_UNFOCUSED_ACTIVE_MODIFIED_BORDER, TAB_UNFOCUSED_INACTIVE_MODIFIED_BORDER, TAB_LAST_PINNED_BORDER, TAB_HOVER_BACKGROUND, TAB_UNFOCUSED_HOVER_BACKGROUND, TAB_HOVER_FOREGROUND, TAB_UNFOCUSED_HOVER_FOREGROUND, TAB_HOVER_BORDER, TAB_UNFOCUSED_HOVER_BORDER, WORKBENCH_BACKGROUND, EDITOR_GROUP_HEADER_TABS_BACKGROUND, EDITOR_DRAG_AND_DROP_BACKGROUND, TAB_ACTIVE_BACKGROUND, TAB_UNFOCUSED_ACTIVE_BACKGROUND, TAB_INACTIVE_BACKGROUND, TAB_UNFOCUSED_INACTIVE_BACKGROUND } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/theme';
...
import { DraggedEditorGroupIdentifier, DraggedEditorIdentifier, isWindowDraggedOver, extractTreeDropData, ResourcesDropHandler } from '@codingame/monaco-vscode-91789cdf-e3cb-5a04-aaeb-6f7df7d3d231-common/vscode/vs/workbench/browser/dnd';
...
import { Dimension, addDisposableListener, EventType, EventHelper, DragAndDropObserver, isMouseEvent, getWindow, clearNode, scheduleAtNextAnimationFrame, findParentWithClass } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dom';
import { localize } from '@codingame/monaco-vscode-api/vscode/vs/nls';
import { CloseEditorTabAction, UnpinEditorAction } from './editorActions.js';
import { assertAllDefined, assertIsDefined } from '@codingame/monaco-vscode-api/vscode/vs/base/common/types';
...
import { insert, coalesce } from '@codingame/monaco-vscode-api/vscode/vs/base/common/arrays';
...
import { UNLOCK_GROUP_COMMAND_ID } from '@codingame/monaco-vscode-f48982c4-9e82-55e2-b800-20e6d1e6096f-common/vscode/vs/workbench/browser/parts/editor/editorCommands';
...
import { DraggedTreeItemsIdentifier } from '@codingame/monaco-vscode-api/vscode/vs/editor/common/services/treeViewsDnd';
...
import { applyDragImage } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dnd';
...
let MultiEditorTabsControl = class MultiEditorTabsControl extends EditorTabsControl {
    ...
    createTab(tabIndex, tabsContainer, tabsScrollbar) {
        ...
        const tabActionBar = ( new ActionBar(tabActionsContainer, { ariaLabel: ( localize(3239, "Tab actions")), actionRunner: tabActionRunner }));
