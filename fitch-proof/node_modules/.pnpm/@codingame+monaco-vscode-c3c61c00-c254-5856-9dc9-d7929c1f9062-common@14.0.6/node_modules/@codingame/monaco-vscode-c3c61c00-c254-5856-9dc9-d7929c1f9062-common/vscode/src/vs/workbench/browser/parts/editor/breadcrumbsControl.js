...
import { fillEditorsDragData, DraggedEditorIdentifier } from '@codingame/monaco-vscode-91789cdf-e3cb-5a04-aaeb-6f7df7d3d231-common/vscode/vs/workbench/browser/dnd';
...
const separatorIcon = registerIcon('breadcrumb-separator', Codicon.chevronRight, ( localize(2841, 'Icon for the separator in the breadcrumbs.')));
let BreadcrumbsControl = class BreadcrumbsControl {
    ...
    static { this.CK_BreadcrumbsPossible = ( new RawContextKey('breadcrumbsPossible', false, ( localize(2842, "Whether the editor can show breadcrumbs")))); }
    static { this.CK_BreadcrumbsVisible = ( new RawContextKey('breadcrumbsVisible', false, ( localize(2843, "Whether breadcrumbs are currently visible")))); }
    static { this.CK_BreadcrumbsActive = ( new RawContextKey('breadcrumbsActive', false, ( localize(2844, "Whether breadcrumbs have focus")))); }
        ...
        const updateBreadcrumbs = () => {
            ...
            if (items.length === 0) {
                ...
                this._widget.setItems([new (class extends BreadcrumbsItem {
                        render(container) {
                            container.innerText = ( localize(2845, "no elements"));
                        }
                        equals(other) {
                            return other === this;
                        }
...
registerAction2(class ToggleBreadcrumb extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(2846, "Toggle Breadcrumbs")),
                mnemonicTitle: ( localize(2847, "Toggle &&Breadcrumbs")),
            },
            category: Categories.View,
            toggled: {
                condition: ( ContextKeyExpr.equals('config.breadcrumbs.enabled', true)),
                title: ( localize(2848, "Toggle Breadcrumbs")),
                mnemonicTitle: ( localize(2849, "Toggle &&Breadcrumbs"))
            },
            menu: [
...
registerAction2(class FocusAndSelectBreadcrumbs extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2850, "Focus and Select Breadcrumbs")),
...
registerAction2(class FocusBreadcrumbs extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2851, "Focus Breadcrumbs")),
            precondition: BreadcrumbsControl.CK_BreadcrumbsVisible,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
