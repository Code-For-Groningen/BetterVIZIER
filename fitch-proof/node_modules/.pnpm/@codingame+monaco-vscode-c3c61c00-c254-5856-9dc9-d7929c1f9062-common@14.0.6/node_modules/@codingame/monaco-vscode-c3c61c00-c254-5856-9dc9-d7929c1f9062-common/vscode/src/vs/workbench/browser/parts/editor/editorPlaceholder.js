...
import { isEditorOpenError } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/editor';
...
import { clearNode, $, EventHelper, size } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dom';
...
import { assertAllDefined } from '@codingame/monaco-vscode-api/vscode/vs/base/common/types';
import { ICommandService } from '@codingame/monaco-vscode-api/vscode/vs/platform/commands/common/commands.service';
import { isSingleFolderWorkspaceIdentifier, toWorkspaceIdentifier } from '@codingame/monaco-vscode-api/vscode/vs/platform/workspace/common/workspace';
import { IWorkspaceContextService } from '@codingame/monaco-vscode-api/vscode/vs/platform/workspace/common/workspace.service';
import { EditorOpenSource } from '@codingame/monaco-vscode-api/vscode/vs/platform/editor/common/editor';
import { computeEditorAriaLabel, EditorPaneDescriptor } from '@codingame/monaco-vscode-d0fb86d3-2a47-594e-955b-9a24631a7124-common/vscode/vs/workbench/browser/editor';
...
import { SimpleIconLabel } from '@codingame/monaco-vscode-d4a98668-f793-5361-a9cf-1e6ae6d62ce3-common/vscode/vs/base/browser/ui/iconLabel/simpleIconLabel';
import { FileOperationResult, FileChangeType } from '@codingame/monaco-vscode-api/vscode/vs/platform/files/common/files';
...
let WorkspaceTrustRequiredPlaceholderEditor = class WorkspaceTrustRequiredPlaceholderEditor extends EditorPlaceholder {
    ...
    static { this.LABEL = ( localize(3166, "Workspace Trust Required")); }
    ...
    async getContents() {
        return {
            ...
            actions: [
                {
                    label: ( localize(3169, "Manage Workspace Trust")),
...
let ErrorPlaceholderEditor = class ErrorPlaceholderEditor extends EditorPlaceholder {
    ...
    static { this.LABEL = ( localize(3170, "Error Editor")); }
    ...
    async getContents(input, options, disposables) {
        ...
        let label;
        if (isFileNotFound) {
            label = ( localize(3171, "The editor could not be opened because the file was not found."));
        }
            ...
            label = ( localize(3173, "The editor could not be opened due to an unexpected error."));
        }
        let icon = '$(error)';
