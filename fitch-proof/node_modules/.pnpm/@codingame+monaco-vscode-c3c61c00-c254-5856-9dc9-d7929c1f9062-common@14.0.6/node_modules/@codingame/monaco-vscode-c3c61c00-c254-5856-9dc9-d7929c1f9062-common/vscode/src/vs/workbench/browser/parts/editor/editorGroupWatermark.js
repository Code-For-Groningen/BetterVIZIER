...
const showCommands = { text: ( localize(3149, "Show All Commands")), id: 'workbench.action.showCommands' };
const gotoFile = { text: ( localize(3150, "Go to File")), id: 'workbench.action.quickOpen' };
const openFile = { text: ( localize(3151, "Open File")), id: 'workbench.action.files.openFile' };
const openFolder = { text: ( localize(3152, "Open Folder")), id: 'workbench.action.files.openFolder' };
const openFileOrFolder = { text: ( localize(3153, "Open File or Folder")), id: 'workbench.action.files.openFileFolder' };
const openRecent = { text: ( localize(3154, "Open Recent")), id: 'workbench.action.openRecent' };
const newUntitledFile = { text: ( localize(3155, "New Untitled Text File")), id: 'workbench.action.files.newUntitledFile' };
const findInFiles = { text: ( localize(3156, "Find in Files")), id: 'workbench.action.findInFiles' };
const toggleTerminal = { text: ( localize(3157, "Toggle Terminal")), id: 'workbench.action.terminal.toggleTerminal', when: { web: ( ContextKeyExpr.equals('terminalProcessSupported', true)) } };
const startDebugging = { text: ( localize(3158, "Start Debugging")), id: 'workbench.action.debug.start', when: { web: ( ContextKeyExpr.equals('terminalProcessSupported', true)) } };
const openSettings = { text: ( localize(3159, "Open Settings")), id: 'workbench.action.openSettings' };
const openChat = { text: ( localize(3160, "Open Chat")), id: 'workbench.action.chat.open', when: { native: ( ContextKeyExpr.equals('chatSetupInstalled', true)), web: ( ContextKeyExpr.equals('chatSetupInstalled', true)) } };
const openCopilotEdits = { text: ( localize(3161, "Open Copilot Edits")), id: 'workbench.action.chat.openEditSession', when: { native: ( ContextKeyExpr.equals('chatSetupInstalled', true)), web: ( ContextKeyExpr.equals('chatSetupInstalled', true)) } };
...
registerColor('editorWatermark.foreground', { dark: ( transparent(editorForeground, 0.6)), light: ( transparent(editorForeground, 0.68)), hcDark: editorForeground, hcLight: editorForeground }, ( localize(3162, 'Foreground color for the labels in the editor watermark.')));
