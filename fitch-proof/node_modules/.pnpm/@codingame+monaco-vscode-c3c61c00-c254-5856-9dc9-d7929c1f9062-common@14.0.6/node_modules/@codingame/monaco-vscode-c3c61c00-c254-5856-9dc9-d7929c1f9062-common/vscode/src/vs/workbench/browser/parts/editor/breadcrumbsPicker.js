...
import { compareFileNames } from '@codingame/monaco-vscode-api/vscode/vs/base/common/comparers';
...
import { DisposableStore, MutableDisposable, Disposable } from '@codingame/monaco-vscode-api/vscode/vs/base/common/lifecycle';
import { posix, relative } from '@codingame/monaco-vscode-api/vscode/vs/base/common/path';
...
import { WorkbenchAsyncDataTree, WorkbenchDataTree } from '@codingame/monaco-vscode-api/vscode/vs/platform/list/browser/listService';
...
import { breadcrumbsPickerBackground, widgetShadow, widgetBorder } from '@codingame/monaco-vscode-api/vscode/vs/platform/theme/common/colors/editorColors';
...
import { isWorkspace, isWorkspaceFolder } from '@codingame/monaco-vscode-api/vscode/vs/platform/workspace/common/workspace';
...
class FileAccessibilityProvider {
    getWidgetAriaLabel() {
        return localize(2852, "Breadcrumbs");
    }
