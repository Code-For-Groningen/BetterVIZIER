...
import { preventEditorClose, EditorCloseMethod, EditorResourceAccessor, SideBySideEditor, Verbosity } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/editor';
import { EditorTabsControl } from '@codingame/monaco-vscode-d4a98668-f793-5361-a9cf-1e6ae6d62ce3-common/vscode/vs/workbench/browser/parts/editor/editorTabsControl';
...
import { TAB_ACTIVE_FOREGROUND, TAB_UNFOCUSED_ACTIVE_FOREGROUND } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/theme';
import { Gesture, EventType as EventType$1 } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/touch';
import { addDisposableListener, EventType, DragAndDropObserver, EventHelper, isHTMLElement, isAncestor, Dimension } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dom';
import { CLOSE_EDITOR_COMMAND_ID, UNLOCK_GROUP_COMMAND_ID } from '@codingame/monaco-vscode-f48982c4-9e82-55e2-b800-20e6d1e6096f-common/vscode/vs/workbench/browser/parts/editor/editorCommands';
