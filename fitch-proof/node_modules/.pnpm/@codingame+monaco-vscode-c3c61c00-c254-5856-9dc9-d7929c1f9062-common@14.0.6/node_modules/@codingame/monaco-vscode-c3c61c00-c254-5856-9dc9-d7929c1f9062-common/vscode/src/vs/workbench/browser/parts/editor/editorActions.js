...
import { SideBySideEditorInput } from '@codingame/monaco-vscode-4a28f637-7c3c-5e48-a77c-1b7538b38850-common/vscode/vs/workbench/common/editor/sideBySideEditorInput';
...
import { AutoSaveMode } from '@codingame/monaco-vscode-ce8c4b18-4e75-55dd-9656-517347af9de7-common/vscode/vs/workbench/services/filesConfiguration/common/filesConfigurationService';
...
import { resolveCommandsContext } from '@codingame/monaco-vscode-4a28f637-7c3c-5e48-a77c-1b7538b38850-common/vscode/vs/workbench/browser/parts/editor/editorCommandsContext';
import { IListService } from '@codingame/monaco-vscode-api/vscode/vs/platform/list/browser/listService.service';
import { InputMode } from '@codingame/monaco-vscode-api/vscode/vs/editor/common/inputMode';
...
class SplitEditorAction extends AbstractSplitEditorAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2988, 'Split Editor')),
            f1: true,
            keybinding: {
...
class SplitEditorOrthogonalAction extends AbstractSplitEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(2989, 'Split Editor Orthogonal')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class SplitEditorLeftAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(2990, 'Split Editor Left')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod.CtrlCmd | KeyCode.KeyK, KeyMod.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorRightAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(2991, 'Split Editor Right')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod.CtrlCmd | KeyCode.KeyK, KeyMod.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorUpAction extends ExecuteCommandAction {
    static { this.LABEL = ( localize(2992, "Split Editor Up")); }
    constructor() {
        super({
            id: SPLIT_EDITOR_UP,
            title: ( localize2(2992, "Split Editor Up")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod.CtrlCmd | KeyCode.KeyK, KeyMod.CtrlCmd | KeyCode.Backslash)
...
class SplitEditorDownAction extends ExecuteCommandAction {
    static { this.LABEL = ( localize(2993, "Split Editor Down")); }
    constructor() {
        super({
            id: SPLIT_EDITOR_DOWN,
            title: ( localize2(2993, "Split Editor Down")),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyChord(KeyMod.CtrlCmd | KeyCode.KeyK, KeyMod.CtrlCmd | KeyCode.Backslash)
...
class JoinTwoGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2994, 'Join Editor Group with Next Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class JoinAllGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2995, 'Join All Editor Groups')),
            f1: true,
            category: Categories.View
        });
    }
...
class NavigateBetweenGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2996, 'Navigate Between Editor Groups')),
            f1: true,
            category: Categories.View
        });
    }
...
class FocusActiveGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2997, 'Focus Active Editor Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class FocusFirstGroupAction extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(2998, 'Focus First Editor Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusLastGroupAction extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(2999, 'Focus Last Editor Group')),
            f1: true,
            category: Categories.View
...
class FocusNextGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3000, 'Focus Next Editor Group')),
            f1: true,
            category: Categories.View
...
class FocusPreviousGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3001, 'Focus Previous Editor Group')),
            f1: true,
            category: Categories.View
...
class FocusLeftGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3002, 'Focus Left Editor Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusRightGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3003, 'Focus Right Editor Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusAboveGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3004, 'Focus Editor Group Above')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class FocusBelowGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3005, 'Focus Editor Group Below')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
let CloseEditorAction = class CloseEditorAction extends Action {
    ...
    static { this.LABEL = ( localize(3006, "Close Editor")); }
...
let UnpinEditorAction = class UnpinEditorAction extends Action {
    ...
    static { this.LABEL = ( localize(3007, "Unpin Editor")); }
    constructor(id, label, commandService) {
...
let CloseEditorTabAction = class CloseEditorTabAction extends Action {
    static { this.ID = 'workbench.action.closeActiveEditor'; }
    static { this.LABEL = ( localize(3008, "Close")); }
...
class RevertAndCloseEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3009, 'Revert and Close Editor')),
            f1: true,
            category: Categories.View
        });
    }
...
class CloseLeftEditorsInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3010, 'Close Editors to the Left in Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class AbstractCloseAllAction extends Action2 {
    ...
    revertEditors(editorService, logService, progressService, editors) {
        return progressService.withProgress({
            ...
            delay: 800,
            title: ( localize(3011, "Reverting Editors...")),
...
class CloseAllEditorsAction extends AbstractCloseAllAction {
    ...
    static { this.LABEL = ( localize2(3012, 'Close All Editors')); }
    constructor() {
        super({
...
class CloseAllEditorGroupsAction extends AbstractCloseAllAction {
    constructor() {
        super({
            ...
            title: ( localize2(3013, 'Close All Editor Groups')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class CloseEditorsInOtherGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3014, 'Close Editors in Other Groups')),
            f1: true,
            category: Categories.View
        });
    }
...
class CloseEditorInAllGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3015, 'Close Editor in All Groups')),
            f1: true,
            category: Categories.View
        });
    }
...
class MoveGroupLeftAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3016, 'Move Editor Group Left')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveGroupRightAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3017, 'Move Editor Group Right')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveGroupUpAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3018, 'Move Editor Group Up')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveGroupDownAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3019, 'Move Editor Group Down')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class DuplicateGroupLeftAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3020, 'Duplicate Editor Group Left')),
            f1: true,
            category: Categories.View
        }, GroupDirection.LEFT);
    }
...
class DuplicateGroupRightAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3021, 'Duplicate Editor Group Right')),
            f1: true,
            category: Categories.View
        }, GroupDirection.RIGHT);
    }
...
class DuplicateGroupUpAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3022, 'Duplicate Editor Group Up')),
            f1: true,
            category: Categories.View
        }, GroupDirection.UP);
    }
...
class DuplicateGroupDownAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3023, 'Duplicate Editor Group Down')),
            f1: true,
            category: Categories.View
        }, GroupDirection.DOWN);
    }
...
class MinimizeOtherGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3024, 'Expand Editor Group')),
            f1: true,
            category: Categories.View,
...
class MinimizeOtherGroupsHideSidebarAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3025, 'Expand Editor Group and Hide Side Bars')),
            f1: true,
            category: Categories.View,
...
class ResetGroupSizesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3026, 'Reset Editor Group Sizes')),
            f1: true,
            category: Categories.View
        });
    }
...
class ToggleGroupSizesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3027, 'Toggle Editor Group Sizes')),
            f1: true,
            category: Categories.View
        });
    }
...
class MaximizeGroupHideSidebarAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3028, 'Maximize Editor Group and Hide Side Bars')),
            f1: true,
            category: Categories.View,
...
class ToggleMaximizeEditorGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3029, 'Toggle Maximize Editor Group')),
            f1: true,
            category: Categories.View,
            precondition: ( ContextKeyExpr.or(
...
class OpenNextEditor extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3030, 'Open Next Editor')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class OpenPreviousEditor extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3031, 'Open Previous Editor')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class OpenNextEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3032, 'Open Next Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class OpenPreviousEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3033, 'Open Previous Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class OpenFirstEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3034, 'Open First Editor in Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenLastEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3035, 'Open Last Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class NavigateForwardAction extends Action2 {
    ...
    static { this.LABEL = ( localize(3036, "Go Forward")); }
    constructor() {
        super({
            id: NavigateForwardAction.ID,
            title: {
                ...( localize2(3036, "Go Forward")),
                mnemonicTitle: ( localize(3037, "&&Forward"))
            },
            f1: true,
...
class NavigateBackwardsAction extends Action2 {
    ...
    static { this.LABEL = ( localize(3038, "Go Back")); }
    constructor() {
        super({
            id: NavigateBackwardsAction.ID,
            title: {
                ...( localize2(3038, "Go Back")),
                mnemonicTitle: ( localize(3039, "&&Back"))
            },
            f1: true,
...
class NavigatePreviousAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3040, 'Go Previous')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateForwardInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3041, 'Go Forward in Edit Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateBackwardsInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3042, 'Go Back in Edit Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigatePreviousInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3043, 'Go Previous in Edit Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateToLastEditLocationAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3044, 'Go to Last Edit Location')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class NavigateForwardInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3045, 'Go Forward in Navigation Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateBackwardsInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3046, 'Go Back in Navigation Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigatePreviousInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3047, 'Go Previous in Navigation Locations')),
            f1: true
        });
    }
    async run(accessor) {
...
class NavigateToLastNavigationLocationAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3048, 'Go to Last Navigation Location')),
            f1: true
        });
    }
    async run(accessor) {
...
class ReopenClosedEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3049, 'Reopen Closed Editor')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class ClearRecentFilesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3050, 'Clear Recently Opened...')),
            f1: true,
    ...
    async run(accessor) {
        ...
        const { confirmed } = await dialogService.confirm({
            type: 'warning',
            message: ( localize(3051, "Do you want to clear all recently opened files and workspaces?")),
            detail: ( localize(3052, "This action is irreversible!")),
            primaryButton: ( localize(3053, "&&Clear"))
        });
        if (!confirmed) {
            return;
        }
...
class ShowEditorsInActiveGroupByMostRecentlyUsedAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3054, 'Show Editors in Active Group By Most Recently Used')),
            f1: true,
            category: Categories.View
        });
    }
...
class ShowAllEditorsByAppearanceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3055, 'Show All Editors By Appearance')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class ShowAllEditorsByMostRecentlyUsedAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3056, 'Show All Editors By Most Recently Used')),
            f1: true,
            category: Categories.View
        });
    }
...
class QuickAccessPreviousRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3057, 'Quick Open Previous Recently Used Editor')),
            f1: true,
            category: Categories.View
...
class QuickAccessLeastRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3058, 'Quick Open Least Recently Used Editor')),
            f1: true,
            category: Categories.View
        }, AllEditorsByMostRecentlyUsedQuickAccess.PREFIX, undefined);
    }
...
class QuickAccessPreviousRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3059, 'Quick Open Previous Recently Used Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class QuickAccessLeastRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: ( localize2(3060, 'Quick Open Least Recently Used Editor in Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class QuickAccessPreviousEditorFromHistoryAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3061, 'Quick Open Previous Editor from History')),
            f1: true
        });
    }
    async run(accessor) {
...
class OpenNextRecentlyUsedEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3062, 'Open Next Recently Used Editor')),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenPreviousRecentlyUsedEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3063, 'Open Previous Recently Used Editor')),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenNextRecentlyUsedEditorInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3064, 'Open Next Recently Used Editor In Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class OpenPreviousRecentlyUsedEditorInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3065, 'Open Previous Recently Used Editor In Group')),
            f1: true,
            category: Categories.View
        });
    }
...
class ClearEditorHistoryAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3066, 'Clear Editor History')),
            f1: true
        });
    }
    async run(accessor) {
        ...
        const { confirmed } = await dialogService.confirm({
            type: 'warning',
            message: ( localize(3067, "Do you want to clear the history of recently opened editors?")),
            detail: ( localize(3052, "This action is irreversible!")),
            primaryButton: ( localize(3053, "&&Clear"))
        });
        if (!confirmed) {
...
class MoveEditorLeftInGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3068, 'Move Editor Left')),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveEditorRightInGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3069, 'Move Editor Right')),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveEditorToPreviousGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3070, 'Move Editor into Previous Group')),
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod.CtrlCmd | KeyMod.Alt | KeyCode.LeftArrow,
                mac: {
...
class MoveEditorToNextGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3071, 'Move Editor into Next Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
                primary: KeyMod.CtrlCmd | KeyMod.Alt | KeyCode.RightArrow,
...
class MoveEditorToAboveGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3072, 'Move Editor into Group Above')),
            f1: true,
            category: Categories.View
...
class MoveEditorToBelowGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3073, 'Move Editor into Group Below')),
            f1: true,
            category: Categories.View
...
class MoveEditorToLeftGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3074, 'Move Editor into Left Group')),
            f1: true,
            category: Categories.View
...
class MoveEditorToRightGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3075, 'Move Editor into Right Group')),
            f1: true,
            category: Categories.View
...
class MoveEditorToFirstGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3076, 'Move Editor into First Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class MoveEditorToLastGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3077, 'Move Editor into Last Group')),
            f1: true,
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
...
class SplitEditorToPreviousGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3078, 'Split Editor into Previous Group')),
            f1: true,
            category: Categories.View
...
class SplitEditorToNextGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3079, 'Split Editor into Next Group')),
            f1: true,
            category: Categories.View
...
class SplitEditorToAboveGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3080, 'Split Editor into Group Above')),
            f1: true,
            category: Categories.View
...
class SplitEditorToBelowGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3081, 'Split Editor into Group Below')),
            f1: true,
            category: Categories.View
...
class SplitEditorToLeftGroupAction extends ExecuteCommandAction {
    ...
    static { this.LABEL = ( localize(3082, "Split Editor into Left Group")); }
    constructor() {
        super({
            id: 'workbench.action.splitEditorToLeftGroup',
            title: ( localize2(3082, "Split Editor into Left Group")),
            f1: true,
            category: Categories.View
...
class SplitEditorToRightGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3083, 'Split Editor into Right Group')),
            f1: true,
            category: Categories.View
...
class SplitEditorToFirstGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3084, 'Split Editor into First Group')),
            f1: true,
            category: Categories.View
...
class SplitEditorToLastGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: ( localize2(3085, 'Split Editor into Last Group')),
            f1: true,
            category: Categories.View
...
class EditorLayoutSingleAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3086, 'Single Column Editor Layout')),
            f1: true,
            category: Categories.View
...
class EditorLayoutTwoColumnsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3087, 'Two Columns Editor Layout')),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}], orientation: GroupOrientation.HORIZONTAL });
    }
...
class EditorLayoutThreeColumnsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3088, 'Three Columns Editor Layout')),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}, {}], orientation: GroupOrientation.HORIZONTAL });
    }
...
class EditorLayoutTwoRowsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3089, 'Two Rows Editor Layout')),
            f1: true,
            category: Categories.View
...
class EditorLayoutThreeRowsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3090, 'Three Rows Editor Layout')),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}, {}], orientation: GroupOrientation.VERTICAL });
    }
...
class EditorLayoutTwoByTwoGridAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3091, 'Grid Editor Layout (2x2)')),
            f1: true,
            category: Categories.View
...
class EditorLayoutTwoColumnsBottomAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3092, 'Two Columns Bottom Editor Layout')),
            f1: true,
            category: Categories.View
...
class EditorLayoutTwoRowsRightAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(3093, 'Two Rows Right Editor Layout')),
            f1: true,
            category: Categories.View
...
class NewEditorGroupLeftAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3094, 'New Editor Group to the Left')),
            f1: true,
            category: Categories.View
        }, GroupDirection.LEFT);
    }
...
class NewEditorGroupRightAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3095, 'New Editor Group to the Right')),
            f1: true,
            category: Categories.View
        }, GroupDirection.RIGHT);
    }
...
class NewEditorGroupAboveAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3096, 'New Editor Group Above')),
            f1: true,
            category: Categories.View
        }, GroupDirection.UP);
    }
...
class NewEditorGroupBelowAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: ( localize2(3097, 'New Editor Group Below')),
            f1: true,
            category: Categories.View
        }, GroupDirection.DOWN);
    }
...
class ToggleEditorTypeAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3098, 'Toggle Editor Type')),
            f1: true,
            category: Categories.View,
...
class ReOpenInTextEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(3099, 'Reopen Editor With Text Editor')),
            f1: true,
            category: Categories.View,
            precondition: ActiveEditorAvailableEditorIdsContext
        });
...
class MoveEditorToNewWindowAction extends BaseMoveCopyEditorToNewWindowAction {
    constructor() {
        super(MOVE_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3100, "Move Editor into New Window")),
            mnemonicTitle: ( localize(3101, "&&Move Editor into New Window")),
        }, undefined, true);
    }
}
class CopyEditorToNewindowAction extends BaseMoveCopyEditorToNewWindowAction {
    constructor() {
        super(COPY_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3102, "Copy Editor into New Window")),
            mnemonicTitle: ( localize(3103, "&&Copy Editor into New Window")),
...
class MoveEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
    constructor() {
        super(MOVE_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3104, "Move Editor Group into New Window")),
            mnemonicTitle: ( localize(3105, "&&Move Editor Group into New Window")),
        }, true);
    }
}
class CopyEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
    constructor() {
        super(COPY_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, {
            ...( localize2(3106, "Copy Editor Group into New Window")),
            mnemonicTitle: ( localize(3107, "&&Copy Editor Group into New Window")),
        }, false);
    }
}
class RestoreEditorsToMainWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3108, "Restore Editors into Main Window")),
                mnemonicTitle: ( localize(3109, "&&Restore Editors into Main Window")),
            },
            f1: true,
...
class NewEmptyEditorWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3110, "New Empty Editor Window")),
                mnemonicTitle: ( localize(3111, "&&New Empty Editor Window")),
            },
            f1: true,
            category: Categories.View
        });
...
class ToggleOvertypeInsertMode extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(3112, "Toggle Overtype/Insert Mode")),
                mnemonicTitle: ( localize(3113, "&&Toggle Overtype/Insert Mode")),
            },
            metadata: {
                description: ( localize2(3114, "Toggle between overtype and insert mode")),
            },
            keybinding: {
                weight: KeybindingWeight.WorkbenchContrib,
