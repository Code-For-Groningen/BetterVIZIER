...
import { DEFAULT_EDITOR_ASSOCIATION, EditorInputCapabilities, isResourceMergeEditorInput } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/editor';
...
let MergeEditorInput = class MergeEditorInput extends AbstractTextResourceEditorInput {
    ...
    getName() {
        return localize(7342, "Merging: {0}", super.getName());
    }
    async resolve() {
        if (!this._inputModel) {
