...
import { CompareResult, equals } from '@codingame/monaco-vscode-api/vscode/vs/base/common/arrays';
...
import { autorunHandleChanges } from '@codingame/monaco-vscode-api/vscode/vs/base/common/observableInternal/autorun';
...
import { keepObserved } from '@codingame/monaco-vscode-api/vscode/vs/base/common/observableInternal/utils';
...
import { UndoRedoGroup, UndoRedoElementType } from '@codingame/monaco-vscode-api/vscode/vs/platform/undoRedo/common/undoRedo';
...
import { DocumentLineRangeMap, LineRangeMapping, DocumentRangeMap } from '@codingame/monaco-vscode-464d4abe-0937-5367-af84-1b9279e14ea3-common/vscode/vs/workbench/contrib/mergeEditor/browser/model/mapping';
import { TextModelDiffs, TextModelDiffState, TextModelDiffChangeReason } from './textModelDiffs.js';
import { leftJoin } from '@codingame/monaco-vscode-464d4abe-0937-5367-af84-1b9279e14ea3-common/vscode/vs/workbench/contrib/mergeEditor/browser/utils';
import { ModifiedBaseRange, ModifiedBaseRangeStateKind, ModifiedBaseRangeState } from '@codingame/monaco-vscode-464d4abe-0937-5367-af84-1b9279e14ea3-common/vscode/vs/workbench/contrib/mergeEditor/browser/model/modifiedBaseRange';
...
let MergeEditorModel = class MergeEditorModel extends EditorModel {
    ...
    setInputHandled(baseRange, inputNumber, handled, tx) {
        ...
        this.undoRedoService.pushElement({
            ...
            label: ( localize(7372, "Set Input Handled")),
            redo() {
...
class MarkAsHandledUndoRedoElement {
    constructor(resource, mergeEditorModelRef, stateRef, input1Handled, input2Handled) {
        ...
        this.label = ( localize(7373, 'Undo Mark As Handled'));
