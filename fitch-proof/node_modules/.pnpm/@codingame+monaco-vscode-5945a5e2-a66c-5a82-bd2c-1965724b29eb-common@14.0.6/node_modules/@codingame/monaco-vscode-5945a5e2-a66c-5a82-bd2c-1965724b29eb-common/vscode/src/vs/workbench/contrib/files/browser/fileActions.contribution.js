...
import { COPY_PATH_COMMAND_ID, COPY_RELATIVE_PATH_COMMAND_ID, REVEAL_IN_EXPLORER_COMMAND_ID, SAVE_FILE_LABEL, SAVE_FILE_COMMAND_ID, SAVE_FILE_WITHOUT_FORMATTING_LABEL, SAVE_FILE_WITHOUT_FORMATTING_COMMAND_ID, SAVE_ALL_IN_GROUP_COMMAND_ID, SAVE_FILES_COMMAND_ID, REVERT_FILE_COMMAND_ID, COMPARE_WITH_SAVED_COMMAND_ID, SAVE_FILE_AS_LABEL, SAVE_FILE_AS_COMMAND_ID, NEW_UNTITLED_FILE_LABEL, NEW_UNTITLED_FILE_COMMAND_ID, OPEN_TO_SIDE_COMMAND_ID, OpenEditorsGroupContext, OpenEditorsDirtyEditorContext, OpenEditorsReadonlyEditorContext, COMPARE_RESOURCE_COMMAND_ID, ResourceSelectedForCompareContext, SELECT_FOR_COMPARE_COMMAND_ID, COMPARE_SELECTED_COMMAND_ID, OpenEditorsSelectedFileOrUntitledContext, OPEN_WITH_EXPLORER_COMMAND_ID, REMOVE_ROOT_FOLDER_LABEL, REMOVE_ROOT_FOLDER_COMMAND_ID, SAVE_ALL_COMMAND_ID } from '@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/files/browser/fileConstants';
...
import { FilesExplorerFocusCondition, ExplorerRootContext, ExplorerResourceWritableContext, ExplorerResourceMoveableToTrash, ExplorerResourceCut, ExplorerFolderContext, ExplorerResourceAvailableEditorIdsContext, FoldersViewVisibleContext } from '@codingame/monaco-vscode-eea37658-2307-56a5-8ed0-b2752c7b7a50-common/vscode/vs/workbench/contrib/files/common/files';
import { ADD_ROOT_FOLDER_LABEL, ADD_ROOT_FOLDER_COMMAND_ID } from '@codingame/monaco-vscode-eea37658-2307-56a5-8ed0-b2752c7b7a50-common/vscode/vs/workbench/browser/actions/workspaceCommands';
import { REOPEN_WITH_COMMAND_ID, CLOSE_EDITOR_COMMAND_ID, CLOSE_OTHER_EDITORS_IN_GROUP_COMMAND_ID, CLOSE_SAVED_EDITORS_COMMAND_ID, CLOSE_EDITORS_IN_GROUP_COMMAND_ID } from '@codingame/monaco-vscode-f48982c4-9e82-55e2-b800-20e6d1e6096f-common/vscode/vs/workbench/browser/parts/editor/editorCommands';
import { AutoSaveAfterShortDelayContext } from '@codingame/monaco-vscode-ce8c4b18-4e75-55dd-9656-517347af9de7-common/vscode/vs/workbench/services/filesConfiguration/common/filesConfigurationService';
...
const copyPathCommand = {
    ...
    title: ( localize(6535, "Copy Path"))
};
const copyRelativePathCommand = {
    id: COPY_RELATIVE_PATH_COMMAND_ID,
    title: ( localize(6536, "Copy Relative Path"))
};
const revealInSideBarCommand = {
    id: REVEAL_IN_EXPLORER_COMMAND_ID,
    title: ( localize(6537, "Reveal in Explorer View"))
};
...
appendSaveConflictEditorTitleAction('workbench.files.action.acceptLocalChanges', ( localize(6538, "Use your changes and overwrite file contents")), Codicon.check, -10, acceptLocalChangesCommand);
appendSaveConflictEditorTitleAction('workbench.files.action.revertLocalChanges', ( localize(6539, "Discard your changes and revert to file contents")), Codicon.discard, -9, revertLocalChangesCommand);
...
appendToCommandPalette({
    id: COPY_PATH_COMMAND_ID,
    title: ( localize2(6540, "Copy Path of Active File")),
    category: Categories.File
});
appendToCommandPalette({
    id: COPY_RELATIVE_PATH_COMMAND_ID,
    title: ( localize2(6541, "Copy Relative Path of Active File")),
    category: Categories.File
});
appendToCommandPalette({
...
appendToCommandPalette({
    ...
    title: ( localize2(6542, "Save All in Group")),
    category: Categories.File
});
appendToCommandPalette({
    id: SAVE_FILES_COMMAND_ID,
    title: ( localize2(6543, "Save All Files")),
    category: Categories.File
});
appendToCommandPalette({
    id: REVERT_FILE_COMMAND_ID,
    title: ( localize2(6544, "Revert File")),
    category: Categories.File
});
appendToCommandPalette({
    id: COMPARE_WITH_SAVED_COMMAND_ID,
    title: ( localize2(6545, "Compare Active File with Saved")),
    category: Categories.File,
    metadata: {
...
appendToCommandPalette({
    ...
    category: Categories.File,
    metadata: { description: ( localize2(6547, "Create a new folder or directory")) }
}, ( WorkspaceFolderCountContext.notEqualsTo('0')));
appendToCommandPalette({
...
const openToSideCommand = {
    ...
    title: ( localize(6548, "Open to the Side"))
};
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        ...
        title: ( localize(6549, "Reopen Editor With..."))
    },
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        id: REVERT_FILE_COMMAND_ID,
        title: ( localize(6544, "Revert File")),
        precondition: OpenEditorsDirtyEditorContext
    },
    when: ( ContextKeyExpr.and((
    OpenEditorsGroupContext.toNegated()), (
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        id: COMPARE_WITH_SAVED_COMMAND_ID,
        title: ( localize(6551, "Compare with Saved")),
        precondition: OpenEditorsDirtyEditorContext
    },
...
const compareResourceCommand = {
    ...
    title: ( localize(6552, "Compare with Selected"))
};
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: '3_compare',
    order: 20,
...
const selectForCompareCommand = {
    ...
    title: ( localize(6553, "Select for Compare"))
};
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: '3_compare',
    order: 30,
...
const compareSelectedCommand = {
    ...
    title: ( localize(6554, "Compare Selected"))
};
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: '3_compare',
    order: 30,
...
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        ...
        title: ( localize(6556, "Close Others"))
    },
    when: ( OpenEditorsGroupContext.toNegated())
});
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    ...
    command: {
        ...
        title: ( localize(6557, "Close Saved"))
    }
});
MenuRegistry.appendMenuItem(MenuId.OpenEditorsContext, {
    group: '4_close',
...
MenuRegistry.appendMenuItem(MenuId.ExplorerContext, {
    ...
    alt: {
        id: DELETE_FILE_ID,
        title: ( localize(6561, "Delete Permanently"))
    },
...
for (const menuId of [MenuId.EmptyEditorGroupContext, MenuId.EditorTabsBarContext]) {
    MenuRegistry.appendMenuItem(menuId, { command: { id: NEW_UNTITLED_FILE_COMMAND_ID, title: ( localize(6562, "New Text File")) }, group: '1_file', order: 10 });
    MenuRegistry.appendMenuItem(menuId, { command: { id: 'workbench.action.quickOpen', title: ( localize(6563, "Open File...")) }, group: '1_file', order: 20 });
}
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    group: '1_new',
    command: {
        id: NEW_UNTITLED_FILE_COMMAND_ID,
        title: ( localize(6564, "&&New Text File"))
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        ...
        title: ( localize(6568, "A&&uto Save")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: REVERT_FILE_COMMAND_ID,
        title: ( localize(6569, "Re&&vert File")),
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: CLOSE_EDITOR_COMMAND_ID,
        title: ( localize(6570, "&&Close Editor")),
        precondition: ( ContextKeyExpr.or(ActiveEditorContext, ( ContextKeyExpr.and(FoldersViewVisibleContext, SidebarFocusContext))))
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarGoMenu, {
    ...
    command: {
        ...
        title: ( localize(6571, "Go to &&File..."))
    },
    order: 1
});
