...
import { RemoveRootFolderAction } from '@codingame/monaco-vscode-eea37658-2307-56a5-8ed0-b2752c7b7a50-common/vscode/vs/workbench/browser/actions/workspaceActions';
import { OpenEditorsView } from '@codingame/monaco-vscode-3cf6a388-482f-5484-a806-0525ad9ad8af-common/vscode/vs/workbench/contrib/files/browser/views/openEditorsView';
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    handler: async (accessor, resource) => {
        ...
        if (uri && fileService.hasProvider(uri)) {
            ...
            const editorLabel = ( localize(6671, "{0} (in file) ↔ {1}", name, name));
            try {
...
CommandsRegistry.registerCommand({
    ...
    handler: async (accessor, args) => {
        ...
        const fileService = accessor.get(IFileService);
        const createFileLocalized = ( localize(6672, "Create File"));
