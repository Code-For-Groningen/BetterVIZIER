...
import { compareIgnoreCase, equalsIgnoreCase } from '@codingame/monaco-vscode-api/vscode/vs/base/common/strings';
import { Language } from '@codingame/monaco-vscode-api/vscode/vs/base/common/platform';
import { or, matchesPrefix, matchesWords, matchesContiguousSubString, matchesCamelCase } from '@codingame/monaco-vscode-api/vscode/vs/base/common/filters';
import { UserSettingsLabelProvider, AriaLabelProvider, UILabelProvider } from '@codingame/monaco-vscode-api/vscode/vs/base/common/keybindingLabels';
...
import { isString, isEmptyObject } from '@codingame/monaco-vscode-api/vscode/vs/base/common/types';
import { IExtensionService } from '@codingame/monaco-vscode-api/vscode/vs/workbench/services/extensions/common/extensions.service';
import { ExtensionIdentifier, ExtensionIdentifierMap } from '@codingame/monaco-vscode-api/vscode/vs/platform/extensions/common/extensions';
import { ContextKeyExpr } from '@codingame/monaco-vscode-api/vscode/vs/platform/contextkey/common/contextkey';

var KeybindingsEditorModel_1;
const KEYBINDING_ENTRY_TEMPLATE_ID = 'keybinding.entry.template';
const SOURCE_SYSTEM = ( localize(11900, "System"));
const SOURCE_EXTENSION = ( localize(11901, "Extension"));
const SOURCE_USER = ( localize(11902, "User"));
    ...
    static getCommandDefaultLabel(menuCommand) {
        if (!Language.isDefaultVariant()) {
            if (menuCommand && menuCommand.title && menuCommand.title.original) {
                ...
                return category ? ( localize(11903, "{0}: {1}", category, title)) : title;
            }
        }
        return null;
    }
...
class KeybindingItemMatches {
    ...
    wordMatchesAltModifier(word) {
        ...
        if (equalsIgnoreCase(( localize(11904, "option")), word)) {
            return true;
        }
        return false;
    }
    ...
    wordMatchesMetaModifier(word) {
        ...
        if (equalsIgnoreCase(( localize(11905, "meta")), word)) {
            return true;
        }
        return false;
    }
