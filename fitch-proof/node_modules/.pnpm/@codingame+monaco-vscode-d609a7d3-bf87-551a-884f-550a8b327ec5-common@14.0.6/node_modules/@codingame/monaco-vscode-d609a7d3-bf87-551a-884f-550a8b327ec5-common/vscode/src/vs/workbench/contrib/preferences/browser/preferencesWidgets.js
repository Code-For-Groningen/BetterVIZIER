...
let SettingsTargetsWidget = class SettingsTargetsWidget extends Widget {
    ...
    resetLabels() {
        ...
        this.userLocalSettings.label = ( localize(8174, "User"));
        this.userRemoteSettings.label = ( localize(8175, "Remote")) + (hostLabel ? ` [${hostLabel}]` : '');
        this.workspaceSettings.label = ( localize(8176, "Workspace"));
        this.folderSettingsAction.label = ( localize(8177, "Folder"));
    }
    create(parent) {
        ...
        this.settingsSwitcherBar = this._register(( new ActionBar(settingsTabsWidget, {
            ...
            ariaLabel: ( localize(8178, "Settings Switcher")),
            ariaRole: 'tablist',
        ...
        this.userLocalSettings.tooltip = ( localize(8174, "User"));
        ...
        const remoteAuthority = this.environmentService.remoteAuthority;
        const hostLabel = remoteAuthority && this.labelService.getHostLabel(Schemas.vscodeRemote, remoteAuthority);
        this.userRemoteSettings.tooltip = ( localize(8175, "Remote")) + (hostLabel ? ` [${hostLabel}]` : '');
    ...
    setResultCount(settingsTarget, count) {
        if (settingsTarget === ConfigurationTarget.WORKSPACE) {
            let label = ( localize(8176, "Workspace"));
            if (count) {
                label += ` (${count})`;
            }
    ...
    async update() {
        ...
        this.workspaceSettings.tooltip = ( localize(8176, "Workspace"));
    }
};
