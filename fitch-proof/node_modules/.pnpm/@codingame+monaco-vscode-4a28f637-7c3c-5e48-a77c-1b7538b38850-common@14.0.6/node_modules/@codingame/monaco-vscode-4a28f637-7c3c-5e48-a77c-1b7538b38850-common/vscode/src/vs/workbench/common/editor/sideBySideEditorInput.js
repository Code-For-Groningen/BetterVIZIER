...
import { EditorInputCapabilities, isResourceDiffEditorInput, isResourceMultiDiffEditorInput, isResourceSideBySideEditorInput, isResourceMergeEditorInput, isEditorInput, findViewStateForEditor, isResourceEditorInput, isDiffEditorInput, EditorExtensions } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/editor';
...
let SideBySideEditorInput = class SideBySideEditorInput extends EditorInput {
    ...
    getName() {
        ...
        return localize(3768, "{0} - {1}", this.secondary.getName(), this.primary.getName());
    }
    getPreferredName() {
