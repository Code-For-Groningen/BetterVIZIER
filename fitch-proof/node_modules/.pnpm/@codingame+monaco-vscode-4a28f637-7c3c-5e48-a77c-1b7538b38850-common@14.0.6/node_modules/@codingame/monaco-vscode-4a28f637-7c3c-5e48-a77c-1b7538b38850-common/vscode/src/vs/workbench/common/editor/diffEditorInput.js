...
import { EditorInputCapabilities, Verbosity, BINARY_DIFF_EDITOR_ID, TEXT_DIFF_EDITOR_ID, isResourceDiffEditorInput } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/editor';
...
import { isResolvedEditorModel } from '@codingame/monaco-vscode-api/vscode/vs/platform/editor/common/editor';
...
let DiffEditorInput = class DiffEditorInput extends SideBySideEditorInput {
    ...
    computeLabels() {
        ...
        if (this.preferredName) {
            ...
            name = ( localize(3767, "{0} ↔ {1}", originalName, modifiedName));
