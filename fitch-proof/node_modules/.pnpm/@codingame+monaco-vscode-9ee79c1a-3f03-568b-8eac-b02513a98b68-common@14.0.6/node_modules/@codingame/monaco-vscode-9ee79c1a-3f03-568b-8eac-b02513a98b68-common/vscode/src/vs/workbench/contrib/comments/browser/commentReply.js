...
let CommentReply = class CommentReply extends Disposable {
    ...
    setCommentEditorDecorations() {
        ...
        const placeholder = hasExistingComments
            ? (this._commentOptions?.placeHolder || ( localize(4960, "Reply...")))
            : (this._commentOptions?.placeHolder || ( localize(4961, "Type a new comment")));
    ...
    createReplyButton(commentEditor, commentForm) {
        ...
        this._register(this.hoverService.setupManagedHover(getDefaultHoverDelegate('mouse'), this._reviewThreadReplyButton, this._commentOptions?.prompt || ( localize(4960, "Reply..."))));
        this._reviewThreadReplyButton.textContent = this._commentOptions?.prompt || ( localize(4960, "Reply..."));
