...
const collapseIcon = registerIcon('review-comment-collapse', Codicon.chevronUp, ( localize(4965, 'Icon to collapse a review comment.')));
...
let CommentThreadHeader = class CommentThreadHeader extends Disposable {
    ...
    _fillHead() {
        ...
        this._collapseAction = ( new Action(CommentCommandId.Hide, ( localize(4966, "Collapse")), collapseClass, true, () => this._delegate.collapse()));
    ...
    createThreadLabel() {
        ...
        if (label === undefined) {
            if (!(this._commentThread.comments && this._commentThread.comments.length)) {
                label = ( localize(4967, "Start discussion"));
            }
        }
        if (label) {
