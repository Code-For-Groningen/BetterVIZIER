                    ...
                    async () => {
                        try {
                            ...
                            const error = e.message
                                ? ( localize(4954, "Toggling the comment reaction failed: {0}.", e.message))
                                : ( localize(4955, "Toggling the comment reaction failed"));
                ...
                async () => {
                    try {
                        ...
                        if (reaction.hasReacted) {
                            error = e.message
                                ? ( localize(4956, "Deleting the comment reaction failed: {0}.", e.message))
                                : ( localize(4957, "Deleting the comment reaction failed"));
                        }
                        else {
                            error = e.message
                                ? ( localize(4958, "Deleting the comment reaction failed: {0}.", e.message))
                                : ( localize(4959, "Deleting the comment reaction failed"));
                        }
                        this.notificationService.error(error);
                    }
                },
