...
import { h, scheduleAtNextAnimationFrame, getWindow } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dom';
...
import { findFirstMax } from '@codingame/monaco-vscode-api/vscode/vs/base/common/arraysFind';
import { BugIndicatingError } from '@codingame/monaco-vscode-api/vscode/vs/base/common/errors';
import { Disposable, toDisposable } from '@codingame/monaco-vscode-api/vscode/vs/base/common/lifecycle';
import { transaction, globalTransaction, disposableObservableValue, observableValue } from '@codingame/monaco-vscode-api/vscode/vs/base/common/observableInternal/base';
...
import { ObservableElementSizeObserver } from '@codingame/monaco-vscode-api/vscode/vs/editor/browser/widget/diffEditor/utils';
    ...
    constructor(_element, _dimension, _viewModel, _workbenchUIElementFactory, _parentContextKeyService, _parentInstantiationService) {
        ...
        const placeholderMessage = derived(reader => {
            ...
            return (!vm || vm.isLoading.read(reader))
                ? ( localize(208, 'Loading...'))
                : ( localize(209, 'No Changed Files'));
        });
        this._register(autorun((reader) => {
