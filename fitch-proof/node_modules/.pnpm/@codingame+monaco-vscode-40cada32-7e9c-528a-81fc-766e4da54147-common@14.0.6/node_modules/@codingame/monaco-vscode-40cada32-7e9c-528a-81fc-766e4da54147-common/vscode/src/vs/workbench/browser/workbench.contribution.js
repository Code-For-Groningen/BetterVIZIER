...
import { isMacintosh, isNative, isWeb, isWindows, isLinux } from '@codingame/monaco-vscode-api/vscode/vs/base/common/platform';
import { ConfigurationMigrationWorkbenchContribution, DynamicWorkbenchSecurityConfiguration, workbenchConfigurationNodeBase, windowConfigurationNodeBase, DynamicWindowConfiguration, problemsConfigurationNodeBase, Extensions as Extensions$1 } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/configuration';
import { isStandalone } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/browser';
import { registerWorkbenchContribution2, WorkbenchPhase } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/contributions';
import { EditorActionsLocation, EditorTabsMode, LayoutSettings, ActivityBarPosition } from '@codingame/monaco-vscode-api/vscode/vs/workbench/services/layout/browser/layoutService';
...
(function registerConfiguration() {
    ...
    registry.registerConfiguration({
        ...
        'properties': {
            ...
            'workbench.editor.titleScrollbarSizing': {
                ...
                enum: ['default', 'large'],
                enumDescriptions: [
                    ( localize(3463, "The default size.")),
                    ( localize(
                    3464,
            ...
            [LayoutSettings.EDITOR_TABS_MODE]: {
                ...
                'enumDescriptions': [
                    ( localize(3466, "Each editor is displayed as a tab in the editor title area.")),
                    ( localize(
                    3467,
                    "The active editor is displayed as a single large tab in the editor title area."
                )),
                    ( localize(3468, "The editor title area is not displayed.")),
                ],
                'description': ( localize(
                    3469,
            ...
            [LayoutSettings.EDITOR_ACTIONS_LOCATION]: {
                ...
                'markdownEnumDescriptions': [
                    ...
                    ( localize(3472, "Editor actions are not shown.")),
                ],
                'markdownDescription': ( localize(3473, "Controls where the editor actions are shown.")),
                'default': 'default'
            },
            ...
            'workbench.editor.decorations.badges': {
                'type': 'boolean',
                'markdownDescription': ( localize(3478, "Controls whether editor file decorations should use badges.")),
                'default': true
            },
            'workbench.editor.decorations.colors': {
                'type': 'boolean',
                'markdownDescription': ( localize(3479, "Controls whether editor file decorations should use colors.")),
                'default': true
            },
            ...
            'workbench.editor.labelFormat': {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(3490, "Show the name of the file followed by its directory name.")),
                    ( localize(
                    3491,
                    "Show the name of the file followed by its path relative to the workspace folder."
                )),
                    ( localize(3492, "Show the name of the file followed by its absolute path."))
                ],
                'default': 'default',
                'description': ( localize(3493, "Controls the format of the label for an editor.")),
            },
            'workbench.editor.untitled.labelFormat': {
                ...
                'default': 'content',
                'description': ( localize(3496, "Controls the format of the label for an untitled editor.")),
            },
            ...
            'workbench.editor.languageDetectionHints': {
                ...
                properties: {
                    untitledEditors: {
                        type: 'boolean',
                        description: ( localize(3502, "Show in untitled text editors")),
                    },
                    notebookEditors: {
                        type: 'boolean',
                        description: ( localize(3503, "Show in notebook editors")),
                    }
                }
            },
            ...
            'workbench.editor.tabActionCloseVisibility': {
                type: 'boolean',
                default: true,
                description: ( localize(3505, "Controls the visibility of the tab close action button."))
            },
            'workbench.editor.tabActionUnpinVisibility': {
                type: 'boolean',
                default: true,
                description: ( localize(3506, "Controls the visibility of the tab unpin action button."))
            },
            'workbench.editor.tabSizing': {
                ...
                'default': 'fit',
                'enumDescriptions': [
                    ( localize(3507, "Always keep tabs large enough to show the full editor label.")),
                    ( localize(
                    3508,
            ...
            'workbench.editor.pinnedTabSizing': {
                ...
                'default': 'normal',
                'enumDescriptions': [
                    ( localize(3514, "A pinned tab inherits the look of non pinned tabs.")),
                    ( localize(
                    3515,
            ...
            'workbench.editor.preventPinnedEditorClose': {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(3520, "Prevent closing the pinned editor when using the keyboard.")),
                    ( localize(3521, "Prevent closing the pinned editor when using mouse middle click.")),
                    ( localize(3522, "Never prevent closing a pinned editor."))
                ],
                description: ( localize(
                    3523,
            ...
            'workbench.editor.splitSizing': {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(3525, "Splits all the editor groups to equal parts.")),
                    ( localize(3526, "Splits the active editor group to equal parts."))
                ],
                'description': ( localize(3527, "Controls the size of editor groups when splitting them."))
            },
            ...
            'workbench.editor.navigationScope': {
                ...
                'enumDescriptions': [
                    ( localize(3542, "Navigate across all opened editors and editor groups.")),
                    ( localize(3543, "Navigate only in editors of the active editor group.")),
                    ( localize(3544, "Navigate only in the active editor."))
                ],
            },
            ...
            'workbench.editor.splitInGroupLayout': {
                ...
                'enumDescriptions': [
                    ( localize(3548, "Editors are positioned from top to bottom.")),
                    ( localize(3549, "Editors are positioned from left to right."))
                ]
            },
            ...
            'workbench.editor.doubleClickTabToToggleEditorGroupSizes': {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(3555, "No editor group is resized when double clicking on a tab."))
                ]
            },
            ...
            'workbench.commandPalette.experimental.askChatLocation': {
                'type': 'string',
                tags: ['experimental'],
                'description': ( localize(3568, "Controls where the command palette should ask chat questions.")),
                'default': 'chatView',
                enum: ['chatView', 'quickChat'],
                enumDescriptions: [
                    ( localize(3569, "Ask chat questions in the Chat view.")),
                    ( localize(3570, "Ask chat questions in Quick Chat."))
                ]
            },
            ...
            'workbench.panel.opensMaximized': {
                ...
                'enumDescriptions': [
                    ( localize(3581, "Always maximize the panel when opening it.")),
                    ( localize(
                    3582,
                    "Never maximize the panel when opening it. The panel will open un-maximized."
                )),
                    ( localize(3583, "Open the panel to the state that it was in, before it was closed."))
                ]
            },
            ...
            [LayoutSettings.ACTIVITY_BAR_LOCATION]: {
                ...
                'enumDescriptions': [
                    ...
                    ( localize(3589, "Hide the Activity Bar in the Primary and Secondary Side Bars."))
                ],
            },
            'workbench.activityBar.iconClickBehavior': {
                ...
                'enumDescriptions': [
                    ( localize(3591, "Hide the Primary Side Bar if the clicked item is already visible.")),
                    ( localize(3592, "Focus the Primary Side Bar if the clicked item is already visible."))
                ]
            },
            ...
            'workbench.view.showQuietly': {
                ...
                'properties': {
                    'workbench.panel.output': {
                        'type': 'boolean',
                        'description': ( localize(3595, "Output view"))
                    }
                },
                'additionalProperties': false
            },
            'workbench.fontAliasing': {
                ...
                'default': 'default',
                'description': ( localize(3596, "Controls font aliasing method in the workbench.")),
                'enumDescriptions': [
                    ( localize(
                    3597,
                    ...
                    ( localize(3599, "Disables font smoothing. Text will show with jagged sharp edges.")),
                    ( localize(
                    3600,
            ...
            'workbench.settings.editor': {
                ...
                'enum': ['ui', 'json'],
                'enumDescriptions': [
                    ( localize(3601, "Use the settings UI editor.")),
                    ( localize(3602, "Use the JSON file editor.")),
                ],
                'description': ( localize(3603, "Determines which settings editor to use by default.")),
                'default': 'ui',
                'scope': ConfigurationScope.WINDOW
            },
            ...
            'workbench.reduceMotion': {
                ...
                'enumDescriptions': [
                    ( localize(3606, "Always render with reduced motion.")),
                    ( localize(3607, "Do not render with reduced motion")),
                    ( localize(3608, "Render with reduced motion based on OS configuration.")),
                ],
                default: 'auto',
                tags: ['accessibility'],
                enum: ['on', 'off', 'auto']
            ...
            'workbench.navigationControl.enabled': {
                ...
                'markdownDescription': isWeb ?
                    ( localize(3609, "Controls whether the navigation control in the title bar is shown.")) :
                    ( localize(
                    3610,
            ...
            [LayoutSettings.LAYOUT_ACTIONS]: {
                ...
                'default': true,
                'markdownDescription': isWeb ?
                    ( localize(3611, "Controls whether the layout control in the title bar is shown.")) :
                    ( localize(
                    3612,
            ...
            'workbench.layoutControl.type': {
                ...
                'enumDescriptions': [
                    ( localize(3613, "Shows a single button with a dropdown of layout options.")),
                    ( localize(
                    3614,
                    "Shows several buttons for toggling the visibility of the panels and side bar."
                )),
                    ( localize(3615, "Shows both the dropdown and toggle buttons.")),
                ],
                'default': 'both',
                'description': ( localize(
                    3616,
            ...
            'workbench.tips.enabled': {
                'type': 'boolean',
                'default': true,
                'description': ( localize(3617, "When enabled, will show the watermark tips when no editor is open."))
            },
        }
    });
    ...
    windowTitleDescription += '\n- ' + [
        ( localize(3619, "`${activeEditorShort}`: the file name (e.g. myFile.txt).")),
        ( localize(
        3620,
        ...
        ( localize(3631, "`${appName}`: e.g. VS Code.")),
        ( localize(3632, "`${remoteName}`: e.g. SSH")),
        ( localize(
        3633,
        "`${dirty}`: an indicator for when the active editor has unsaved changes."
    )),
        ( localize(3634, "`${focusedView}`: the name of the view that is currently focused.")),
        ( localize(
        3635,
    ...
    registry.registerConfiguration({
        ...
        'properties': {
            ...
            'window.titleSeparator': {
                ...
                'markdownDescription': ( localize(3638, "Separator used by {0}.", '`#window.title#`'))
            },
            [LayoutSettings.COMMAND_CENTER]: {
                type: 'boolean',
                default: true,
                markdownDescription: isWeb ?
                    ( localize(3639, "Show command launcher together with the window title.")) :
                    ( localize(
                    3640,
            ...
            'window.menuBarVisibility': {
                ...
                'markdownEnumDescriptions': [
                    ...
                    ( localize(3645, "Menu is always hidden.")),
                    isWeb ?
                        ( localize(3646, "Menu is displayed as a compact button in the side bar.")) :
                        ( localize(
                        3647,
            ...
            'window.openFilesInNewWindow': {
                ...
                'enum': ['on', 'off', 'default'],
                'enumDescriptions': [
                    ( localize(3652, "Files will open in a new window.")),
                    ( localize(
                    3653,
            ...
            'window.openFoldersInNewWindow': {
                ...
                'enum': ['on', 'off', 'default'],
                'enumDescriptions': [
                    ( localize(3658, "Folders will open in a new window.")),
                    ( localize(3659, "Folders will replace the last active window.")),
                    ( localize(
                    3660,
            ...
            'window.confirmBeforeClose': {
                ...
                'enumDescriptions': [
                    isWeb ?
                        ...
                        ( localize(3663, "Always ask for confirmation.")),
                    isWeb ?
                        ( localize(
                        3664,
                        ...
                        ( localize(3665, "Only ask for confirmation if a keybinding was used.")),
                    isWeb ?
                        ( localize(
                        3666,
                        "Never explicitly ask for confirmation unless data loss is imminent."
                    )) :
                        ( localize(3667, "Never explicitly ask for confirmation."))
                ],
    ...
    registry.registerConfiguration({
        ...
        'properties': {
            ...
            'zenMode.centerLayout': {
                'type': 'boolean',
                'default': true,
                'description': ( localize(3673, "Controls whether turning on Zen Mode also centers the layout."))
            },
            'zenMode.showTabs': {
                'type': 'string',
                ...
                'enumDescriptions': [
                    ( localize(3675, "Each editor is displayed as a tab in the editor title area.")),
                    ( localize(
                    3676,
                    "The active editor is displayed as a single large tab in the editor title area."
                )),
                    ( localize(3677, "The editor title area is not displayed.")),
                ],
                'default': 'multiple'
            },
...
( Registry.as(Extensions$1.ConfigurationMigration))
