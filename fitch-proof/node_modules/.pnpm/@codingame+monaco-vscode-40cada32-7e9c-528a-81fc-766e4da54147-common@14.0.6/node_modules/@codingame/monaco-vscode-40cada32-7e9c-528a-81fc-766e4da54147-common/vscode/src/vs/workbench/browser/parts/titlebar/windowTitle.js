...
import { Verbosity, EditorResourceAccessor, SideBySideEditor } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/editor';
...
import { isMacintosh, isNative, isWeb, isWindows } from '@codingame/monaco-vscode-api/vscode/vs/base/common/platform';
import { trim } from '@codingame/monaco-vscode-api/vscode/vs/base/common/strings';
import { template } from '@codingame/monaco-vscode-api/vscode/vs/base/common/labels';
import { Verbosity as Verbosity$1 } from '@codingame/monaco-vscode-2cbab29e-9393-5de6-b701-9a9555360b6b-common/vscode/vs/platform/label/common/label';
...
let WindowTitle = class WindowTitle extends Disposable {
    ...
    static { this.NLS_USER_IS_ADMIN = isWindows ? ( localize(3420, "[Administrator]")) : ( localize(3421, "[Superuser]")); }
    static { this.NLS_EXTENSION_HOST = ( localize(3422, "[Extension Development Host]")); }
