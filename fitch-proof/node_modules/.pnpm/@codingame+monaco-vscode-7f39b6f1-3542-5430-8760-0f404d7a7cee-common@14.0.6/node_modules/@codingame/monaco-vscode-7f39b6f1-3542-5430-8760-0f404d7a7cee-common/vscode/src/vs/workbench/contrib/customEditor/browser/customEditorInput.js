...
import { dirname, isEqual } from '@codingame/monaco-vscode-api/vscode/vs/base/common/resources';
...
import { EditorInputCapabilities, Verbosity, createEditorOpenError } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/editor';
        ...
        if (this.doCanMove(targetWindow.vscodeWindowId) !== true) {
            throw createEditorOpenError(( localize(
                ...
                toAction({
                    ...
                    label: ( localize(5081, "Open in Original Window")),
                    run: async () => {
