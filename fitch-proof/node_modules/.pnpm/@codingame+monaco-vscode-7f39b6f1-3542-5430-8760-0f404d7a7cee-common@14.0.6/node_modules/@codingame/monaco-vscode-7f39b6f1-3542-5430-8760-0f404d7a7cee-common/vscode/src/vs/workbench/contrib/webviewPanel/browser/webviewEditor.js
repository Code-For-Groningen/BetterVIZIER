...
import { WebviewWindowDragMonitor } from '@codingame/monaco-vscode-771c2e6d-0284-5ac1-be73-7176085eedc5-common/vscode/vs/workbench/contrib/webview/browser/webviewWindowDragMonitor';
...
const CONTEXT_ACTIVE_WEBVIEW_PANEL_ID = ( new RawContextKey('activeWebviewPanelId', '', {
    type: 'string',
    description: ( localize(10929, "The viewType of the currently active webview panel.")),
}));
