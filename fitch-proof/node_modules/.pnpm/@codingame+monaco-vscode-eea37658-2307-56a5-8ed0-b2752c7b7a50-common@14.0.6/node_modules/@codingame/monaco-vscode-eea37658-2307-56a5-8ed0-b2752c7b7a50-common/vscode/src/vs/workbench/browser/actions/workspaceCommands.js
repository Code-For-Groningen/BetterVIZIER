...
import { hasWorkspaceFileExtension } from '@codingame/monaco-vscode-api/vscode/vs/platform/workspace/common/workspace';
...
const ADD_ROOT_FOLDER_LABEL = ( localize2(2736, 'Add Folder to Workspace...'));
...
async function selectWorkspaceFolders(accessor) {
    ...
    const folders = await dialogsService.showOpenDialog({
        openLabel: mnemonicButtonLabel(( localize(2737, "&&Add"))),
        title: ( localize(2738, "Add Folder to Workspace")),
...
CommandsRegistry.registerCommand(PICK_WORKSPACE_FOLDER_COMMAND_ID, async function (accessor, args) {
    ...
    if (!options.placeHolder) {
        options.placeHolder = ( localize(2739, "Select workspace folder"));
    }
