...
import { hasWorkspaceFileExtension, WorkbenchState } from '@codingame/monaco-vscode-api/vscode/vs/platform/workspace/common/workspace';
...
import { OpenFolderWorkspaceSupportContext, WorkbenchStateContext, EnterMultiRootWorkspaceSupportContext, EmptyWorkspaceSupportContext, WorkspaceFolderCountContext } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/contextkeys';
...
class OpenFolderAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2719, 'Open Folder...')),
            category: Categories.File,
            f1: true,
...
class OpenFileFolderAction extends Action2 {
    ...
    static { this.LABEL = ( localize2(2720, 'Open...')); }
    constructor() {
        super({
...
class OpenWorkspaceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2721, 'Open Workspace from File...')),
            category: Categories.File,
            f1: true,
...
class CloseWorkspaceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2722, 'Close Workspace')),
...
class OpenWorkspaceConfigFileAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2723, 'Open Workspace Configuration File')),
            category: workspacesCategory,
            f1: true,
...
class RemoveRootFolderAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2724, 'Remove Folder from Workspace...')),
            category: workspacesCategory,
            f1: true,
...
class SaveWorkspaceAsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2725, 'Save Workspace As...')),
            category: workspacesCategory,
            f1: true,
            precondition: EnterMultiRootWorkspaceSupportContext
        });
...
class DuplicateWorkspaceInNewWindowAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2726, 'Duplicate As Workspace in New Window')),
            category: workspacesCategory,
            f1: true,
            precondition: EnterMultiRootWorkspaceSupportContext
        });
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: OpenFolderAction.ID,
        title: ( localize(2728, "Open &&Folder..."))
    },
    order: 2,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: OpenWorkspaceAction.ID,
        title: ( localize(2730, "Open Wor&&kspace from File..."))
    },
    order: 3,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        ...
        title: ( localize(2731, "A&&dd Folder to Workspace..."))
    },
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: SaveWorkspaceAsAction.ID,
        title: ( localize(2732, "Save Workspace As..."))
    },
    order: 2,
    when: EnterMultiRootWorkspaceSupportContext
});
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: DuplicateWorkspaceInNewWindowAction.ID,
        title: ( localize(2733, "Duplicate Workspace"))
    },
    order: 3,
    when: EnterMultiRootWorkspaceSupportContext
});
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: CloseWorkspaceAction.ID,
        title: ( localize(2734, "Close &&Folder"))
    },
    order: 3,
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
    ...
    command: {
        id: CloseWorkspaceAction.ID,
        title: ( localize(2735, "Close &&Workspace"))
    },
    order: 3,
