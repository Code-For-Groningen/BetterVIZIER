...
import { $, getWindow, append, trackFocus, EventType, addDisposableListener, EventHelper, isHTMLElement, clearNode } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dom';
...
class Pane extends Disposable {
    ...
    constructor(options) {
        ...
        this._ariaHeaderLabel = ( localize(30, "{0} Section", options.title));
