...
import { $, append, addStandardDisposableListener, EventType, trackFocus } from '@codingame/monaco-vscode-api/vscode/vs/base/browser/dom';
...
import { MenuId, MenuRegistry, SubmenuItemAction } from '@codingame/monaco-vscode-api/vscode/vs/platform/actions/common/actions';
...
import { SubmenuEntryActionViewItem } from '@codingame/monaco-vscode-api/vscode/vs/platform/actions/browser/menuEntryActionViewItem';
...
MenuRegistry.appendMenuItem(viewFilterMenu, {
    ...
    title: ( localize(3432, "More Filters...")),
    group: 'navigation',
    icon: Codicon.filter,
});
