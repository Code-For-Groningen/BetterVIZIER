...
import { TextFileResolveReason, TextFileEditorModelState, EncodingMode } from '@codingame/monaco-vscode-a17f5129-e16c-5dac-857e-dcd91bfeffa2-common/vscode/vs/workbench/services/textfile/common/textfiles';
...
import { NO_TYPE_ID, WorkingCopyCapabilities } from '@codingame/monaco-vscode-ce8c4b18-4e75-55dd-9656-517347af9de7-common/vscode/vs/workbench/services/workingCopy/common/workingCopy';
...
let TextFileEditorModel = class TextFileEditorModel extends BaseTextEditorModel {
    ...
    static { this.TEXTFILE_SAVE_ENCODING_SOURCE = SaveSourceRegistry.registerSource('textFileEncoding.source', ( localize(12012, "File Encoding Changed"))); }
    ...
    async doSave(options) {
        ...
        return this.progressService.withProgress({
            title: ( localize(12013, "Saving '{0}'", this.name)),
    ...
    doSaveSequential(versionId, options, progress, saveCancellation) {
        return this.saveSequentializer.run(versionId, (async () => {
            ...
            this.inErrorMode = false;
            progress.report({ message: ( localize(12014, "Writing into file...")) });
