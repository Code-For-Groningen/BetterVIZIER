...
import { foreground, errorForeground, contrastBorder } from '@codingame/monaco-vscode-api/vscode/vs/platform/theme/common/colors/baseColors';
import '@codingame/monaco-vscode-api/vscode/vs/platform/theme/common/colors/chartsColors';
import { editorInfoForeground, editorWarningForeground, toolbarHoverBackground } from '@codingame/monaco-vscode-api/vscode/vs/platform/theme/common/colors/editorColors';
import { inputBorder } from '@codingame/monaco-vscode-api/vscode/vs/platform/theme/common/colors/inputColors';
import { listDeemphasizedForeground } from '@codingame/monaco-vscode-api/vscode/vs/platform/theme/common/colors/listColors';
...
const debugToolBarBackground = registerColor('debugToolBar.background', {
    ...
    hcDark: '#000000',
    hcLight: '#FFFFFF'
}, ( localize(5356, "Debug toolbar background color.")));
const debugToolBarBorder = registerColor('debugToolBar.border', null, ( localize(5357, "Debug toolbar border color.")));
const debugIconStartForeground = registerColor('debugIcon.startForeground', {
    dark: '#89D185',
    light: '#388A34',
    hcDark: '#89D185',
    hcLight: '#388A34'
}, ( localize(5358, "Debug toolbar icon for start debugging.")));
