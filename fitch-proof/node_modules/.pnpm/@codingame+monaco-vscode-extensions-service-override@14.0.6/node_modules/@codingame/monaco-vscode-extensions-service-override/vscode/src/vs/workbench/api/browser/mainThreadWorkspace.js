...
let MainThreadWorkspace = class MainThreadWorkspace {
    ...
    getStatusMessage(extensionName, addCount, removeCount) {
        ...
        if (wantsToAdd && !wantsToDelete) {
            if (addCount === 1) {
                message = ( localize(2363, "Extension '{0}' added 1 folder to the workspace", extensionName));
            }
            else {
                message = ( localize(
                    2364,
            ...
            if (removeCount === 1) {
                message = ( localize(2365, "Extension '{0}' removed 1 folder from the workspace", extensionName));
            }
            else {
                message = ( localize(
                    2366,
            ...
            message = ( localize(2367, "Extension '{0}' changed folders of the workspace", extensionName));
        }
        return message;
    }
