...
import { defaultExternalUriOpenerId } from '@codingame/monaco-vscode-bd6ad8b7-9db3-51a8-9895-0046508c029d-common/vscode/vs/workbench/contrib/externalUriOpener/common/configuration';
            ...
            openExternalUri: async (uri, ctx, token) => {
                try {
                    ...
                    if (!isCancellationError(e)) {
                        const openDefaultAction = ( new Action('default', ( localize(2360, "Open using default opener")), undefined, undefined, async () => {
                        ...
                        this.notificationService.notify({
                            ...
                            message: ( localize(2361, 'Could not open uri with \'{0}\': {1}', id, (e.toString()))),
                            actions: {
                                primary: [
                                    openDefaultAction
                                ]
