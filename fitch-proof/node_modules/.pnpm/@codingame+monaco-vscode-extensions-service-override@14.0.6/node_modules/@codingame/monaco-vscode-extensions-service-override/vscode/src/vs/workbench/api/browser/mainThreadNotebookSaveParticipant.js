...
import { NotebookFileWorkingCopyModel } from '@codingame/monaco-vscode-168b98e5-dc20-5807-b1f9-798f1f92b37f-common/vscode/vs/workbench/contrib/notebook/common/notebookEditorModel';
...
class ExtHostNotebookDocumentSaveParticipant {
    ...
    async participate(workingCopy, context, _progress, token) {
        ...
        const p = ( new Promise((resolve, reject) => {
            _warningTimeout = setTimeout(() => reject(( new Error(( localize(2351, "Aborted onWillSaveNotebookDocument-event after 1750ms"))))), 1750);
