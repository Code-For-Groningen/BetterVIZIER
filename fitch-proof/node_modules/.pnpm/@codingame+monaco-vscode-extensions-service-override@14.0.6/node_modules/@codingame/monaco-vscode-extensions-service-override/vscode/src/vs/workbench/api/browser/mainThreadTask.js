...
import { TaskDefinition, PresentationOptions, RunOptions, CommandOptions, RuntimeType, TaskSourceKind, TaskScope, CustomTask, ContributedTask, ConfiguringTask, TaskEventKind } from '@codingame/monaco-vscode-api/vscode/vs/workbench/contrib/tasks/common/tasks';
...
(function (TaskDTO) {
    ...
    function to(task, workspace, executeOnly, icon, hide) {
        ...
        const label = ( localize(2357, '{0}: {1}', source.label, task.name));
