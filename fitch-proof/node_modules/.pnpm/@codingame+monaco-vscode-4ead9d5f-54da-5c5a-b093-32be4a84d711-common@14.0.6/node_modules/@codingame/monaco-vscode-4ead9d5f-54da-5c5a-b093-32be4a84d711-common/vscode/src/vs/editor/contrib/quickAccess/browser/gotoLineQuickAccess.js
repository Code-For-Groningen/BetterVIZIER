...
import { EditorOption, RenderLineNumbersType } from '@codingame/monaco-vscode-api/vscode/vs/editor/common/config/editorOptions';
import { ScrollType } from '@codingame/monaco-vscode-api/vscode/vs/editor/common/editorCommon';
import { AbstractEditorNavigationQuickAccessProvider } from '@codingame/monaco-vscode-ea14e352-8f1c-5569-b79a-8a96a53e8abe-common/vscode/vs/editor/contrib/quickAccess/browser/editorNavigationQuickAccess';
...
class AbstractGotoLineQuickAccessProvider extends AbstractEditorNavigationQuickAccessProvider {
    ...
    provideWithoutTextEditor(picker) {
        const label = ( localize(1346, "Open a text editor first to go to a line."));
        picker.items = [{ label }];
    ...
    getPickLabel(editor, lineNumber, column) {
        if (this.isValidLineNumber(editor, lineNumber)) {
            if (this.isValidColumn(editor, lineNumber, column)) {
                return localize(1347, "Go to line {0} and character {1}.", lineNumber, column);
            }
            return localize(1348, "Go to line {0}.", lineNumber);
        }
