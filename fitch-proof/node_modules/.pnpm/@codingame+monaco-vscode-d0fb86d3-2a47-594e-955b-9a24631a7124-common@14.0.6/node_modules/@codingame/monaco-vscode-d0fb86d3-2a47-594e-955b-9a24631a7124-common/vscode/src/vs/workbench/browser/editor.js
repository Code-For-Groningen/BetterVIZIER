...
import { EditorExtensions, EditorCloseContext, EditorResourceAccessor, SideBySideEditor } from '@codingame/monaco-vscode-api/vscode/vs/workbench/common/editor';
...
function computeEditorAriaLabel(input, index, group, groupCount) {
    ...
    if (group && !group.isPinned(input)) {
        ariaLabel = ( localize(2740, "{0}, preview", ariaLabel));
    }
    if (group?.isSticky(index ?? input)) {
        ariaLabel = ( localize(2741, "{0}, pinned", ariaLabel));
    }
