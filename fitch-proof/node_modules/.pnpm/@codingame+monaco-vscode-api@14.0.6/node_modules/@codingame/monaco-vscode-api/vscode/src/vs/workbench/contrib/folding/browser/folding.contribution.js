...
let DefaultFoldingRangeProvider = class DefaultFoldingRangeProvider extends Disposable {
    ...
    async _updateConfigValues() {
        ...
        DefaultFoldingRangeProvider_1.extensionItemLabels.push(( localize(6874, 'All')));
        DefaultFoldingRangeProvider_1.extensionDescriptions.push(( localize(6875, "All active folding range providers")));
