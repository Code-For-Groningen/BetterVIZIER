            ...
            'properties': {
                'security.allowedUNCHosts': {
                    ...
                    'items': {
                        'type': 'string',
                        'pattern': '^[^\\\\]+$',
                        'patternErrorMessage': ( localize(3688, 'UNC host names must not contain backslashes.'))
                    },
                    'default': [],
        ...
        const configurationNode = {
            ...
            'properties': {
                [CONFIG_NEW_WINDOW_PROFILE]: {
                    ...
                    'enumItemLabels': [...( this.userDataProfilesService.profiles.map(p => '')), ( localize(3691, "Active Window"))],
