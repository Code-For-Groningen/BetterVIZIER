...
class ShowOrFocusStandaloneColorPicker extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(912, "Show or Focus Standalone Color Picker")),
                mnemonicTitle: ( localize(913, "&&Show or Focus Standalone Color Picker")),
            },
...
class HideStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(915, "Hide the Color Picker")),
            ...
            metadata: {
                description: ( localize2(916, "Hide the standalone color picker.")),
            }
        });
    }
...
class InsertColorWithStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(917, "Insert Color with Standalone Color Picker")),
            ...
            metadata: {
                description: ( localize2(918, "Insert hex/rgb/hsl colors with the focused standalone color picker.")),
            }
        });
    }
    run(_accessor, editor) {
