        ...
        },
        {
            ...
            properties: {
                ...
                'http.proxySupport': {
                    ...
                    enumDescriptions: [
                        ( localize(1902, "Disable proxy support for extensions.")),
                        ( localize(1903, "Enable proxy support for extensions.")),
                        ( localize(
                        1904,
                        "Enable proxy support for extensions, fall back to request options, when no proxy found."
                    )),
                        ( localize(1905, "Enable proxy support for extensions, override request options.")),
                    ],
                    default: 'override',
                    markdownDescription: ( localize(
                        1906,
