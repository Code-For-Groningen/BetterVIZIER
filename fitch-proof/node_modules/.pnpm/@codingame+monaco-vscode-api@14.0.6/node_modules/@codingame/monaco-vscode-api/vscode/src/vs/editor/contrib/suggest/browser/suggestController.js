...
class TriggerSuggestAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1468, "Trigger Suggest")),
...
registerEditorAction(class extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1473, "Reset Suggest Widget Size")),
