    ...
    getAriaLabel(marker) {
        ...
        switch (marker.severity) {
            case MarkerSeverity.Error:
                severityLabel = ( localize(1048, "Error"));
                break;
            case MarkerSeverity.Warning:
                severityLabel = ( localize(1049, "Warning"));
                break;
            case MarkerSeverity.Info:
                severityLabel = ( localize(1050, "Info"));
                break;
            case MarkerSeverity.Hint:
                severityLabel = ( localize(1051, "Hint"));
                break;
        }
    ...
    showAtMarker(marker, markerIdx, markerCount) {
        ...
        if (model) {
            const detail = markerCount > 1
                ? ( localize(1053, "{0} of {1} problems", markerIdx, markerCount))
                : ( localize(1054, "{0} of {1} problem", markerIdx, markerCount));
...
const editorMarkerNavigationError = registerColor('editorMarkerNavigationError.background', { dark: errorDefault, light: errorDefault, hcDark: contrastBorder, hcLight: contrastBorder }, ( localize(1055, 'Editor marker navigation widget error color.')));
const editorMarkerNavigationErrorHeader = registerColor('editorMarkerNavigationError.headerBackground', { dark: ( transparent(editorMarkerNavigationError, .1)), light: ( transparent(editorMarkerNavigationError, .1)), hcDark: null, hcLight: null }, ( localize(1056, 'Editor marker navigation widget error heading background.')));
const editorMarkerNavigationWarning = registerColor('editorMarkerNavigationWarning.background', { dark: warningDefault, light: warningDefault, hcDark: contrastBorder, hcLight: contrastBorder }, ( localize(1057, 'Editor marker navigation widget warning color.')));
const editorMarkerNavigationWarningHeader = registerColor('editorMarkerNavigationWarning.headerBackground', { dark: ( transparent(editorMarkerNavigationWarning, .1)), light: ( transparent(editorMarkerNavigationWarning, .1)), hcDark: '#0C141F', hcLight: ( transparent(editorMarkerNavigationWarning, .2)) }, ( localize(1058, 'Editor marker navigation widget warning heading background.')));
const editorMarkerNavigationInfo = registerColor('editorMarkerNavigationInfo.background', { dark: infoDefault, light: infoDefault, hcDark: contrastBorder, hcLight: contrastBorder }, ( localize(1059, 'Editor marker navigation widget info color.')));
const editorMarkerNavigationInfoHeader = registerColor('editorMarkerNavigationInfo.headerBackground', { dark: ( transparent(editorMarkerNavigationInfo, .1)), light: ( transparent(editorMarkerNavigationInfo, .1)), hcDark: null, hcLight: null }, ( localize(1060, 'Editor marker navigation widget info heading background.')));
const editorMarkerNavigationBackground = registerColor('editorMarkerNavigation.background', editorBackground, ( localize(1061, 'Editor marker navigation widget background.')));
