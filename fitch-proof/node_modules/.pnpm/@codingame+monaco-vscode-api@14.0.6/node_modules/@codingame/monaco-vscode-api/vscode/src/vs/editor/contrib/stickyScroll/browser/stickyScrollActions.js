    ...
    constructor() {
        super({
            ...
            title: {
                ...
                mnemonicTitle: ( localize(1449, "&&Toggle Editor Sticky Scroll")),
            },
            metadata: {
            ...
            toggled: {
                ...
                title: ( localize(1451, "Sticky Scroll")),
                mnemonicTitle: ( localize(1452, "&&Sticky Scroll")),
            },
            menu: [
...
class FocusStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1453, "Focus Editor Sticky Scroll")),
...
class SelectNextStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1455, "Select the next editor sticky scroll line")),
...
class SelectPreviousStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1456, "Select the previous sticky scroll line")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
...
class GoToStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1457, "Go to the focused sticky scroll line")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
...
class SelectEditor extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(1458, "Select Editor")),
            precondition: ( EditorContextKeys.stickyScrollFocused.isEqualTo(true)),
            keybinding: {
                weight,
