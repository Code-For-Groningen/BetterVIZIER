...
class IndentationToSpacesAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1168, "Convert Indentation to Spaces")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1169, "Convert the tab indentation to spaces.")),
            }
        });
    }
    run(accessor, editor) {
...
class IndentationToTabsAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1170, "Convert Indentation to Tabs")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1171, "Convert the spaces indentation to tabs.")),
            }
        });
    }
    run(accessor, editor) {
    ...
    run(accessor, editor) {
        ...
        const picks = ( [1, 2, 3, 4, 5, 6, 7, 8].map(n => ({
            ...
            description: (n === creationOpts.tabSize && n === modelOpts.tabSize
                ? ( localize(1172, "Configured Tab Size"))
                : n === creationOpts.tabSize
                    ? ( localize(1173, "Default Tab Size"))
                    : n === modelOpts.tabSize
                        ? ( localize(1174, "Current Tab Size"))
                        : undefined)
        })));
        const autoFocusIndex = Math.min(model.getOptions().tabSize - 1, 7);
        setTimeout(() => {
            quickInputService.pick(picks, { placeHolder: ( localize(1175, "Select Tab Size for Current File")), activeItem: picks[autoFocusIndex] }).then(pick => {
                if (pick) {
...
class IndentUsingTabs extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(false, false, {
            ...
            label: ( localize2(1176, "Indent Using Tabs")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1177, "Use indentation with tabs.")),
            }
        });
    }
}
class IndentUsingSpaces extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, false, {
            ...
            label: ( localize2(1178, "Indent Using Spaces")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1179, "Use indentation with spaces.")),
            }
        });
    }
}
class ChangeTabDisplaySize extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, true, {
            ...
            label: ( localize2(1180, "Change Tab Display Size")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1181, "Change the space size equivalent of the tab.")),
            }
        });
    }
}
class DetectIndentation extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1182, "Detect Indentation from Content")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1183, "Detect the indentation from content.")),
            }
        });
    }
    run(accessor, editor) {
...
class ReindentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1184, "Reindent Lines")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1185, "Reindent the lines of the editor.")),
            }
        });
    }
    run(accessor, editor) {
...
class ReindentSelectedLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1186, "Reindent Selected Lines")),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: ( localize2(1187, "Reindent the selected lines of the editor.")),
            }
        });
    }
    run(accessor, editor) {
