...
const UndoCommand = registerCommand(( new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '1_do',
            title: ( localize(138, "&&Undo")),
            order: 1
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: ( localize(139, "Undo")),
            order: 1
        }, {
...
const RedoCommand = registerCommand(( new MultiCommand({
    ...
    menuOpts: [{
            menuId: MenuId.MenubarEditMenu,
            group: '1_do',
            title: ( localize(140, "&&Redo")),
            order: 2
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: ( localize(141, "Redo")),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '1_do',
...
const SelectAllCommand = registerCommand(( new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '1_basic',
            title: ( localize(142, "&&Select All")),
            order: 1
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: ( localize(143, "Select All")),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '9_select',
