...
class AccessibleViewNextAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4105, "Show Next in Accessible View"))
        });
    }
    run(accessor) {
...
class AccessibleViewNextCodeBlockAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4106, "Accessible View: Next Code Block"))
        });
    }
    run(accessor) {
...
class AccessibleViewPreviousCodeBlockAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4107, "Accessible View: Previous Code Block"))
        });
    }
    run(accessor) {
...
class AccessibleViewPreviousAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4108, "Show Previous in Accessible View"))
        });
    }
    run(accessor) {
...
class AccessibleViewGoToSymbolAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4109, "Go To Symbol in Accessible View"))
        });
    }
    run(accessor) {
...
const AccessibilityHelpAction = registerCommand(( new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '',
            title: ( localize(4110, "Open Accessibility Help")),
            order: 1
        }],
})));
const AccessibleViewAction = registerCommand(( new MultiCommand({
    ...
    menuOpts: [{
            menuId: MenuId.CommandPalette,
            group: '',
            title: ( localize(4111, "Open Accessible View")),
            order: 1
        }],
})));
class AccessibleViewDisableHintAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4112, "Disable Accessible View Hint"))
        });
    }
    run(accessor) {
...
class AccessibilityHelpConfigureKeybindingsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4113, "Accessibility Help Configure Unassigned Keybindings"))
        });
    }
    async run(accessor) {
...
class AccessibilityHelpConfigureAssignedKeybindingsAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4114, "Accessibility Help Configure Assigned Keybindings"))
        });
    }
    async run(accessor) {
...
class AccessibilityHelpOpenHelpLinkAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4115, "Accessibility Help Open Help Link"))
        });
    }
    run(accessor) {
...
class AccessibleViewAcceptInlineCompletionAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(4116, "Accept Inline Completion"))
        });
    }
    async run(accessor) {
