...
var SuggestWidget_1;
registerColor('editorSuggestWidget.background', editorWidgetBackground, ( localize(1474, 'Background color of the suggest widget.')));
registerColor('editorSuggestWidget.border', editorWidgetBorder, ( localize(1475, 'Border color of the suggest widget.')));
const editorSuggestWidgetForeground = registerColor('editorSuggestWidget.foreground', editorForeground, ( localize(1476, 'Foreground color of the suggest widget.')));
registerColor('editorSuggestWidget.selectedForeground', quickInputListFocusForeground, ( localize(1477, 'Foreground color of the selected entry in the suggest widget.')));
registerColor('editorSuggestWidget.selectedIconForeground', quickInputListFocusIconForeground, ( localize(1478, 'Icon foreground color of the selected entry in the suggest widget.')));
const editorSuggestWidgetSelectedBackground = registerColor('editorSuggestWidget.selectedBackground', quickInputListFocusBackground, ( localize(1479, 'Background color of the selected entry in the suggest widget.')));
registerColor('editorSuggestWidget.highlightForeground', listHighlightForeground, ( localize(1480, 'Color of the match highlights in the suggest widget.')));
...
registerColor('editorSuggestWidgetStatus.foreground', ( transparent(editorSuggestWidgetForeground, .5)), ( localize(1482, 'Foreground color of the suggest widget status.')));
var State;
(function (State) {
...
let SuggestWidget = class SuggestWidget {
    ...
    static { this.LOADING_MESSAGE = ( localize(1483, "Loading...")); }
    static { this.NO_SUGGESTIONS_MESSAGE = ( localize(1484, "No suggestions.")); }
    constructor(editor, _storageService, _contextKeyService, _themeService, instantiationService) {
        ...
        this._list = ( new List('SuggestWidget', this._listElement, {
            ...
            accessibilityProvider: {
                getRole: () => 'option',
                getWidgetAriaLabel: () => ( localize(1485, "Suggest")),
                ...
                getAriaLabel: (item) => {
                    ...
                    if (typeof item.completion.label !== 'string') {
                        ...
                        if (detail && description) {
                            label = ( localize(1486, '{0} {1}, {2}', label, detail, description));
                        }
                        else if (detail) {
                            label = ( localize(1487, '{0} {1}', label, detail));
                        }
                        else if (description) {
                            label = ( localize(1488, '{0}, {1}', label, description));
                        }
                    }
