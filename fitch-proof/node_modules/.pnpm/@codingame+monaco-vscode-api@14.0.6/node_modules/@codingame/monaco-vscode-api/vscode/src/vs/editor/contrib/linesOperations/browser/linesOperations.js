...
class CopyLinesUpAction extends AbstractCopyLinesAction {
    constructor() {
        super(false, {
            ...
            label: ( localize2(1257, "Copy Line Up")),
            ...
            menuOpts: {
                ...
                group: '2_line',
                title: ( localize(1258, "&&Copy Line Up")),
                order: 1
            }
        });
    }
...
class CopyLinesDownAction extends AbstractCopyLinesAction {
    constructor() {
        super(true, {
            ...
            label: ( localize2(1259, "Copy Line Down")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class DuplicateSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1261, "Duplicate Selection")),
            precondition: EditorContextKeys.writable,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: ( localize(1262, "&&Duplicate Selection")),
                order: 5
            }
        });
    }
...
class MoveLinesUpAction extends AbstractMoveLinesAction {
    constructor() {
        super(false, {
            ...
            label: ( localize2(1263, "Move Line Up")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: ( localize(1264, "Mo&&ve Line Up")),
                order: 3
            }
        });
    }
...
class MoveLinesDownAction extends AbstractMoveLinesAction {
    constructor() {
        super(true, {
            ...
            label: ( localize2(1265, "Move Line Down")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: ( localize(1266, "Move &&Line Down")),
                order: 4
            }
        });
    }
...
class SortLinesAscendingAction extends AbstractSortLinesAction {
    constructor() {
        super(false, {
            ...
            label: ( localize2(1267, "Sort Lines Ascending")),
            precondition: EditorContextKeys.writable
        });
    }
}
class SortLinesDescendingAction extends AbstractSortLinesAction {
    constructor() {
        super(true, {
            ...
            label: ( localize2(1268, "Sort Lines Descending")),
            precondition: EditorContextKeys.writable
        });
    }
}
class DeleteDuplicateLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1269, "Delete Duplicate Lines")),
            precondition: EditorContextKeys.writable
        });
    }
    run(_accessor, editor) {
...
class TrimTrailingWhitespaceAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1270, "Trim Trailing Whitespace")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class DeleteLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1271, "Delete Line")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
...
class IndentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1272, "Indent Line")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class OutdentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1273, "Outdent Line")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class InsertLineBeforeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1274, "Insert Line Above")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class InsertLineAfterAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1275, "Insert Line Below")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class DeleteAllLeftAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: 'deleteAllLeft',
            label: ( localize2(1276, "Delete All Left")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
...
class DeleteAllRightAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: 'deleteAllRight',
            label: ( localize2(1277, "Delete All Right")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
...
class JoinLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1278, "Join Lines")),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: 0,
...
class TransposeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1279, "Transpose Characters around the Cursor")),
            precondition: EditorContextKeys.writable
        });
    }
    run(_accessor, editor) {
...
class UpperCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: ( localize2(1280, "Transform to Uppercase")),
            precondition: EditorContextKeys.writable
        });
    }
...
class LowerCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: ( localize2(1281, "Transform to Lowercase")),
            precondition: EditorContextKeys.writable
        });
    }
    _modifyText(text, wordSeparators) {
...
class TitleCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1282, "Transform to Title Case")),
            precondition: EditorContextKeys.writable
        });
    }
    _modifyText(text, wordSeparators) {
...
class SnakeCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1283, "Transform to Snake Case")),
            precondition: EditorContextKeys.writable
        });
    }
    _modifyText(text, wordSeparators) {
...
class CamelCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1284, "Transform to Camel Case")),
            precondition: EditorContextKeys.writable
        });
    }
    _modifyText(text, wordSeparators) {
...
class PascalCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1285, "Transform to Pascal Case")),
            precondition: EditorContextKeys.writable
        });
    }
    _modifyText(text, wordSeparators) {
...
class KebabCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1286, 'Transform to Kebab Case')),
            precondition: EditorContextKeys.writable
        });
    }
    _modifyText(text, _) {
