...
class EditorAccessibilitySupport extends BaseEditorOption {
    constructor() {
        super(EditorOption.accessibilitySupport, 'accessibilitySupport', AccessibilitySupport.Unknown, {
            ...
            enum: ['auto', 'on', 'off'],
            enumDescriptions: [
                ( localize(259, "Use platform APIs to detect when a Screen Reader is attached.")),
                ( localize(260, "Optimize for usage with a Screen Reader.")),
                ( localize(261, "Assume a screen reader is not attached.")),
            ],
            default: 'auto',
            tags: ['accessibility'],
    ...
    constructor() {
        ...
        super(EditorOption.comments, 'comments', defaults, {
            'editor.comments.insertSpace': {
                ...
                description: ( localize(263, "Controls whether a space character is inserted when commenting."))
            },
    ...
    constructor() {
        ...
        super(EditorOption.find, 'find', defaults, {
            ...
            'editor.find.seedSearchStringFromSelection': {
                ...
                enumDescriptions: [
                    ( localize(267, 'Never seed search string from the editor selection.')),
                    ( localize(
                    268,
                    'Always seed search string from the editor selection, including word at cursor position.'
                )),
                    ( localize(269, 'Only seed search string from the editor selection.'))
                ],
                description: ( localize(
                    270,
            ...
            'editor.find.autoFindInSelection': {
                ...
                enumDescriptions: [
                    ( localize(271, 'Never turn on Find in Selection automatically (default).')),
                    ( localize(272, 'Always turn on Find in Selection automatically.')),
                    ( localize(
                    273,
            ...
            'editor.find.history': {
                ...
                default: 'workspace',
                enumDescriptions: [
                    ( localize(278, 'Do not store search history from the find widget.')),
