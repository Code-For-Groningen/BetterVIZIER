            ...
            definitions: {
                icons: {
                    ...
                    properties: {
                        ...
                        fontCharacter: { type: 'string', description: ( localize(2209, 'The font character associated with the icon definition.')) }
                    },
...
const widgetClose = registerIcon('widget-close', Codicon.close, ( localize(2210, 'Icon for the close action in widgets.')));
const gotoPreviousLocation = registerIcon('goto-previous-location', Codicon.arrowUp, ( localize(2211, 'Icon for goto previous editor location.')));
const gotoNextLocation = registerIcon('goto-next-location', Codicon.arrowDown, ( localize(2212, 'Icon for goto next editor location.')));
