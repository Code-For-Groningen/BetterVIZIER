...
const inlineSuggestionHintsNextIcon = registerIcon('inline-suggestion-hints-next', Codicon.chevronRight, ( localize(1227, 'Icon for show next parameter hint.')));
const inlineSuggestionHintsPreviousIcon = registerIcon('inline-suggestion-hints-previous', Codicon.chevronLeft, ( localize(1228, 'Icon for show previous parameter hint.')));
let InlineSuggestionHintsContentWidget = class InlineSuggestionHintsContentWidget extends Disposable {
    ...
    createCommandAction(commandId, label, iconClassName) {
        ...
        let tooltip = label;
        if (kb) {
            tooltip = ( localize(1229, '{0} ({1})', label, kb.getLabel()));
        }
    ...
    constructor(editor, withBorder, _position, _currentSuggestionIdx, _suggestionCount, _extraCommands, _commandService, instantiationService, keybindingService, _contextKeyService, _menuService) {
        ...
        this.previousAction = this.createCommandAction(showPreviousInlineSuggestionActionId, ( localize(1230, 'Previous')), ThemeIcon.asClassName(inlineSuggestionHintsPreviousIcon));
        this.availableSuggestionCountAction = ( new Action('inlineSuggestionHints.availableSuggestionCount', '', undefined, false));
        this.nextAction = this.createCommandAction(showNextInlineSuggestionActionId, ( localize(1231, 'Next')), ThemeIcon.asClassName(inlineSuggestionHintsNextIcon));
