...
class DefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(
            ...
            localize(1063, 'Definitions')
        ));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1064, "No definition found for '{0}'", info.word))
            : ( localize(1065, "No definition found"));
    }
    ...
    constructor() {
        super({
            ...
            title: {
                ...
                mnemonicTitle: ( localize(1067, "Go to &&Definition")),
            },
...
registerAction2(class OpenDefinitionToSideAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1068, "Open Definition to the Side")),
...
registerAction2(class PeekDefinitionAction extends DefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1069, "Peek Definition")),
...
class DeclarationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(
            ...
            localize(1070, 'Declarations')
        ));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1071, "No declaration found for '{0}'", info.word))
            : ( localize(1072, "No declaration found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToDeclarationAction extends DeclarationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1073, "Go to Declaration")),
                mnemonicTitle: ( localize(1074, "Go to &&Declaration")),
            },
...
registerAction2(class PeekDeclarationAction extends DeclarationAction {
    constructor() {
        super({
            ...
            title: ( localize2(1075, "Peek Declaration")),
            precondition: ( ContextKeyExpr.and(
...
class TypeDefinitionAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(
            ...
            localize(1076, 'Type Definitions')
        ));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1077, "No type definition found for '{0}'", info.word))
            : ( localize(1078, "No type definition found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1079, "Go to Type Definition")),
                mnemonicTitle: ( localize(1080, "Go to &&Type Definition")),
            },
...
registerAction2(class PeekTypeDefinitionAction extends TypeDefinitionAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1081, "Peek Type Definition")),
            precondition: ( ContextKeyExpr.and(
...
class ImplementationAction extends SymbolNavigationAction {
    async _getLocationModel(languageFeaturesService, model, position, token) {
        return (new ReferencesModel(
            ...
            localize(1082, 'Implementations')
        ));
    }
    _getNoResultFoundMessage(info) {
        return info && info.word
            ? ( localize(1083, "No implementation found for '{0}'", info.word))
            : ( localize(1084, "No implementation found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1085, "Go to Implementations")),
                mnemonicTitle: ( localize(1086, "Go to &&Implementations")),
            },
...
registerAction2(class PeekImplementationAction extends ImplementationAction {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1087, "Peek Implementations")),
            precondition: ( ContextKeyExpr.and(
...
class ReferencesAction extends SymbolNavigationAction {
    _getNoResultFoundMessage(info) {
        return info
            ? ( localize(1088, "No references found for '{0}'", info.word))
            : ( localize(1089, "No references found"));
    }
    _getAlternativeCommand(editor) {
...
registerAction2(class GoToReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: {
                ...( localize2(1090, "Go to References")),
                mnemonicTitle: ( localize(1091, "Go to &&References")),
            },
            precondition: ( ContextKeyExpr.and(
...
registerAction2(class PeekReferencesAction extends ReferencesAction {
    constructor() {
        super({
            ...
            title: ( localize2(1093, "Peek References")),
            precondition: ( ContextKeyExpr.and(
                EditorContextKeys.hasReferenceProvider,
                PeekContext.notInPeekEditor,
                ( EditorContextKeys.isInEmbeddedEditor.toNegated())
...
class GenericGoToLocationAction extends SymbolNavigationAction {
    constructor(config, _references, _gotoMultipleBehaviour) {
        super(config, {
            ...
            title: ( localize2(1094, "Go to Any Symbol")),
    ...
    async _getLocationModel(languageFeaturesService, _model, _position, _token) {
        return (new ReferencesModel(this._references, localize(1095, 'Locations')));
    }
    _getNoResultFoundMessage(info) {
        return info && ( localize(1096, "No results for '{0}'", info.word)) || '';
    }
    _getGoToPreference(editor) {
...
CommandsRegistry.registerCommand({
    ...
    handler: (accessor, resource, position) => {
        ...
        return codeEditorService.openCodeEditor({ resource }, codeEditorService.getFocusedCodeEditor()).then(control => {
            ...
            const references = createCancelablePromise(token => getReferencesAtPosition(languageFeaturesService.referenceProvider, control.getModel(), Position.lift(position), false, false, token).then(references => ( new ReferencesModel(references, ( localize(1092, 'References'))))));
