...
class InspectContextKeysAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2506, 'Inspect Context Keys')),
...
class ToggleScreencastModeAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2507, 'Toggle Screencast Mode')),
            category: Categories.Developer,
            f1: true
        });
    }
...
class LogStorageAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2508, "Log Storage Database Contents")),
            category: Categories.Developer,
            f1: true
        });
    }
    run(accessor) {
        ...
        )), ( localize(2510, "Open developer tools from the menu and select the Console tab.")));
    }
}
class LogWorkingCopiesAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2511, "Log Working Copies")),
            category: Categories.Developer,
            f1: true
        });
    }
...
class RemoveLargeStorageEntriesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(2512, 'Remove Large Storage Database Entries...')),
            category: Categories.Developer,
            f1: true
        });
    }
    async run(accessor) {
                    ...
                    if (value && (!environmentService.isBuilt  || value.length > RemoveLargeStorageEntriesAction.SIZE_THRESHOLD)) {
                        items.push({
                            ...
                            detail: ( localize(
                                2513,
                                "Scope: {0}, Target: {1}",
                                scope === StorageScope.APPLICATION ? ( localize(2514, "Global")) : scope === StorageScope.PROFILE ? ( localize(2515, "Profile")) : ( localize(2516, "Workspace")),
                                target === StorageTarget.MACHINE ? ( localize(2517, "Machine")) : ( localize(2518, "User"))
                            )),
                        });
                    }
                }
        ...
        const selectedItems = await ( new Promise(resolve => {
            ...
            picker.customLabel = ( localize(2519, "Remove"));
            picker.placeholder = ( localize(2520, "Select large entries to remove from storage"));
            if (items.length === 0) {
                picker.description = ( localize(2521, "There are no large storage entries to remove."));
            }
            picker.show();
        ...
        const { confirmed } = await dialogService.confirm({
            ...
            primaryButton: ( localize(2524, "&&Remove"))
        });
        if (!confirmed) {
            return;
        }
...
class StartTrackDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2525, 'Start Tracking Disposables')),
            category: Categories.Developer,
            f1: true,
...
class SnapshotTrackedDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2526, 'Snapshot Tracked Disposables')),
            category: Categories.Developer,
            f1: true,
...
class StopTrackDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2527, 'Stop Tracking Disposables')),
            category: Categories.Developer,
            f1: true,
...
configurationRegistry.registerConfiguration({
    id: 'screencastMode',
    order: 9,
    title: ( localize(2528, "Screencast Mode")),
    type: 'object',
    properties: {
        ...
        'screencastMode.keyboardOptions': {
            type: 'object',
            description: ( localize(2531, "Options for customizing the keyboard overlay in screencast mode.")),
            properties: {
                'showKeys': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(2532, "Show raw keys."))
                },
                'showKeybindings': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(2533, "Show keyboard shortcuts."))
                },
                'showCommands': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(2534, "Show command names."))
                },
                'showCommandGroups': {
                    type: 'boolean',
                    default: false,
                    description: ( localize(2535, "Show command group names, when commands are also shown."))
                },
                'showSingleEditorCursorMoves': {
                    type: 'boolean',
                    default: true,
                    description: ( localize(2536, "Show single editor cursor move commands."))
                }
            },
            default: {
                'showKeys': true,
