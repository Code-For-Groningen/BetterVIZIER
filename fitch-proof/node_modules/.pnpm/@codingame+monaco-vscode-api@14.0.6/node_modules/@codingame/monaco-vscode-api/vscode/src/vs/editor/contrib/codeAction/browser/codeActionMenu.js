...
const uncategorizedCodeActionGroup = ( Object.freeze({ kind: HierarchicalKind.Empty, title: ( localize(890, 'More Actions...')) }));
const codeActionGroups = ( Object.freeze([
    { kind: CodeActionKind.QuickFix, title: ( localize(891, 'Quick Fix')) },
    { kind: CodeActionKind.RefactorExtract, title: ( localize(892, 'Extract')), icon: Codicon.wrench },
    { kind: CodeActionKind.RefactorInline, title: ( localize(893, 'Inline')), icon: Codicon.wrench },
    { kind: CodeActionKind.RefactorRewrite, title: ( localize(894, 'Rewrite')), icon: Codicon.wrench },
    { kind: CodeActionKind.RefactorMove, title: ( localize(895, 'Move')), icon: Codicon.wrench },
    { kind: CodeActionKind.SurroundWith, title: ( localize(896, 'Surround With')), icon: Codicon.surroundWith },
    { kind: CodeActionKind.Source, title: ( localize(897, 'Source Action')), icon: Codicon.symbolFile },
