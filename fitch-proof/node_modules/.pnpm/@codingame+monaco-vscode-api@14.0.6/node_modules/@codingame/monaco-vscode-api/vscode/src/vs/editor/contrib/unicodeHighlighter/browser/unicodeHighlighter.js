...
import { isModelDecorationVisible, isModelDecorationInString, isModelDecorationInComment } from '../../../common/viewModel/viewModelDecorations.js';
...
const warningIcon = registerIcon('extensions-warning-message', Codicon.warning, ( localize(1533, 'Icon shown with a warning message in the extensions editor.')));
        ...
        this._updateState = (state) => {
            if (state && state.hasMore) {
                ...
                if (state.nonBasicAsciiCharacterCount >= max) {
                    data = {
                        message: ( localize(1534, 'This document contains many non-basic ASCII unicode characters')),
                        command: ( new DisableHighlightingOfNonBasicAsciiCharactersAction()),
                    };
                }
                else if (state.ambiguousCharacterCount >= max) {
                    data = {
                        message: ( localize(1535, 'This document contains many ambiguous unicode characters')),
                        command: ( new DisableHighlightingOfAmbiguousCharactersAction()),
                    };
                }
                else if (state.invisibleCharacterCount >= max) {
                    data = {
                        message: ( localize(1536, 'This document contains many invisible unicode characters')),
...
const configureUnicodeHighlightOptionsStr = ( localize(1537, 'Configure Unicode Highlight Options'));
        ...
        for (const d of lineDecorations) {
            ...
            switch (highlightInfo.reason.kind) {
                ...
                case UnicodeHighlighterReasonKind.Invisible:
                    reason = ( localize(1540, 'The character {0} is invisible.', codePointStr));
                    break;
                case UnicodeHighlighterReasonKind.NonBasicAscii:
                    reason = ( localize(1541, 'The character {0} is not a basic ASCII character.', codePointStr));
                    break;
            }
            ...
            const adjustSettings = ( localize(1542, 'Adjust settings'));
...
class DisableHighlightingInCommentsAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1543, "Disable highlighting of characters in comments")),
...
class DisableHighlightingInStringsAction extends EditorAction {
    ...
    constructor() {
        super({
            id: DisableHighlightingOfAmbiguousCharactersAction.ID,
            label: ( localize2(1545, "Disable highlighting of characters in strings")),
            precondition: undefined
        });
        this.shortLabel = ( localize(1546, 'Disable Highlight In Strings'));
    }
    async run(accessor, editor, args) {
        const configurationService = accessor?.get(IConfigurationService);
        if (configurationService) {
...
class DisableHighlightingOfAmbiguousCharactersAction extends EditorAction {
    ...
    constructor() {
        super({
            id: DisableHighlightingOfAmbiguousCharactersAction.ID,
            label: ( localize2(1547, "Disable highlighting of ambiguous characters")),
            precondition: undefined
        });
        this.shortLabel = ( localize(1548, 'Disable Ambiguous Highlight'));
    }
    async run(accessor, editor, args) {
        const configurationService = accessor?.get(IConfigurationService);
        if (configurationService) {
...
class DisableHighlightingOfInvisibleCharactersAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1549, "Disable highlighting of invisible characters")),
            precondition: undefined
        });
        this.shortLabel = ( localize(1550, 'Disable Invisible Highlight'));
    }
    async run(accessor, editor, args) {
        const configurationService = accessor?.get(IConfigurationService);
        if (configurationService) {
...
class DisableHighlightingOfNonBasicAsciiCharactersAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1551, "Disable highlighting of non basic ASCII characters")),
            precondition: undefined
        });
        this.shortLabel = ( localize(1552, 'Disable Non ASCII Highlight'));
    }
    async run(accessor, editor, args) {
        const configurationService = accessor?.get(IConfigurationService);
        if (configurationService) {
...
class ShowExcludeOptions extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: ( localize2(1553, "Show Exclude Options")),
            precondition: undefined
        });
    }
    async run(accessor, editor, args) {
