...
const CONTEXT_RENAME_INPUT_VISIBLE = ( new RawContextKey('renameInputVisible', false, ( localize(1396, "Whether the rename input widget is visible"))));
...
class RenameCandidateListView {
    ...
    setCandidates(candidates) {
        ...
        status(( localize(1398, "Received {0} rename suggestions", candidates.length)));
    }
    clearCandidates() {
...
class InputWithButton {
    ...
    get domNode() {
        if (!this._domNode) {
            ...
            this._inputNode.setAttribute('aria-label', ( localize(1399, "Rename input. Type new name and press Enter to commit.")));
            this._domNode.appendChild(this._inputNode);
            this._buttonNode = document.createElement('div');
            this._buttonNode.className = 'rename-suggestions-button';
            this._buttonNode.setAttribute('tabindex', '0');
            this._buttonGenHoverText = ( localize(1400, "Generate new name suggestions"));
            this._buttonCancelHoverText = ( localize(1401, "Cancel"));
