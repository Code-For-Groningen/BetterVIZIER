...
const TelemetryLogGroup = { id: 'telemetry', name: ( localize(1928, "Telemetry")) };
...
export { NullEndpointTelemetryService, NullTelemetryService, NullTelemetryServiceShape, TelemetryLogGroup, TelemetryTrustedValue, cleanData, cleanRemoteAuthority, extensionTelemetryLogChannelId, getTelemetryLevel, isInternalTelemetry, isLoggingOnly, supportsTelemetry, telemetryLogId, validateTelemetryData };
