...
class ToggleTabFocusModeAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(1528, 'Toggle Tab Key Moves Focus')),
    ...
    run() {
        ...
        if (newValue) {
            alert(( localize(1530, "Pressing Tab will now move focus to the next focusable element")));
        }
        else {
            alert(( localize(1531, "Pressing Tab will now insert the tab character")));
        }
    }
}
