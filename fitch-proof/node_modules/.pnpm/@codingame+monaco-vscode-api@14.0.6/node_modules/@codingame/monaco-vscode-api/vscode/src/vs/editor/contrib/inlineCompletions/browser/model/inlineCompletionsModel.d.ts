...
export declare class InlineCompletionsModel extends Disposable {
    ...
    readonly primaryPosition: IObservable<Position>;
    ...
    readonly selectedInlineCompletionIndex: IObservable<number>;
    readonly selectedInlineCompletion: IObservable<InlineCompletionWithUpdatedRange | undefined>;
    readonly activeCommands: IObservable<Command[]>;
    readonly lastTriggerKind: IObservable<InlineCompletionTriggerKind | undefined>;
    readonly inlineCompletionsCount: IObservable<number | undefined>;
    ...
    readonly status: IObservable<"loading" | "ghostText" | "inlineEdit" | "noSuggestion">;
    ...
    readonly inlineEditAvailable: IObservable<boolean>;
    ...
    readonly tabShouldJumpToInlineEdit: IObservable<boolean>;
    readonly tabShouldAcceptInlineEdit: IObservable<boolean>;
