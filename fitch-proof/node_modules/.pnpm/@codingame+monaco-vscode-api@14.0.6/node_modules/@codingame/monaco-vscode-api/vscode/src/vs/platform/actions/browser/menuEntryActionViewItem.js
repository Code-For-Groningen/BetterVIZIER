...
let MenuEntryActionViewItem = class MenuEntryActionViewItem extends ActionViewItem {
    ...
    getTooltip() {
        ...
        let title = keybindingLabel
            ? ( localize(1646, "{0} ({1})", tooltip, keybindingLabel))
            : tooltip;
        if (!this._wantsAltCommand && this._menuItemAction.alt?.enabled) {
            ...
            const altTitleSection = altKeybindingLabel
                ? ( localize(1646, "{0} ({1})", altTooltip, altKeybindingLabel))
                : altTooltip;
            title = ( localize(
                1647,
                "{0}\n[{1}] {2}",
    ...
    updateLabel() {
        ...
        if (this.label) {
            ...
            if (this._options?.conversational) {
                this.label.textContent = ( localize(1648, '{1} to {0}', this._action.label, kb2));
            }
            else {
                this.label.textContent = ( localize(1649, '{0} ({1})', this._action.label, kb2));
            }
        }
    }
