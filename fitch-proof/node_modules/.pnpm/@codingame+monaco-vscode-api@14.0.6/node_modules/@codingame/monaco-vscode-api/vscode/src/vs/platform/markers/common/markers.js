...
(function (MarkerSeverity) {
    ...
    _displayStrings[MarkerSeverity.Error] = ( localize(1859, "Error"));
    _displayStrings[MarkerSeverity.Warning] = ( localize(1860, "Warning"));
    _displayStrings[MarkerSeverity.Info] = ( localize(1861, "Info"));
    function toString(a) {
