...
registerColor('inlineEdit.indicator.foreground', buttonForeground, ( localize(1244, 'Foreground color for the inline edit indicator.')));
registerColor('inlineEdit.indicator.background', buttonBackground, ( localize(1245, 'Background color for the inline edit indicator.')));
registerColor('inlineEdit.indicator.border', buttonSeparator, ( localize(1246, 'Border color for the inline edit indicator.')));
