...
const symbolKindNames = {
    [SymbolKind.Array]: ( localize(758, "array")),
    [SymbolKind.Boolean]: ( localize(759, "boolean")),
    [SymbolKind.Class]: ( localize(760, "class")),
    [SymbolKind.Constant]: ( localize(761, "constant")),
    [SymbolKind.Constructor]: ( localize(762, "constructor")),
    [SymbolKind.Enum]: ( localize(763, "enumeration")),
    [SymbolKind.EnumMember]: ( localize(764, "enumeration member")),
    [SymbolKind.Event]: ( localize(765, "event")),
    [SymbolKind.Field]: ( localize(766, "field")),
    [SymbolKind.File]: ( localize(767, "file")),
    [SymbolKind.Function]: ( localize(768, "function")),
    [SymbolKind.Interface]: ( localize(769, "interface")),
    [SymbolKind.Key]: ( localize(770, "key")),
    [SymbolKind.Method]: ( localize(771, "method")),
    [SymbolKind.Module]: ( localize(772, "module")),
    [SymbolKind.Namespace]: ( localize(773, "namespace")),
    [SymbolKind.Null]: ( localize(774, "null")),
    [SymbolKind.Number]: ( localize(775, "number")),
    [SymbolKind.Object]: ( localize(776, "object")),
    [SymbolKind.Operator]: ( localize(777, "operator")),
    [SymbolKind.Package]: ( localize(778, "package")),
    [SymbolKind.Property]: ( localize(779, "property")),
    [SymbolKind.String]: ( localize(780, "string")),
    [SymbolKind.Struct]: ( localize(781, "struct")),
    [SymbolKind.TypeParameter]: ( localize(782, "type parameter")),
    [SymbolKind.Variable]: ( localize(783, "variable")),
};
function getAriaLabelForSymbol(symbolName, kind) {
    return localize(784, '{0} ({1})', symbolName, symbolKindNames[kind]);
}
var SymbolTag;
(function (SymbolTag) {
