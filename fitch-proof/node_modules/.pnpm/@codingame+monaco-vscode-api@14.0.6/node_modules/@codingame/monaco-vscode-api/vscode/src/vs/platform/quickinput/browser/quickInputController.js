...
let QuickInputController = class QuickInputController extends Disposable {
    ...
    getUI(showInActiveContainer) {
        ...
        checkAll.setAttribute('aria-label', ( localize(1882, "Toggle all checkboxes")));
        ...
        const visibleCount = this._register(( new CountBadge(visibleCountContainer, { countFormat: ( localize(1883, "{0} Results")) }, this.styles.countBadge)));
        const countContainer = append(filterContainer, $('.quick-input-count'));
        countContainer.setAttribute('aria-live', 'polite');
        const count = this._register(( new CountBadge(countContainer, { countFormat: ( localize(1884, "{0} Selected")) }, this.styles.countBadge)));
    ...
    show(controller) {
        ...
        backButton.tooltip = backKeybindingLabel ? ( localize(1887, "Back ({0})", backKeybindingLabel)) : ( localize(1888, "Back"));
