...
let ContextMenuController = class ContextMenuController {
    ...
    _showScrollbarContextMenu(anchor) {
        ...
        actions.push(createAction({
            label: ( localize(926, "Render Characters")),
        ...
        actions.push(createEnumAction(( localize(927, "Vertical size")), minimapOptions.enabled, 'editor.minimap.size', minimapOptions.size, [{
                label: ( localize(928, "Proportional")),
                value: 'proportional'
            }, {
                label: ( localize(929, "Fill")),
                value: 'fill'
            }, {
                label: ( localize(930, "Fit")),
                value: 'fit'
            }]));
        actions.push(createEnumAction(( localize(931, "Slider")), minimapOptions.enabled, 'editor.minimap.showSlider', minimapOptions.showSlider, [{
                label: ( localize(932, "Mouse Over")),
                value: 'mouseover'
            }, {
                label: ( localize(933, "Always")),
                value: 'always'
            }]));
        const useShadowDOM = this._editor.getOption(EditorOption.useShadowDOM) && !isIOS;
        this._contextMenuIsBeingShownCount++;
...
class ShowContextMenu extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(934, "Show Editor Context Menu")),
