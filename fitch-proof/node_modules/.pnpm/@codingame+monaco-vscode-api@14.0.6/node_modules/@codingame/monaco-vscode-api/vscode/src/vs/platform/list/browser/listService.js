    ...
    properties: {
        [multiSelectModifierSettingKey]: {
            ...
            markdownEnumDescriptions: [
                ( localize(1827, "Maps to `Control` on Windows and Linux and to `Command` on macOS.")),
                ( localize(1828, "Maps to `Alt` on Windows and Linux and to `Option` on macOS."))
            ],
            default: 'ctrlCmd',
        ...
        [scrollByPageKey]: {
            type: 'boolean',
            default: false,
            description: ( localize(1832, "Controls whether clicks in the scrollbar scroll page by page."))
        },
        [treeIndentKey]: {
            type: 'number',
            default: 8,
            minimum: 4,
            maximum: 40,
            description: ( localize(1833, "Controls tree indentation in pixels."))
        },
        [treeRenderIndentGuidesKey]: {
            type: 'string',
            enum: ['none', 'onHover', 'always'],
            default: 'onHover',
            description: ( localize(1834, "Controls whether the tree should render indent guides."))
        },
        [listSmoothScrolling]: {
            type: 'boolean',
            default: false,
            description: ( localize(1835, "Controls whether lists and trees have smooth scrolling.")),
        },
        ...
        [fastScrollSensitivityKey]: {
            type: 'number',
            default: 5,
            markdownDescription: ( localize(1837, "Scrolling speed multiplier when pressing `Alt`."))
        },
        [defaultFindModeSettingKey]: {
            ...
            enumDescriptions: [
                ...
                ( localize(1839, "Filter elements when searching."))
            ],
            default: 'highlight',
            description: ( localize(
                1840,
        ...
        [defaultFindMatchTypeSettingKey]: {
            ...
            enumDescriptions: [
                ( localize(1846, "Use fuzzy matching when searching.")),
                ( localize(1847, "Use contiguous matching when searching."))
            ],
            default: 'fuzzy',
            description: ( localize(
                1848,
        ...
        [treeStickyScroll]: {
            type: 'boolean',
            default: true,
            description: ( localize(1850, "Controls whether sticky scrolling is enabled in trees.")),
        },
