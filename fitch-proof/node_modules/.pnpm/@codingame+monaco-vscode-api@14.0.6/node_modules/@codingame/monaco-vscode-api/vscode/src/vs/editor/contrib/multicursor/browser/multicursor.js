...
function announceCursorChange(previousCursorState, cursorState) {
    ...
    if (cursorDiff.length >= 1) {
        ...
        const msg = cursorDiff.length === 1 ? ( localize(1300, "Cursor added: {0}", cursorPositions)) : ( localize(1301, "Cursors added: {0}", cursorPositions));
        status(msg);
    }
}
class InsertCursorAbove extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1302, "Add Cursor Above")),
            ...
            menuOpts: {
                ...
                group: '3_multi',
                title: ( localize(1303, "&&Add Cursor Above")),
                order: 2
            }
        });
    }
...
class InsertCursorBelow extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1304, "Add Cursor Below")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: ( localize(1305, "A&&dd Cursor Below")),
                order: 3
            }
        });
    }
...
class InsertCursorAtEndOfEachLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1306, "Add Cursors to Line Ends")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class InsertCursorAtEndOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1308, "Add Cursors To Bottom")),
            precondition: undefined
        });
    }
    run(accessor, editor) {
...
class InsertCursorAtTopOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1309, "Add Cursors To Top")),
            precondition: undefined
        });
    }
    run(accessor, editor) {
...
class AddSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1310, "Add Selection To Next Find Match")),
            precondition: undefined,
            kbOpts: {
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: ( localize(1311, "Add &&Next Occurrence")),
                order: 5
            }
        });
    }
...
class AddSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1312, "Add Selection To Previous Find Match")),
            precondition: undefined,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: ( localize(1313, "Add P&&revious Occurrence")),
                order: 6
            }
        });
    }
...
class MoveSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1314, "Move Last Selection To Next Find Match")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
class MoveSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1315, "Move Last Selection To Previous Find Match")),
            precondition: undefined
        });
    }
    _run(multiCursorController, findController) {
...
class SelectHighlightsAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1316, "Select All Occurrences of Find Match")),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: ( localize(1317, "Select All &&Occurrences")),
                order: 7
            }
        });
    }
...
class CompatChangeAll extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: ( localize2(1318, "Change All Occurrences")),
...
class FocusNextCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1319, "Focus Next Cursor")),
            metadata: {
                description: ( localize(1320, "Focuses the next cursor")),
                args: [],
            },
            precondition: undefined
        });
...
class FocusPreviousCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1321, "Focus Previous Cursor")),
            metadata: {
                description: ( localize(1322, "Focuses the previous cursor")),
                args: [],
            },
            precondition: undefined
        });
