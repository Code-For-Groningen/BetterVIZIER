    ...
    async _checkForUnusualLineTerminators() {
        ...
        try {
            ...
            result = await this._dialogService.confirm({
                title: ( localize(1557, "Unusual Line Terminators")),
                message: ( localize(1558, "Detected unusual line terminators")),
                detail: ( localize(
                    1559,
                ...
                primaryButton: ( localize(1560, "&&Remove Unusual Line Terminators")),
                cancelButton: ( localize(1561, "Ignore"))
            });
        }
        finally {
            this._isPresentingDialog = false;
