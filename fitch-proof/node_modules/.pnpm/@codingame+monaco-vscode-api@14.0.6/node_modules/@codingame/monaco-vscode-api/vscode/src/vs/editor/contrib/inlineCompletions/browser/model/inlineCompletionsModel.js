...
import { firstNonWhitespaceIndex, commonPrefixLength } from '../../../../../base/common/strings.js';
    ...
    constructor(textModel, _selectedSuggestItem, _textModelVersionId, _positions, _debounceValue, _enabled, _editor, _instantiationService, _commandService, _languageConfigurationService) {
        ...
        this.state = derivedOpts({
            ...
            if (inlineEditResult) {
                ...
                LineRange.fromRange(edit.range).distanceToLine(this.primaryPosition.read(reader).lineNumber);
                const currentItemIsCollapsed = false;
