...
const listHoverBackground = registerColor('list.hoverBackground', { dark: '#2A2D2E', light: '#F0F0F0', hcDark: ( Color.white.transparent(0.1)), hcLight: ( ( Color.fromHex('#0F4A85')).transparent(0.1)) }, ( localize(2138, "List/Tree background when hovering over items using the mouse.")));
const listHoverForeground = registerColor('list.hoverForeground', null, ( localize(2139, "List/Tree foreground when hovering over items using the mouse.")));
...
const listErrorForeground = registerColor('list.errorForeground', { dark: '#F88070', light: '#B01011', hcDark: null, hcLight: null }, ( localize(2145, 'Foreground color of list items containing errors.')));
const listWarningForeground = registerColor('list.warningForeground', { dark: '#CCA700', light: '#855F00', hcDark: null, hcLight: null }, ( localize(2146, 'Foreground color of list items containing warnings.')));
const listFilterWidgetBackground = registerColor('listFilterWidget.background', { light: ( darken(editorWidgetBackground, 0)), dark: ( lighten(editorWidgetBackground, 0)), hcDark: editorWidgetBackground, hcLight: editorWidgetBackground }, ( localize(2147, 'Background color of the type filter widget in lists and trees.')));
const listFilterWidgetOutline = registerColor('listFilterWidget.outline', { dark: Color.transparent, light: Color.transparent, hcDark: '#f38518', hcLight: '#007ACC' }, ( localize(2148, 'Outline color of the type filter widget in lists and trees.')));
...
const listFilterWidgetShadow = registerColor('listFilterWidget.shadow', widgetShadow, ( localize(2150, 'Shadow color of the type filter widget in lists and trees.')));
const listFilterMatchHighlight = registerColor('list.filterMatchBackground', { dark: editorFindMatchHighlight, light: editorFindMatchHighlight, hcDark: null, hcLight: null }, ( localize(2151, 'Background color of the filtered match.')));
const listFilterMatchHighlightBorder = registerColor('list.filterMatchBorder', { dark: editorFindMatchHighlightBorder, light: editorFindMatchHighlightBorder, hcDark: contrastBorder, hcLight: activeContrastBorder }, ( localize(2152, 'Border color of the filtered match.')));
const listDeemphasizedForeground = registerColor('list.deemphasizedForeground', { dark: '#8C8C8C', light: '#8E8E90', hcDark: '#A7A8A9', hcLight: '#666666' }, ( localize(2153, "List/Tree foreground color for items that are deemphasized.")));
const treeIndentGuidesStroke = registerColor('tree.indentGuidesStroke', { dark: '#585858', light: '#a9a9a9', hcDark: '#a9a9a9', hcLight: '#a5a5a5' }, ( localize(2154, "Tree stroke color for the indentation guides.")));
const treeInactiveIndentGuidesStroke = registerColor('tree.inactiveIndentGuidesStroke', ( transparent(treeIndentGuidesStroke, 0.4)), ( localize(2155, "Tree stroke color for the indentation guides that are not active.")));
const tableColumnsBorder = registerColor('tree.tableColumnsBorder', { dark: '#CCCCCC20', light: '#61616120', hcDark: null, hcLight: null }, ( localize(2156, "Table border color between columns.")));
const tableOddRowsBackgroundColor = registerColor('tree.tableOddRowsBackground', { dark: ( transparent(foreground, 0.04)), light: ( transparent(foreground, 0.04)), hcDark: null, hcLight: null }, ( localize(2157, "Background color for odd table rows.")));
registerColor('editorActionList.background', editorWidgetBackground, ( localize(2158, "Action List background color.")));
registerColor('editorActionList.foreground', editorWidgetForeground, ( localize(2159, "Action List foreground color.")));
registerColor('editorActionList.focusForeground', listActiveSelectionForeground, ( localize(2160, "Action List foreground color for the focused item.")));
registerColor('editorActionList.focusBackground', listActiveSelectionBackground, ( localize(2161, "Action List background color for the focused item.")));
