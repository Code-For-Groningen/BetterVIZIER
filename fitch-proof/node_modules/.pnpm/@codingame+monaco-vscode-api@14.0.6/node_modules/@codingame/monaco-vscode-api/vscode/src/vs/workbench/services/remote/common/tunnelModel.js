...
const forwardedPortsFeaturesEnabled = ( new RawContextKey('forwardedPortsViewEnabled', false, ( localize(11960, "Whether the Ports view is enabled."))));
const forwardedPortsViewEnabled = ( new RawContextKey('forwardedPortsViewOnlyEnabled', false, ( localize(11960, "Whether the Ports view is enabled."))));
...
const UserTunnelSource = {
    ...
    description: ( localize(11961, "User Forwarded"))
};
const AutoTunnelSource = {
    source: TunnelSource.Auto,
    description: ( localize(11962, "Auto Forwarded"))
};
            ...
            for (const tunnel of tunnels) {
                ...
                this.detected.set(makeAddress(tunnel.remoteAddress.host, tunnel.remoteAddress.port), {
                    ...
                    source: {
                        ...
                        description: ( localize(11964, "Statically Forwarded"))
                    }
                });
