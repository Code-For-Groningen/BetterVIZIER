...
let View = class View extends ViewEventHandler {
    ...
    _instantiateEditContext(experimentalEditContextEnabled, accessibilitySupport) {
        const domNode = getWindow(this._overflowGuardContainer.domNode);
    ...
    _createCoordinatedRendering() {
        return {
            ...
            renderText: () => {
                ...
                return [viewPartsToRender, ( new RenderingContext(
