    ...
    async showCodeActionList(actions, at, options) {
        ...
        const delegate = {
            onSelect: async (action, preview) => {
                this.applyCodeAction(action,  true, !!preview, options.fromLightbulb ? ApplyCodeActionReason.FromAILightbulb : ApplyCodeActionReason.FromCodeActions);
    ...
    _getActionBarActions(actions, at, options) {
        ...
        if (options.includeDisabledActions && actions.validActions.length > 0 && actions.allActions.length !== actions.validActions.length) {
            resultActions.push(this._showDisabled ? {
                id: 'hideMoreActions',
                label: ( localize(888, 'Hide Disabled')),
                enabled: true,
                tooltip: '',
                class: undefined,
                run: () => {
                ...
                id: 'showMoreActions',
                label: ( localize(889, 'Show Disabled')),
                enabled: true,
                tooltip: '',
                class: undefined,
                run: () => {
