...
const $ = $$1;
const increaseHoverVerbosityIcon = registerIcon('hover-increase-verbosity', Codicon.add, ( localize(1153, 'Icon for increaseing hover verbosity.')));
const decreaseHoverVerbosityIcon = registerIcon('hover-decrease-verbosity', Codicon.remove, ( localize(1154, 'Icon for decreasing hover verbosity.')));
class MarkdownHover {
...
let MarkdownHoverParticipant = class MarkdownHoverParticipant {
    ...
    createLoadingMessage(anchor) {
        return (new MarkdownHover(
            this,
            anchor.range,
            [( new MarkdownString()).appendText(( localize(1155, "Loading...")))],
            false,
            2000
        ));
    }
...
function labelForHoverVerbosityAction(keybindingService, action) {
    switch (action) {
        case HoverVerbosityAction.Increase: {
            ...
            return kb ?
                ( localize(1158, "Increase Hover Verbosity ({0})", kb.getLabel())) :
                ( localize(1159, "Increase Hover Verbosity"));
        }
        case HoverVerbosityAction.Decrease: {
            const kb = keybindingService.lookupKeybinding(DECREASE_HOVER_VERBOSITY_ACTION_ID);
            return kb ?
                ( localize(1160, "Decrease Hover Verbosity ({0})", kb.getLabel())) :
                ( localize(1161, "Decrease Hover Verbosity"));
        }
    }
}
