...
import product$1 from '../../product/common/product.js';
...
function getTitleBarStyle(configurationService) {
    ...
    return isLinux && product$1.quality === 'stable' ? TitlebarStyle.NATIVE : TitlebarStyle.CUSTOM;
}
...
export { CustomTitleBarVisibility, DEFAULT_CUSTOM_TITLEBAR_HEIGHT, TitleBarSetting, TitlebarStyle, WindowMinimumSize, getMenuBarVisibility, getTitleBarStyle, hasCustomTitlebar, hasNativeTitlebar, isFileToOpen, isFolderToOpen, isWorkspaceToOpen, useWindowControlsOverlay };
