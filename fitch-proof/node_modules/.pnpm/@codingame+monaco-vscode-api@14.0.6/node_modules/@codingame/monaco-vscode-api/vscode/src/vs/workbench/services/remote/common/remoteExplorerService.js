...
const getStartedWalkthrough = {
    ...
    properties: {
        id: {
            description: ( localize(11952, 'The ID of a Get Started walkthrough to open.')),
            type: 'string'
        },
    }
};
const remoteHelpExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: ( localize(11953, 'Contributes help information for Remote')),
        type: 'object',
        properties: {
            'getStarted': {
            ...
            'feedback': {
                ...
                type: 'string',
                markdownDeprecationMessage: ( localize(11957, "Use {0} instead", '`reportIssue`'))
            },
            'reportIssue': {
                description: ( localize(
                    11958,
