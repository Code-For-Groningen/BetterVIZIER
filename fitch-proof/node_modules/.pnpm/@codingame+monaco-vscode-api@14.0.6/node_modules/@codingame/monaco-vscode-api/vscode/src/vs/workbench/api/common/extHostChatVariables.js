...
import { ChatResponseReferencePart as ChatResponseReferencePart$1, ChatResponseProgressPart as ChatResponseProgressPart$1 } from './extHostTypeConverters.js';
import { ChatResponseReferencePart, ChatResponseProgressPart } from './extHostTypes.js';
        ...
        if (!this._apiObject) {
            ...
            this._apiObject = {
                progress(value) {
                    ...
                    const part = new ChatResponseProgressPart(value);
                    const dto = ChatResponseProgressPart$1.from(part);
                    _report(dto);
                    return this;
                },
                reference(value) {
                    throwIfDone(this.reference);
                    const part = new ChatResponseReferencePart(value);
                    const dto = ChatResponseReferencePart$1.from(part);
                    _report(dto);
                    return this;
                },
                push(part) {
                    ...
                    if (part instanceof ChatResponseReferencePart) {
                        _report(ChatResponseReferencePart$1.from(part));
                    }
                    else if (part instanceof ChatResponseProgressPart) {
                        _report(ChatResponseProgressPart$1.from(part));
                    }
                    return this;
                }
            };
