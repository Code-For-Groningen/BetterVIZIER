...
const $ = $$1;
const parameterHintsNextIcon = registerIcon('parameter-hints-next', Codicon.chevronDown, ( localize(1324, 'Icon for show next parameter hint.')));
const parameterHintsPreviousIcon = registerIcon('parameter-hints-previous', Codicon.chevronUp, ( localize(1325, 'Icon for show previous parameter hint.')));
    ...
    render(hints) {
        ...
        if (activeParameter) {
            ...
            if (this.announcedLabel !== labelToAnnounce) {
                alert(( localize(1326, "{0}, hint", labelToAnnounce)));
...
registerColor('editorHoverWidget.highlightForeground', listHighlightForeground, ( localize(1327, 'Foreground color of the active item in the parameter hint.')));
