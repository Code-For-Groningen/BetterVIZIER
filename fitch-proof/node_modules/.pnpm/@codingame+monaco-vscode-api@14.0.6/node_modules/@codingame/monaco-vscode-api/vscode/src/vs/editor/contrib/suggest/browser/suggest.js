...
const Context = {
    ...
    HasFocusedSuggestion: ( new RawContextKey('suggestWidgetHasFocusedSuggestion', false, ( localize(1459, "Whether any suggestion is focused")))),
    DetailsVisible: ( new RawContextKey('suggestWidgetDetailsVisible', false, ( localize(1460, "Whether suggestion details are visible")))),
    MultipleSuggestions: ( new RawContextKey('suggestWidgetMultipleSuggestions', false, ( localize(1461, "Whether there are multiple suggestions to pick from")))),
    ...
    AcceptSuggestionsOnEnter: ( new RawContextKey('acceptSuggestionOnEnter', true, ( localize(1463, "Whether suggestions are inserted when pressing Enter")))),
    HasInsertAndReplaceRange: ( new RawContextKey('suggestionHasInsertAndReplaceRange', false, ( localize(1464, "Whether the current suggestion has insert and replace behaviour")))),
    InsertMode: ( new RawContextKey(
        'suggestionInsertMode',
        undefined,
        { type: 'string', description: ( localize(1465, "Whether the default behaviour is to insert or replace")) }
    )),
    CanResolve: ( new RawContextKey('suggestionCanResolve', false, ( localize(1466, "Whether the current suggestion supports to resolve further details")))),
};
