...
const InQuickInputContextKey = ( new RawContextKey(inQuickInputContextKeyValue, false, ( localize(1869, "Whether keyboard focus is inside the quick input control"))));
...
const QuickInputAlignmentContextKey = ( new RawContextKey(quickInputAlignmentContextKeyValue, 'top', ( localize(1870, "The alignment of the quick input"))));
const quickInputTypeContextKeyValue = 'quickInputType';
const QuickInputTypeContextKey = ( new RawContextKey(quickInputTypeContextKeyValue, undefined, ( localize(1871, "The type of the currently visible quick input"))));
...
const backButton = {
    ...
    tooltip: ( localize(1873, "Back")),
    handle: -1
};
class QuickInput extends Disposable {
    static { this.noPromptMessage = ( localize(1874, "Press 'Enter' to confirm your input or 'Escape' to cancel")); }
    constructor(ui) {
        super();
        this.ui = ui;
    ...
    getSteps() {
        if (this.step && this.totalSteps) {
            return localize(1875, "{0}/{1}", this.step, this.totalSteps);
        }
        if (this.step) {
...
class QuickPick extends QuickInput {
    ...
    static { this.DEFAULT_ARIA_LABEL = ( localize(1876, "Type to narrow down results.")); }
    get quickNavigate() {
    ...
    get okLabel() {
        return this._okLabel ?? ( localize(1877, "OK"));
    }
    set okLabel(okLabel) {
...
class InputBox extends QuickInput {
    ...
    set prompt(prompt) {
        ...
        this.noValidationMessage = prompt
            ? ( localize(1878, "{0} (Press 'Enter' to confirm or 'Escape' to cancel)", prompt))
