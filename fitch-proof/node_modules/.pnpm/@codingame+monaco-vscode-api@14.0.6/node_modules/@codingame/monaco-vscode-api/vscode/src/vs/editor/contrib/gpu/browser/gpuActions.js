...
class DebugEditorGpuRendererAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1118, "Developer: Debug Editor GPU Renderer")),
    ...
    async run(accessor, editor) {
        ...
        const choice = await quickInputService.pick([
            {
                label: ( localize(1119, "Log Texture Atlas Stats")),
                id: 'logTextureAtlasStats',
            },
            {
                label: ( localize(1120, "Save Texture Atlas")),
                id: 'saveTextureAtlas',
            },
            {
                label: ( localize(1121, "Draw Glyph")),
                id: 'drawGlyph',
            },
        ], { canPickMany: false });
        if (!choice) {
