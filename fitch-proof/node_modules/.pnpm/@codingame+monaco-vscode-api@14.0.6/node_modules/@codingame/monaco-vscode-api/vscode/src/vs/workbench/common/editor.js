...
const DEFAULT_EDITOR_ASSOCIATION = {
    id: 'default',
    displayName: ( localize(3763, "Text Editor")),
    providerDisplayName: ( localize(3764, "Built-in"))
};
...
function createTooLargeFileError(group, input, options, message, preferencesService) {
    return createEditorOpenError(message, [
        toAction({
            id: 'workbench.action.openLargeFile', label: ( localize(3765, "Open Anyway")), run: () => {
        ...
        toAction({
            id: 'workbench.action.configureEditorLargeFileConfirmation', label: ( localize(3766, "Configure Limit")), run: () => {
