...
let InlayHintsAccessibility = class InlayHintsAccessibility {
    ...
    static { this.IsReading = ( new RawContextKey(
        ...
        false,
        { type: 'boolean', description: ( localize(6901, "Whether the current line and its inlay hints are currently focused")) }
    )); }
    ...
    constructor(_editor, contextKeyService, _accessibilitySignalService, _instaService) {
        ...
        this._ariaElement.setAttribute('aria-description', ( localize(6902, "Code with Inlay Hint Information")));
...
registerAction2(class StartReadHints extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(6903, "Read Line With Inline Hints")),
...
registerAction2(class StopReadHints extends EditorAction2 {
    constructor() {
        super({
            ...
            title: ( localize2(6904, "Stop Inlay Hints Reading")),
