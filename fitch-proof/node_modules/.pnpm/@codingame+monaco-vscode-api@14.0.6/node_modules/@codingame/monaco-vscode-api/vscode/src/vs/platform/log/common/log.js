...
function LogLevelToLocalizedString(logLevel) {
    switch (logLevel) {
        case LogLevel.Trace: return { original: 'Trace', value: ( localize(1853, "Trace")) };
        case LogLevel.Debug: return { original: 'Debug', value: ( localize(1854, "Debug")) };
        case LogLevel.Info: return { original: 'Info', value: ( localize(1855, "Info")) };
        case LogLevel.Warning: return { original: 'Warning', value: ( localize(1856, "Warning")) };
        case LogLevel.Error: return { original: 'Error', value: ( localize(1857, "Error")) };
        case LogLevel.Off: return { original: 'Off', value: ( localize(1858, "Off")) };
    }
}
