...
function getSyncAreaLabel(source) {
    switch (source) {
        case SyncResource.Settings: return localize(12296, "Settings");
        case SyncResource.Keybindings: return localize(12297, "Keyboard Shortcuts");
        case SyncResource.Snippets: return localize(12298, "Snippets");
        case SyncResource.Tasks: return localize(12299, "Tasks");
        case SyncResource.Extensions: return localize(12300, "Extensions");
        case SyncResource.GlobalState: return localize(12301, "UI State");
        case SyncResource.Profiles: return localize(12302, "Profiles");
        case SyncResource.WorkspaceState: return localize(12303, "Workspace State");
    }
}
var AccountStatus;
...
const SYNC_TITLE = ( localize2(12304, "Settings Sync"));
const SYNC_VIEW_ICON = registerIcon('settings-sync-view-icon', Codicon.sync, ( localize(12305, 'View icon of the Settings Sync view.')));
...
const DOWNLOAD_ACTIVITY_ACTION_DESCRIPTOR = {
    ...
    title: ( localize2(12306, "Download Settings Sync Activity")),
