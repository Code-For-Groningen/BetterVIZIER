...
const VIEWS_LOG_NAME = ( localize(3928, "Views"));
const defaultViewIcon = registerIcon('default-view-icon', Codicon.window, ( localize(3929, 'Default view icon.')));
var Extensions;
(function (Extensions) {
    ...
    addViews(viewDescriptors, viewContainer) {
        ...
        for (const viewDescriptor of viewDescriptors) {
            if (this.getView(viewDescriptor.id) !== null) {
                throw ( new Error(( localize(3930, "A view with id '{0}' is already registered", viewDescriptor.id))));
            }
...
class NoTreeViewError extends Error {
    constructor(treeViewId) {
        super(( localize(3931, 'No tree view with id \'{0}\' registered.', treeViewId)));
