...
class ShowOrFocusHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1129, "Show or Focus Hover")),
            metadata: {
                        ...
                        schema: {
                            ...
                            properties: {
                                'focus': {
                                    ...
                                    enumDescriptions: [
                                        ( localize(1131, 'The hover will not automatically take focus.')),
                                        ( localize(1132, 'The hover will take focus only if it is already visible.')),
                                        ( localize(1133, 'The hover will automatically take focus when it appears.')),
                                    ],
...
class ShowDefinitionPreviewHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1134, "Show Definition Preview Hover")),
            precondition: undefined,
            metadata: {
                description: ( localize2(1135, 'Show the definition preview hover in the editor.')),
            },
        });
    }
    run(accessor, editor) {
...
class HideContentHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1136, "Hide Hover")),
...
class ScrollUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1137, "Scroll Up Hover")),
            ...
            metadata: {
                description: ( localize2(1138, 'Scroll up the editor hover.'))
            },
        });
    }
    run(accessor, editor) {
...
class ScrollDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1139, "Scroll Down Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1140, 'Scroll down the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class ScrollLeftHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1141, "Scroll Left Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1142, 'Scroll left the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class ScrollRightHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1143, "Scroll Right Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1144, 'Scroll right the editor hover.'))
            },
        });
    }
    run(accessor, editor) {
...
class PageUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1145, "Page Up Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1146, 'Page up the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class PageDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1147, "Page Down Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1148, 'Page down the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class GoToTopHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1149, "Go To Top Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
            ...
            metadata: {
                description: ( localize2(1150, 'Go to the top of the editor hover.')),
            },
        });
    }
    run(accessor, editor) {
...
class GoToBottomHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: ( localize2(1151, "Go To Bottom Hover")),
            precondition: EditorContextKeys.hoverFocused,
            kbOpts: {
                kbExpr: EditorContextKeys.hoverFocused,
                primary: KeyCode.End,
            ...
            metadata: {
                description: ( localize2(1152, 'Go to the bottom of the editor hover.'))
            },
        });
    }
    run(accessor, editor) {
