...
const TASK_RUNNING_STATE = ( new RawContextKey('taskRunning', false, ( localize(9560, "Whether a task is currently running."))));
const TASKS_CATEGORY = ( localize2(9561, "Tasks"));
var ShellQuoting;
