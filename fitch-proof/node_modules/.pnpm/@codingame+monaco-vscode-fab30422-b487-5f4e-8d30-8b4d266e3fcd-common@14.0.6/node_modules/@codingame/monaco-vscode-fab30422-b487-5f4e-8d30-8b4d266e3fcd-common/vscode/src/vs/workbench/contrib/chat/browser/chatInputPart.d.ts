...
import { IChatViewState } from "@codingame/monaco-vscode-c465110a-57c0-59d7-a6b2-be0a4db7e517-common/vscode/vs/workbench/contrib/chat/browser/chatWidget";
...
export declare class ChatInputPart extends Disposable implements IHistoryNavigationWidget {
    ...
    private readonly _chatEditsFileLimitHover;
