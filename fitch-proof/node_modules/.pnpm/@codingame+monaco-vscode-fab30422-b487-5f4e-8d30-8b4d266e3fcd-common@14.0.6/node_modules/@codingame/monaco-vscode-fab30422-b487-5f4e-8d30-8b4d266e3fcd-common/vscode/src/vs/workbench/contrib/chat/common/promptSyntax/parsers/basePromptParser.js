...
import { RecursiveReference, ParseError, NonPromptSnippetFile, FileOpenFailed, FailedToResolveContentsStream } from '../../promptFileReferenceErrors.js';

var BasePromptParser_1;
const errorMessages = {
    recursion: ( localize(4769, 'Recursive reference found')),
    fileOpenFailed: ( localize(4770, 'Failed to open file')),
    streamOpenFailed: ( localize(4771, 'Failed to open contents stream')),
    brokenChild: ( localize(4772, 'Contains a broken reference that will be ignored')),
};
let BasePromptParser = BasePromptParser_1 = class BasePromptParser extends ObservableDisposable {
    onUpdate(callback) {
    ...
    constructor(promptContentsProvider, seenReferences = [], instantiationService, configService, logService) {
        super();
    ...
    static isPromptSnippet(uri) {
        return uri.path.endsWith(PROMPT_SNIPPET_FILE_EXTENSION);
    }
    get isPromptSnippet() {
        return BasePromptParser_1.isPromptSnippet(this.uri);
    }
    toString() {
...
BasePromptParser = BasePromptParser_1 = ( __decorate([
    ( __param(2, IInstantiationService)),
    ( __param(3, IConfigurationService)),
    ( __param(4, ILogService))
], BasePromptParser));
let PromptFileReference = class PromptFileReference extends BasePromptParser {
    constructor(token, dirname, seenReferences = [], initService, configService, logService) {
