...
let ChatInstructionAttachmentsModel = class ChatInstructionAttachmentsModel extends Disposable {
    get references() {
        const result = [];
...
ChatInstructionAttachmentsModel = ( __decorate([
    ( __param(0, IInstantiationService)),
    ( __param(1, IConfigurationService))
], ChatInstructionAttachmentsModel));

export { ChatInstructionAttachmentsModel, toChatVariable };
