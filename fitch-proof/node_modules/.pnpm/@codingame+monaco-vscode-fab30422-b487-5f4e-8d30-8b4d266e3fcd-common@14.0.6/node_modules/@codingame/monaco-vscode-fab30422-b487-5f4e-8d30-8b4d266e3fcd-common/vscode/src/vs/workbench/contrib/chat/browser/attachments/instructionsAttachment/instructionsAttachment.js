...
let InstructionsAttachmentWidget = class InstructionsAttachmentWidget extends Disposable {
    get uri() {
    ...
    constructor(model, resourceLabels, contextKeyService, contextMenuService, hoverService, labelService, menuService, fileService, languageService, modelService) {
        ...
        this.domNode = $('.chat-prompt-instructions-attachment.chat-attached-context-attachment.show-file-icons.implicit');
    ...
    render() {
        ...
        const ariaLabel = ( localize(4381, "Prompt attachment, {0}", friendlyName));
        const uriLabel = this.labelService.getUriLabel(file, { relative: true });
        const promptLabel = ( localize(4382, "Prompt"));
        ...
        const removeButton = this.renderDisposables.add(( new Button(this.domNode, { supportIcons: true, title: ( localize(4385, "Remove")) })));
