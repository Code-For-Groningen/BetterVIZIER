...
let ChatInstructionsAttachmentModel = class ChatInstructionsAttachmentModel extends Disposable {
    get reference() {
...
ChatInstructionsAttachmentModel = ( __decorate([
    ( __param(1, IInstantiationService))
], ChatInstructionsAttachmentModel));

export { ChatInstructionsAttachmentModel };
