...
let ImplicitContextAttachmentWidget = class ImplicitContextAttachmentWidget extends Disposable {
    ...
    render() {
        ...
        const ariaLabel = range ? ( localize(
            ...
            range.endLineNumber
        )) : ( localize(4376, "Attached file, {0}", friendlyName));
        const uriLabel = this.labelService.getUriLabel(file, { relative: true });
        const currentFile = ( localize(4377, "Current file context"));
        const inactive = ( localize(4378, "disabled"));
        ...
        const buttonMsg = this.attachment.enabled ? ( localize(4379, "Disable current file context")) : ( localize(4380, "Enable current file context"));
