...
const terminalContributionsDescriptor = {
    ...
    jsonSchema: {
        description: ( localize(9760, 'Contributes terminal functionality.')),
        type: 'object',
        properties: {
            profiles: {
                type: 'array',
                description: ( localize(9761, "Defines additional terminal profiles that the user can create.")),
                items: {
                    type: 'object',
                    required: ['id', 'title'],
                    defaultSnippets: [{
                    ...
                    properties: {
                        id: {
                            description: ( localize(9762, "The ID of the terminal profile provider.")),
                            type: 'string',
                        },
                        title: {
                            description: ( localize(9763, "Title for this terminal profile.")),
                            type: 'string',
                        },
                        icon: {
                            ...
                            anyOf: [{
                                ...
                                },
                                {
                                    ...
                                    properties: {
                                        light: {
                                            description: ( localize(9765, 'Icon path when a light theme is used')),
                                            type: 'string'
                                        },
                                        dark: {
                                            description: ( localize(9766, 'Icon path when a dark theme is used')),
                                            type: 'string'
                                        }
                                    }
                                }]
