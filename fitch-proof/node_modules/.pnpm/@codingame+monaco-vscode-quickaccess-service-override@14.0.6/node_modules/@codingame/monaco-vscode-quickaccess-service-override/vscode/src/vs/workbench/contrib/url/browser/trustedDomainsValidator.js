...
import { isURLDomainTrusted } from '@codingame/monaco-vscode-9a1a5840-af83-5d07-a156-ba32a36c5c4b-common/vscode/vs/workbench/contrib/url/browser/trustedDomainService';
...
import { readStaticTrustedDomains, configureOpenerTrustedDomainsHandler } from '@codingame/monaco-vscode-9a1a5840-af83-5d07-a156-ba32a36c5c4b-common/vscode/vs/workbench/contrib/url/browser/trustedDomains';
    ...
    async validateLink(resource, openOptions) {
        ...
        if (await this._trustedDomainService.isValid(resourceUri)) {
            ...
            const { result } = await this._dialogService.prompt({
                ...
                buttons: [
                    {
                        label: ( localize(10685, '&&Open')),
                        run: () => true
                    },
                    {
                        label: ( localize(10686, '&&Copy')),
                        run: () => {
                    ...
                    {
                        label: ( localize(10687, 'Configure &&Trusted Domains')),
                        run: async () => {
