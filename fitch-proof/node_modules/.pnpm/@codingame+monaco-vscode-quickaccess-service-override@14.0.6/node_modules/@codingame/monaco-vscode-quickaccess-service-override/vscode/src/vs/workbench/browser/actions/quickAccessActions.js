...
import { inQuickPickContext, defaultQuickAccessContext, getQuickNavigateHandler } from '@codingame/monaco-vscode-2cbab29e-9393-5de6-b701-9a9555360b6b-common/vscode/vs/workbench/browser/quickaccess';
...
registerAction2(class QuickAccessAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize2(2676, "Go to File...")),
            metadata: {
...
registerAction2(class QuickAccessAction extends Action2 {
    constructor() {
        super({
            ...
            title: ( localize(2677, "Quick Open")),
            icon: Codicon.search,
            menu: {
...
class QuickAccessNavigateNextAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super('workbench.action.quickOpenNavigateNext', ( localize2(2678, 'Navigate Next in Quick Open')), true, true);
    }
}
class QuickAccessNavigatePreviousAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super('workbench.action.quickOpenNavigatePrevious', ( localize2(2679, 'Navigate Previous in Quick Open')), false, true);
    }
}
class QuickAccessSelectNextAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super('workbench.action.quickOpenSelectNext', ( localize2(2680, 'Select Next in Quick Open')), true, false, {
            weight: KeybindingWeight.WorkbenchContrib + 50,
            when: inQuickPickContext,
            primary: 0,
...
class QuickAccessSelectPreviousAction extends BaseQuickAccessNavigateAction {
    constructor() {
        super('workbench.action.quickOpenSelectPrevious', ( localize2(2681, 'Select Previous in Quick Open')), false, false, {
            weight: KeybindingWeight.WorkbenchContrib + 50,
            when: inQuickPickContext,
            primary: 0,
