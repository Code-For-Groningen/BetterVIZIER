...
import { AbstractGotoLineQuickAccessProvider } from '@codingame/monaco-vscode-4ead9d5f-54da-5c5a-b093-32be4a84d711-common/vscode/vs/editor/contrib/quickAccess/browser/gotoLineQuickAccess';
...
class GotoLineAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: ( localize2(4846, 'Go to Line/Column...')),
            f1: true,
            keybinding: {
...
( Registry.as(Extensions.Quickaccess)).registerQuickAccessProvider({
    ...
    helpEntries: [{ description: ( localize(4848, "Go to Line/Column")), commandId: GotoLineAction.ID }]
});
